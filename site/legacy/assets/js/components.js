 ...
 *   <script src="/legacy/assets/js/site_constants.js"></script>
 *   <script src="/legacy/assets/js/components.js"></script>
 *   <script src="/legacy/assets/js/nav.js"></script>
 *
...
(function() {
  ...
  function buildSubscribeCTA() {
    ...
    html += '<h2 style="font-family:var(--font-display);font-size:var(--text-h3);color:var(--text);margin-bottom:var(--space-4)">' + ctaHeadline + '</h2>';
  ...
  if (!window.AMJ_EXPERIMENT) {
    ...
    cdScript.src = '/legacy/assets/js/countdown.js';
  ...
  (function() {
    var fonts = [
      { href: '/legacy/assets/fonts/bebas-neue-400.woff2', type: 'font/woff2' },
      { href: '/legacy/assets/fonts/space-mono-400.woff2', type: 'font/woff2' },
    ];
