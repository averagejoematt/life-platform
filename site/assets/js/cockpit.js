...
/* ── #1375 RETIRED at the September 1st launch re-anchor (owner decision, Session O
   Phase D1). `loadAttemptLine()` rendered "Attempt #N — previous best: D days" into the
   cockpit hero's [data-bind="attempt"] node from /api/survival (+ /api/cycle_compare
