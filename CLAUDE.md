...
- `docs/ARCHITECTURE.md` — full system design, 59 Lambdas, 7 CDK stacks, data flows
...
3. **Serve/Compute**:
   - **MCP Lambda** — 116 tools across 25 domain modules (`mcp/tools_*.py`), accessed via Claude Desktop and claude.ai
