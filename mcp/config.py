...
SOURCES = ["whoop", "withings", "strava", "todoist", "apple_health", "hevy", "eightsleep", "chronicling", "macrofactor", "garmin", "habitify", "notion", "labs", "dexa", "genome", "weather", "supplements", "state_of_mind", "habit_scores", "google_calendar"]
