...
class EmailStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str,
        ...
        create_platform_lambda(self, "BrittanyWeeklyEmail", function_name="brittany-weekly-email", handler="emails.brittany_email_lambda.lambda_handler", source_file="lambdas/emails/brittany_email_lambda.py", schedule="cron(30 17 ? * 1 *)", timeout_seconds=90, memory_mb=256, environment=_brittany_env, custom_policies=rp.email_brittany(), **shared)
