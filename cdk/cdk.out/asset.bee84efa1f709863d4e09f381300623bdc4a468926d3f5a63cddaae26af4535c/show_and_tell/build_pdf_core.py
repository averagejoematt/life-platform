...
IMG_DIR = "/Users/matthewwalker/Documents/Claude/life-platform/show_and_tell/processed"
W, H = letter
...
def toc(s):
    ...
    items = [
        ...
        ("10", "AI Integration",                   "Board of Directors · MCP · 122 tools · OAuth 2.1", None),
...
def week_in_life(s):
    ...
    class Timeline(Flowable):
        ...
        def draw(self):
            ...
            rows = [
                ...
                (102, 32, [
                    (6,"Partner Email","partner update",GREEN_S),
                ]),
                (62, 32, [
    ...
    callouts = [
        ...
        ("Sunday", GREEN_S,
         ...
         "Second: two accountability signals. The Partner email is a warm, narrative update written by "
...
def what_it_surfaces(s):
    ...
    domains = [
        ...
        ("Gamification — keeping the loop closed", ACCENT2, [
            ...
            "<b>Rewards system:</b> user-defined rewards triggered by milestone events — seeded by Matthew and Partner together",
...
def why_tools(s):
    ...
    class NoMemoryBox(Flowable):
        ...
        def draw(self):
            ...
            c.drawString(14, 24,
                "This is why there are 122 tools — not because the data is complex, but because each question")
            c.drawString(14, 12,
...
def features(s):
    ...
    els.append(Paragraph("Partner Email (Sunday 9:30 AM) · Habits Deep-Dive", s["h3a"]))
    els.append(two_col(
        "shot07_partner1",
...
def gamification_page(s):
    ...
    tier_path = "/Users/matthewwalker/Documents/Claude/life-platform/show_and_tell/tier_progression.png"
    ...
    mech = [
        ...
        ["Reward examples (Ph.4)",   "Weekend away · Spa day · New gear (fitness equipment, clothing) · Dinner out · Concert tickets · Experience-based events · Seeded together by Matthew + Partner"],
    ]
...
def architecture(s):
    ...
    arch_path = "/Users/matthewwalker/Documents/Claude/life-platform/show_and_tell/arch_diagram.png"
...
def security_ops(s):
    ...
    els.append(Paragraph(
        "The entire platform lives in a single git repository (v2.80.1.1 — 741 objects, ~80 sessions "
...
def ai_integration(s):
    ...
    els.append(Banner("10 — AI Integration",
        "Claude MCP · 122 tools · OAuth 2.1 · Sonnet 4.6 for synthesis · Haiku for extraction",
        acc=PURPLE))
    els.append(Spacer(1, 0.1*inch))
