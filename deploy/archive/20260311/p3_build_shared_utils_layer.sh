...
LAYER_VERSION_ARN=$(aws lambda publish-layer-version \
    ...
    --description "Shared utils: retry_utils, board_loader, insight_writer, scoring_engine, character_engine, output_writers, ai_calls, html_builder, ai_output_validator, ingestion_framework, ingestion_validator, item_size_guard (Python 3.12)" \
