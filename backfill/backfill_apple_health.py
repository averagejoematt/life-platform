...
EXPORT_PATH_DEFAULT = "/Users/matthewwalker/Documents/Claude/apple_health_export/export.xml"
...
def main():
    EXPORT_PATH = sys.argv[1] if len(sys.argv) > 1 else EXPORT_PATH_DEFAULT
