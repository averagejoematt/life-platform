---
name: craft-review
description: "Grade the repository as a craft artifact the way a promotion committee (Eng I through CIO) would read it cold. Use when asked whether the code would impress a senior engineer, how the codebase reads to an outsider, or for a seniority-calibrated quality bar."
user-invocable: true
argument-hint: "[scope or lens]"
