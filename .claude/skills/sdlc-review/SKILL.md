---
name: sdlc-review
description: "Audit the software lifecycle itself — how this platform is ideated, planned, built, reviewed, shipped and overseen — and grade each stage with evidence. Use to assess process and machinery rather than the product."
user-invocable: true
argument-hint: "[stage or lens]"
