---
name: interview
description: "Run the milestone deep interview — longform, biographical, unfiltered — and write a private brief to S3. Use at experiment milestones or when Matthew wants to talk at length about the journey rather than the data."
user-invocable: true
argument-hint: "[topic]"
