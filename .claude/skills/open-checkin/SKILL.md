---
name: open-checkin
description: "Free-form conversation with no queue to work — Matthew talks about whatever is on his mind, and the close routes each thread to the right platform tool. Use when he wants to talk without a specific agenda."
user-invocable: true
