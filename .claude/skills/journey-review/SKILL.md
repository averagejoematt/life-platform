---
name: journey-review
description: "Re-audit the chat-to-platform integration: do the conversational modes, MCP write tools and capture queues still line up with what the platform actually exposes. Use to check for drift between the chat modes and the engine."
user-invocable: true
