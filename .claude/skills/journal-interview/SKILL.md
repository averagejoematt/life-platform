...
description: "Interview Matthew conversationally, compose a journal entry from his answers, and publish it to Notion; the publish variant also lands a public essay PR. Use when asked to write a journal entry or capture reflections."
user-invocable: true
argument-hint: "[topic | publish]"
