---
name: site-review
description: "Holistic human-in-the-loop review of averagejoematt.com: does each page's story land, does the throughline cohere, does it read well to its intended audience. Use for narrative and UX judgment rather than correctness checks."
user-invocable: true
argument-hint: "[page or door]"
