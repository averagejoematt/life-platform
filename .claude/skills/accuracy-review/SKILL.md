...
description: "Truth-audit averagejoematt.com — verify published numbers against DynamoDB/API ground truth and check every AI-written narrative is grounded in real data. Use when asked whether the site's numbers are true, to audit for fabrication, causal overreach, privacy leaks or stale framing, or before trusting a stored AI artifact (chronicle, panelcast, board)."
user-invocable: true
argument-hint: "[axis-a | full]"
