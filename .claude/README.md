...
- **ADRs** — every non-trivial decision is recorded in [`docs/DECISIONS.md`](../docs/DECISIONS.md) (ADR-001…079). Reversible, dated, with context + consequences.
...
- **MCP server** (`mcp/`, `mcp_bridge.py`, `.mcp.json`) — 133 tools that let Claude query the live platform data directly during a session.
