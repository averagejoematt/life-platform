...
- **ADRs** — every non-trivial decision is recorded in [`docs/DECISIONS.md`](../docs/DECISIONS.md) (ADR-001…156). Reversible, dated, with context + consequences.
...
**22 skills** the agent invokes by name, each `‹name›/SKILL.md` with YAML frontmatter
