...
@media (min-width: 900px) { .mr-cols { grid-template-columns: minmax(0, 4fr) minmax(0, 6fr); } }
...
@media (min-width: 620px) { .mr-figs, .mr-pillars { grid-template-columns: repeat(4, minmax(0, 1fr)); } }
