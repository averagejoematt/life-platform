...
# ── #1351/#3043: DATA_GOVERNANCE.md fact gate — extracted to doc_facts_governance.py
# (2026-08-23, #1665 ceiling) — names re-exported here; the gate is unchanged.
import sys as _sys
...
from doc_facts_governance import (  # noqa: E402,F401
    ...
    DATA_GOVERNANCE_VERIFIED_MAX_AGE_DAYS,
    DELETE_LAMBDA_STALE_CLAIM,
    DG_SKIP_NOTICES,
    REPO_VISIBILITY_CLAIM,
    VERIFIED_HEADER_RE,
