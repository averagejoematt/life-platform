...
from gate_census_proofs import GUARD_PROOFS, QA_PROOFS, REGISTRY_PROOFS  # noqa: E402 — families 2, 3 (qa-smoke #3564), registry (#3544)

for _extracted in (GUARD_PROOFS, QA_PROOFS, REGISTRY_PROOFS):
