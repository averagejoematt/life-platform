...
def topbar() -> str:
    # /gear/ is a footer-tier page, not one of the five doors — no door is marked current.
    links = "".join(f'<a href="{href}" title="{esc(title)}">{door_icon(key)}{label}</a>' for href, label, key, title in DOORS)
    return (
...
FOOTER = (
    ...
    '<a href="/subscribe/">Follow by email</a><a href="/rss.xml">RSS</a><a href="/gear/">The gear</a><a href="/method/">The method</a><a href="/privacy/">Privacy</a></div>'
