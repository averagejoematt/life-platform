...
def _build_intro_script(bible: dict) -> list:
    ...
    system = (
        ...
        "when a point needs more room, the other person cuts in, reacts, or asks, and it continues in the reply. Cut filler. Favour short, vivid, QUOTABLE lines someone would screenshot over long paragraphs. "
