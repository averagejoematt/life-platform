...
def _build_intro_script(bible: dict) -> list:
    ...
    system = (
        ...
        "the general pattern.\n"
        "  - EVERY topic shift is BRIDGED — one speaker's line hands the next topic to the other. This especially includes the "
        "reveal of the eight-coach AI team: it must surface from something Elena or Eli JUST said (a question, a doubt, a "
        "concrete example), never appear from nowhere as the next agenda item.\n"
