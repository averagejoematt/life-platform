...
SOURCE_REGISTRY: dict[str, dict[str, Any]] = {
    "whoop": {
        ...
        "day_key_frame_consequence": (
            ...
            "the Pacific day, 2020-03-23..2026-09-19; re-measured whole-history 2026-09-21 on the live table (4,866 "
            "rows, keys 2020-03-20..2026-09-21), 2,250 of 2,250 straddling rows UTC-keyed, 0 Pacific, 0 neither — the "
            "count grew by exactly the one night that elapsed. NOT a defect in the store and NOT flipped at the writer: the "
