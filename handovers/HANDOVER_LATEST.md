...
set 97 → ≤45. The honest number at wrap is **63 open in all / 60 outside the Roadmap milestone** — a 34-issue
drain, 11 short of the target. Gross: **40 closed, 7 filed** (#3943 #3944 #3945 #3946 #3971 #3972 + the
auto-filed #3980). The owner sheet was applied at boot by asking each gated item one at a time (11 rulings,
...
- **#3980** — auto-filed 13:20Z by the cron-freshness advisory; decoded on the issue.
...
**Backlog:** 97 → 63 open (60 non-Roadmap); Now carries the four armed PRs' issues + #3980 (milestoned Now at wrap); 7 filed (#3943 #3944 #3945 #3946 #3971 #3972 #3980); hygiene 12 → 0 at boot
**Alarms:** ✅ every alarm in ALARM state >72h cites an incident row or issue (wrap_gates e10, 15:1xZ)
**CI warnings:** latest completed main run red on the #3609 gate (see Main); cron-freshness advisory red since 13:20Z (#3980)
