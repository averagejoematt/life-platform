...
- shot07_partner1: Coach Rodriguez "What's driving it" paragraph (emotionally vulnerable content)
...
1. Reward seeding (prerequisite for Partner email fixes)
2. Partner weekly email debugging (deployed but Board sections not rendering)
3. Google Calendar integration
4. Character Sheet Phase 4

## Open Items
- PARTNER_EMAIL env var: not yet set on partner-weekly-email Lambda
- Partner email Board sections not rendering — CloudWatch logs needed to diagnose
