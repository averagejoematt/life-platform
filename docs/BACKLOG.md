...
> 11 won't-do → the parked register, `docs/reviews/PLATFORM_PRODUCT_REVIEW_2026-07.md` +
> pointer issue [#423](https://github.com/averagejoematt/life-platform/issues/423)). The
> shipped-history sections retain archival value.
