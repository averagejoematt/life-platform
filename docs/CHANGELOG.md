...
### Changed
- Genesis re-anchored to **2026-09-06**. Baseline weight: **326.2 lbs** (Withings).
...
### Changed
- Genesis re-anchored to **2026-09-05**. Baseline weight: **324.64 lbs** (Withings).
- All Lambda code that referenced `"2026-04-01"` or `307` literals migrated to import from `lambdas.constants`.
- `character_sheet_lambda.fetch_date` now filters tombstones (clean-slate cascade).
...
### Changed
- Genesis re-anchored to **2026-09-04**. Baseline weight: **324.64 lbs** (Withings).
- All Lambda code that referenced `"2026-04-01"` or `307` literals migrated to import from `lambdas.constants`.
- `character_sheet_lambda.fetch_date` now filters tombstones (clean-slate cascade).
...
### Changed
- Genesis re-anchored to **2026-09-01**. Baseline weight: **326.24 lbs** (Withings).
- All Lambda code that referenced `"2026-04-01"` or `307` literals migrated to import from `lambdas.constants`.
- `character_sheet_lambda.fetch_date` now filters tombstones (clean-slate cascade).
...
### Changed
- Genesis re-anchored to **2026-08-17**. Baseline weight: **321.01 lbs** (Withings).
- All Lambda code that referenced `"2026-04-01"` or `307` literals migrated to import from `lambdas.constants`.
- `character_sheet_lambda.fetch_date` now filters tombstones (clean-slate cascade).
...
### Changed
- Genesis re-anchored to **2026-08-10**. Baseline weight: **321.6 lbs** (Withings).
- All Lambda code that referenced `"2026-04-01"` or `307` literals migrated to import from `lambdas.constants`.
- `character_sheet_lambda.fetch_date` now filters tombstones (clean-slate cascade).
...
### Changed
- Genesis re-anchored to **2026-08-03**. Baseline weight: **321.6 lbs** (Withings).
- All Lambda code that referenced `"2026-04-01"` or `307` literals migrated to import from `lambdas.constants`.
- `character_sheet_lambda.fetch_date` now filters tombstones (clean-slate cascade).
...
### Changed
- Genesis re-anchored to **2026-07-27**. Baseline weight: **317.61 lbs** (Withings).
- All Lambda code that referenced `"2026-04-01"` or `307` literals migrated to import from `lambdas.constants`.
- `character_sheet_lambda.fetch_date` now filters tombstones (clean-slate cascade).
...
### Changed
- Genesis re-anchored to **2026-07-22**. Baseline weight: **321.38 lbs** (Withings).
- All Lambda code that referenced `"2026-04-01"` or `307` literals migrated to import from `lambdas.constants`.
- `character_sheet_lambda.fetch_date` now filters tombstones (clean-slate cascade).
...
### Changed
- Genesis re-anchored to **2026-07-20**. Baseline weight: **315.0 lbs** (Withings).
- All Lambda code that referenced `"2026-04-01"` or `307` literals migrated to import from `lambdas.constants`.
- `character_sheet_lambda.fetch_date` now filters tombstones (clean-slate cascade).
...
### Changed
- Genesis re-anchored to **2026-07-19**. Baseline weight: **315.65 lbs** (Withings).
- All Lambda code that referenced `"2026-04-01"` or `307` literals migrated to import from `lambdas.constants`.
- `character_sheet_lambda.fetch_date` now filters tombstones (clean-slate cascade).
...
### Changed
- Genesis re-anchored to **2026-07-18**. Baseline weight: **315.65 lbs** (Withings).
- All Lambda code that referenced `"2026-04-01"` or `307` literals migrated to import from `lambdas.constants`.
- `character_sheet_lambda.fetch_date` now filters tombstones (clean-slate cascade).
...
### Changed
- Genesis re-anchored to **2026-07-13**. Baseline weight: **314.0 lbs** (Withings).
- All Lambda code that referenced `"2026-04-01"` or `307` literals migrated to import from `lambdas.constants`.
- `character_sheet_lambda.fetch_date` now filters tombstones (clean-slate cascade).
...
### Changed
- Genesis re-anchored to **2026-07-12**. Baseline weight: **300.8 lbs** (Withings).
- All Lambda code that referenced `"2026-04-01"` or `307` literals migrated to import from `lambdas.constants`.
- `character_sheet_lambda.fetch_date` now filters tombstones (clean-slate cascade).
