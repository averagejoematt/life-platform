...
- `lambdas/partner_email_lambda.py`: `USER_ID` env var wired; 3 hardcoded `USER#matthew` strings replaced with f-string references (D1 compliance)
...
- `deploy/fix_partner_user_id.py`: Fix script (applied)
