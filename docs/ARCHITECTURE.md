...
Last updated: 2026-07-25 (v8.6.0 — 71 tools, 37-module MCP package, 20 data sources, 97 Lambdas, 21 secrets, 78 alarms, 9 CDK stacks deployed).
...
┌────────────────────────▼────────────────────────────────────┐
│  SERVE LAYER                                                │
│  MCP Server Lambda (71 tools, 768 MB) + Lambda Function URL │
...
**Lambda:** `life-platform-mcp` | **Tools:** 71 | **Memory:** 768 MB | **Runtime:** python3.12 | **Modules:** 37 (`mcp/tools_*.py` + helpers)
