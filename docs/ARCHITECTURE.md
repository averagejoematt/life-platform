...
Last updated: 2026-07-26 (v8.6.0 — 74 tools, 37-module MCP package, 20 data sources, 98 Lambdas, 21 secrets, 78 alarms, 9 CDK stacks deployed).
...
┌────────────────────────▼────────────────────────────────────┐
│  SERVE LAYER                                                │
│  MCP Server Lambda (74 tools, 768 MB) + Lambda Function URL │
...
**Lambda:** `life-platform-mcp` | **Tools:** 74 | **Memory:** 768 MB | **Runtime:** python3.12 | **Modules:** 37 (`mcp/tools_*.py` + helpers)
