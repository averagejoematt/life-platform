...
Last updated: 2026-09-14 (v8.6.0 — 81 tools, 45-module MCP package, 20 data sources, 105 Lambdas, 26 secrets, 122 alarms, 10 CDK stacks deployed).
...
┌────────────────────────▼────────────────────────────────────┐
│  SERVE LAYER                                                │
│  MCP Server Lambda (81 tools, 768 MB) + Lambda Function URL │
...
**Lambda:** `life-platform-mcp` | **Tools:** 81 | **Memory:** 768 MB | **Runtime:** python3.12 | **Modules:** 45 (`mcp/tools_*.py` + helpers)
