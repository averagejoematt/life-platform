...
┌────────────────────────▼────────────────────────────────────┐
│  SERVE LAYER                                                │
│  MCP Server Lambda (73 tools, 768 MB) + Lambda Function URL │
...
**Lambda:** `life-platform-mcp` | **Tools:** 73 | **Memory:** 768 MB | **Runtime:** python3.12 | **Modules:** 37 (`mcp/tools_*.py` + helpers)
