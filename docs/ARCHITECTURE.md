...
Last updated: 2026-09-14 (v8.6.0 — 82 tools, 45-module MCP package, 20 data sources, 105 Lambdas, 26 secrets, 122 alarms, 10 CDK stacks deployed).
...
**Lambda:** `life-platform-mcp` | **Tools:** 82 | **Memory:** 768 MB | **Runtime:** python3.12 | **Modules:** 45 (`mcp/tools_*.py` + helpers)
