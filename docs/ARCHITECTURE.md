...
Last updated: 2026-08-03 (v8.6.0 — 76 tools, 37-module MCP package, 20 data sources, 99 Lambdas, 25 secrets, 91 alarms, 9 CDK stacks deployed).
...
CloudWatch carries **~91 metric alarms** (CDK-declared; the count is auto-discovered by `deploy/sync_doc_metadata.py` and the inventory is regenerated into `docs/MONITORING.md`).
