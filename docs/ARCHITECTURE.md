...
Last updated: 2026-09-21 (v8.6.0 — 84 tools, 52-module MCP package, 20 data sources, 105 Lambdas, 26 secrets, 127 alarms, 10 CDK stacks deployed).
...
**Lambda:** `life-platform-mcp` | **Tools:** 84 | **Memory:** 768 MB | **Runtime:** python3.12 | **Modules:** 52 (`mcp/tools_*.py` + helpers)
