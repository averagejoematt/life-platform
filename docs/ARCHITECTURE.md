...
Last updated: 2026-09-07 (v8.6.0 — 81 tools, 45-module MCP package, 20 data sources, 104 Lambdas, 26 secrets, 120 alarms, 10 CDK stacks deployed).
...
CloudWatch carries **~120 metric alarms** (CDK-declared; the count is auto-discovered by `deploy/sync_doc_metadata.py` and the inventory is regenerated into `docs/MONITORING.md`).
