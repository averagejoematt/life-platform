...
Last updated: 2026-09-07 (v8.6.0 — 81 tools, 44-module MCP package, 20 data sources, 104 Lambdas, 26 secrets, 121 alarms, 10 CDK stacks deployed).
...
**Lambda:** `life-platform-mcp` | **Tools:** 81 | **Memory:** 768 MB | **Runtime:** python3.12 | **Modules:** 44 (`mcp/tools_*.py` + helpers)
