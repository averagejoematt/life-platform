...
┌────────────────────────▼────────────────────────────────────┐
│  SERVE LAYER                                                │
│  MCP Server Lambda (72 tools, 768 MB) + Lambda Function URL │
...
**Lambda:** `life-platform-mcp` | **Tools:** 72 | **Memory:** 768 MB | **Runtime:** python3.12 | **Modules:** 37 (`mcp/tools_*.py` + helpers)
