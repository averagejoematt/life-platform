...
Last updated: 2026-09-24 (v8.6.0 — 86 tools, 60-module MCP package, 20 data sources, 106 Lambdas, 26 secrets, 129 alarms, 10 CDK stacks deployed).
...
**Lambda:** `life-platform-mcp` | **Tools:** 86 | **Memory:** 768 MB | **Runtime:** python3.12 | **Modules:** 60 (`mcp/tools_*.py` + helpers)
