...
Last updated: 2026-09-07 (v8.6.0 — 76 tools, 40-module MCP package, 20 data sources, 104 Lambdas, 26 secrets, 120 alarms, 10 CDK stacks deployed).
...
**Lambda:** `life-platform-mcp` | **Tools:** 76 | **Memory:** 768 MB | **Runtime:** python3.12 | **Modules:** 40 (`mcp/tools_*.py` + helpers)
