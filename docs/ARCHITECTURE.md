...
Last updated: 2026-03-14 (v3.7.20 — 87 tools, 31-module MCP package, 19 data sources, 43 Lambdas, 8 secrets, 42 alarms, 8 CDK stacks deployed)
...
┌────────────────────────▼────────────────────────────────────┐
│  SERVE LAYER                                                │
│  MCP Server Lambda (86 tools, 1024 MB) + Lambda Function URL│
...
~/Documents/Claude/life-platform/
  ...
  docs/
    ...
    MCP_TOOL_CATALOG.md           ← All 86 tools with params, cache, deps
