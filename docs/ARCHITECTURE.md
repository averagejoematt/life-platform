...
Last updated: 2026-08-08 (v8.6.0 — 76 tools, 37-module MCP package, 20 data sources, 101 Lambdas, 25 secrets, 93 alarms, 9 CDK stacks deployed).
...
**Lambda:** `life-platform-mcp` | **Tools:** 76 | **Memory:** 768 MB | **Runtime:** python3.12 | **Modules:** 37 (`mcp/tools_*.py` + helpers)
