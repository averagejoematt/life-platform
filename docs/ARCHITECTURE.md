...
Last updated: 2026-09-23 (v8.6.0 — 84 tools, 55-module MCP package, 20 data sources, 106 Lambdas, 26 secrets, 128 alarms, 10 CDK stacks deployed).
...
**Lambda:** `life-platform-mcp` | **Tools:** 84 | **Memory:** 768 MB | **Runtime:** python3.12 | **Modules:** 55 (`mcp/tools_*.py` + helpers)
