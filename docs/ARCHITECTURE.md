...
Last updated: 2026-09-14 (v8.6.0 — 82 tools, 45-module MCP package, 20 data sources, 105 Lambdas, 26 secrets, 123 alarms, 10 CDK stacks deployed).
...
CloudWatch carries **~123 metric alarms** (CDK-declared; the count is auto-discovered by `deploy/sync_doc_metadata.py` and the inventory is regenerated into `docs/MONITORING.md`).
