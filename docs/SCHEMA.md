...
**Last updated:** 2026-07-30 (v8.6.0 — 76 MCP tools, 20 data sources, 99 Lambdas, 12 cached tools)
...
| Value         | Meaning                                                          |
|---------------|------------------------------------------------------------------|
| `experiment`  | Record dated on or after EXPERIMENT_START_DATE (currently 2026-07-27). |
