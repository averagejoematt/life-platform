...
**Last updated:** 2026-08-24 (v8.6.0 — 76 MCP tools, 20 data sources, 104 Lambdas, 12 cached tools)
...
| Value         | Meaning                                                          |
|---------------|------------------------------------------------------------------|
| `experiment`  | Record dated on or after EXPERIMENT_START_DATE (currently 2026-08-17). |
