...
**Last updated:** 2026-07-20 (v8.6.0 — 68 MCP tools, 20 data sources, 95 Lambdas, 12 cached tools)
...
| Value         | Meaning                                                          |
|---------------|------------------------------------------------------------------|
| `experiment`  | Record dated on or after EXPERIMENT_START_DATE (currently 2026-07-20). |
