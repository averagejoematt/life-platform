...
| Gate census + can-it-fail proofs (epic #2578) | Load-bearing | CI seconds, session attention | 523 declared gates with measured error bars; the week's cannot-fail finds (#2746, #2754) came from it. Count is DERIVED (`deploy/sync_doc_metadata.py`'s `gate_census_count` fact, #3000) rather than hand-typed — the prior "425" had drifted 13% behind #2639's widened derivation with nothing to notice. Demote trigger: census derivation cost exceeding one CI minute, or two consecutive sessions with zero acted-on findings |
