...
### DECISION 12: Inner Life Observatory (`/mind/`) Deep Review ✅ LOGGED

**Current state:** 952-line observatory page with violet color scheme. Current editorial design pattern. Hero: "The pillar I avoided building" with 4 gauges (Mind pillar level, Resist rate, Journal 30d, Vice streaks active). 3 pull-quotes with evidence badges. Vice streak grid. Connection depth + Willpower bars. Mood chart (conditional). "Building this measurement" gap section. Narrative: "The fifth pillar everyone avoids." Cross-links. Methodology.

**Data layer reality:** Journal entries (90d): 1. State-of-mind check-ins: 3 (all one day). Social interactions logged: 0. Mood trend: insufficient data. Vice streaks are the only domain with depth.

**Core diagnosis:** The data sparsity IS the most honest data point on the site. The man who tracks every gram of protein has one journal entry. The page currently treats sparse data as something to apologize for. It should own that asymmetry as its thesis. Vice streaks carry 60% of the page weight — the emotional architecture needs to be the reverse. This is the causal root of the entire site: when inner life deteriorates, every other domain follows.

**Matthew's stated position:** This is the center of the experiment. The weight he could do without the platform. The inner life — anxiety, imposter syndrome, social anxiety, self-esteem, people-pleasing — is what the platform exists to solve.

**Approved recommendations:**

| # | Recommendation | Category | Effort | Priority |
|---|---------------|----------|--------|----------|
| 12a | **Expand narrative intro — site's most personal writing** — 3-4 paragraph confessional. First person. No hedging. | Content | Low-Med | Must-have |
| 12b | **Restructure page arc: Vulnerability → Commitment → Evidence → Intelligence** | IA | Medium | Must-have |
| 12c | **Reframe data sparsity as the story** — "The data gap IS the data" | Content | Low | Must-have |
| 12d | **Add cross-domain causal connections** — sleep → mood, training → anxiety, HRV as correlate | Data/Content | Medium | Must-have |
| 12e | **Redesign social connection section** — intention-first, not empty scorecard | Design/Content | Medium | Must-have |
| 12f | **Elevate the five commitments** — move from bottom to after intro, reframe as promises | IA/Content | Low | Must-have |
| 12g | **Add intelligence layer preview** — empty frameworks with labels/axes | Feature/Design | Medium | Should-have |
| 12h | **Differentiate visual language** — more intimate than other observatories | Design | Medium | Should-have |
| 12i | **Name clinical reality honestly** — anxiety, withdrawal are patterns, not quirks | Content | Low | Should-have |
| 12j | **Add "What this page will become" section** — 6-month vision | Content | Low | Should-have |
| 12k | **Make vice streaks warmer** — connect to the *why* per category | Content | Low | Should-have |
| 12l | **Add journal excerpt section** (when data permits) | Feature | Medium | Should-have |
| 12m | **State causal hierarchy explicitly** — this pillar determines all others | Content | Low | Must-have |
| 12n | **Protect the title** — "The pillar I avoided building" (GUARDRAIL) | Guardrail | None | Guardrail |
| 12o | **Journal-prompted annotations** | Feature | High | Post-launch |
| 12p | **Reader reflection mechanism** | Feature | High | Post-launch |

**Key themes:** Data sparsity is the thesis. Causal root of the site. Page should feel like opening a notebook, not a dashboard. Five commitments are best content and buried. Vice streaks carry too much weight. Inner life content is the growth engine.

**Implementation scope:**
- [ ] Content: write expanded narrative intro (3-4 paragraphs, first person)
- [ ] IA: restructure sections → Vulnerability → Commitment → Evidence → Intelligence
- [ ] Content: reframe data sparsity as thesis
- [ ] Content: elevate and reframe five commitments as personal promises
- [ ] Content: add causal hierarchy statement
- [ ] Content: name clinical reality honestly
- [ ] Frontend: redesign social connection — intention-first
- [ ] Frontend: intelligence layer preview (empty frameworks)
- [ ] Design: visual language differentiation pass
- [ ] Content: vice streak warmth/context
- [ ] Content: "What this page will become" vision section
- [ ] Frontend: cross-domain causal arrows
- [ ] Post-launch: journal annotations (12o), reader reflections (12p), journal excerpts (12l)

---

### DECISION 13: Benchmarks / The Standards (`/benchmarks/`) Deep Review ✅ LOGGED

**Current state:** 915-line page titled "The Standards." 6 domains (Physical, Sleep, Cognitive, Emotional, Social, Discipline), 27 benchmark cards. Each: name, evidence rating (●●●/●●/●), target, progress bar + letter grade, trend arrow, "why," source. Domain headers have bespoke visualizations. Bottom: interactive self-check (6 inputs, compare to research). All data from API.

**Core diagnosis:** Identity confusion — personal scorecard vs reader reference library — resolved by sequencing, not choosing. Self-check first (reader) → research library (reference) → Matthew's data (personal). Currently backwards.

**Approved recommendations:**

| # | Recommendation | Category | Effort | Priority |
|---|---------------|----------|--------|----------|
| 13a | **Elevate self-check to page hero** — reader confronts themselves first | IA/Feature | Medium | Must-have |
| 13b | **Add one narrative moment** — which benchmark scares/drives him | Content | Low | Must-have |
| 13c | **Add "math of decline" context** — why these specific numbers | Content | Low | Must-have |
| 13d | **Domain-specific cross-links** to observatory pages | IA | Low | Must-have |
| 13e | **Add importance gradient** — survival vs quality benchmarks | Design/Content | Medium | Should-have |
| 13f | **Shareable self-check results** — social card with 6 grades | Growth | Medium | Should-have |
| 13g | **Per-benchmark deep-link anchors** for SEO | SEO/IA | Low | Should-have |
| 13h | **Cognitive-physical crossover note** | Content | Low | Should-have |
| 13i | **Visual consistency pass on domain headers** | Design | Medium | Should-have |
| 13j | **Add "Day 1 vs Now" column** — three-point comparison | Data | Medium | Should-have |
| 13k | **Separate research from personal data layer** per card | UX | Medium | Should-have |
| 13l | **Resolve "Tracking soon" benchmarks** — track or remove | Content | Low | Must-have |
| 13m | **Individual benchmark micro-pages** | Content/SEO | High | Post-launch |
| 13n | **Reader benchmark tracking** | Feature | High | Post-launch |

**Key themes:** Self-check is highest-potential growth feature, currently buried. Evidence rating (●●●) is a credibility asset. Page needs one human moment. "Tracking soon" is a credibility liability. 27-benchmark SEO opportunity. "Day 1 vs Now" reveals the journey.

**Implementation scope:**
- [ ] IA: restructure — self-check hero, then domains, then Matthew's data
- [ ] Feature: expand self-check with instant grades + research context
- [ ] Feature: shareable results card
- [ ] Content: narrative moment from Matthew
- [ ] Content: "math of decline" context
- [ ] Content: cognitive-physical crossover note
- [ ] IA: domain-specific cross-links
- [ ] Design: importance gradient visual hierarchy
- [ ] Frontend: per-benchmark anchor IDs
- [ ] Design: domain header visual consistency pass
- [ ] Content: resolve "Tracking soon" benchmarks
- [ ] UX: separate research from personal data per card
- [ ] Data: Day 1 baseline values
- [ ] Post-launch: micro-pages (13m), reader tracking (13n)

---

### DECISION 14: Data Explorer (`/explorer/`) Deep Review ✅ LOGGED

**Current state:** 550-line interactive page. `/api/correlations` endpoint. Curated "Most Interesting Correlations" (6 featured). Full grid: every metric pair with Pearson r, strength, FDR significance, lagged indicators. Filters: All/Strong/Significant/Predictive/Positive/Negative. Click → detail panel. "Submit a Finding" form. Methodology (FDR correction, lagged analysis, thresholds). 19 data sources.

**Core diagnosis:** Technically excellent, narratively empty. Real data science (FDR, lagged analysis) but expects reader to supply curiosity, literacy, and interpretation. Three audiences unserved: casual (curated), data-curious (browsable), technical (queryable). Curated first, browsable second, queryable third.

**Approved recommendations:**

| # | Recommendation | Category | Effort | Priority |
|---|---------------|----------|--------|----------|
| 14a | **Expand curated findings to hero** — 3-5 editorial features, plain-language | IA/Content | Medium | Must-have |
| 14b | **Elevate lagged (predictive) correlations** — own section, not filter chip | IA | Low-Med | Must-have |
| 14c | **Default to FDR Significant** not All Pairs | UX | Low | Must-have |
| 14d | **Add one narrative anchor** | Content | Low | Must-have |
| 14e | **Add "Pick Two Metrics" query mode** | Feature | Medium | Should-have |
| 14f | **Visual hierarchy by significance** | Design | Medium | Should-have |
| 14g | **Close loop to action** — link correlations to observatories | IA | Medium | Should-have |
| 14h | **Cross-domain differentiator callout** | Content | Low | Should-have |
| 14i | **Elevate Submit a Finding** | UX/Growth | Low | Should-have |
| 14j | **Plan for scale** | Architecture | Medium | Post-launch |
| 14k | **Consider renaming** | Content | Low | Nice-to-have |
| 14l | **Scatter plot visualization** | Data viz | Medium | Post-launch |

**Key themes:** Technically world-class, presentation not. Three audiences, one interface. Lagged correlations are the killer feature. Default view undermines credibility. Submit a Finding is undervalued growth mechanic. Cross-domain is the differentiator.

**Implementation scope:**
- [ ] IA: expand curated findings from cards to editorial features
- [ ] IA: dedicated Predictive Findings section
- [ ] UX: default filter to FDR Significant
- [ ] Content: narrative anchor from Matthew
- [ ] Feature: Pick Two Metrics dropdown query
- [ ] Design: card size scales with significance
- [ ] IA: link correlations to observatory pages
- [ ] Content: cross-domain callout
- [ ] UX: elevate Submit a Finding CTA
- [ ] Post-launch: scatter plots (14l), AI curation scaling (14j)

---

### DECISION 15: Discoveries (`/discoveries/`) Deep Review ✅ LOGGED

**Current state:** 583-line chronological timeline. `/api/journey_timeline`. 7 event types (Weight/Level Up/Experiment/AI Finding/Surprise/Discovery/Milestone), color-coded. Filter bar. Stats header. DISC-7 behavioral response annotations. Currently empty (pre-launch). Heavy overlap with Milestones and Data Explorer.

**Core diagnosis:** Right instinct — chronological record of scientific journey. Three problems: (1) overlaps Milestones/Explorer without clarifying unique value, (2) launches empty, (3) flat timeline without synthesis. Unique value: the action loop (Finding → Action → Outcome).

**Approved recommendations:**

| # | Recommendation | Category | Effort | Priority |
|---|---------------|----------|--------|----------|
| 15a | **Narrow to scientific discoveries** — remove Weight/Level Up | IA | Low | Must-have |
| 15b | **Add executive summary** — "In N days, X findings, Y investigated, Z changed behavior" | Content/Feature | Medium | Must-have |
| 15c | **Lead with Surprises** — counterintuitive findings get prominence | IA/Design | Low | Must-have |
| 15d | **Pre-seed for launch** — Day 1 baselines, hypotheses, experiment starts | Content | Low | Must-have |
| 15e | **Elevate DISC-7 annotation loop** — Finding → Action → Outcome prominent | Feature/Design | Medium | Must-have |
| 15f | **Add discovery lifecycle status** — Observed → Investigating → Confirmed → Integrated | Feature | Medium | Must-have |
| 15g | **Time-based chapter groupings** — monthly breaks with summaries | Design/IA | Medium | Must-have |
| 15h | **Add inner life discoveries** — journal breakthroughs, pattern shifts | Content/Feature | Medium | Must-have |
| 15i | **Clarify relationship to Data Explorer** — cross-link both directions | IA | Low | Must-have |
| 15j | **Add Hypotheses section** — forward-looking active investigations | Content/Feature | Medium | Should-have |
| 15k | **Share mechanics per discovery** | Growth | Medium | Should-have |
| 15l | **Rename consideration** — "The Lab" / "What I've Learned" | Content | Low | Nice-to-have |
| 15m | **Proof-of-concept aggregate metric** — "X% of findings → behavior change" | Feature | Medium | Should-have |

**Key themes:** Action loop is the unique value. Too broad with 7 event types. Must not launch empty. Surprises are crown jewel content. Inner life absent from timeline. Lifecycle status turns list into research pipeline. Chapters prevent scroll fatigue.

**Implementation scope:**
- [ ] IA: remove Weight and Level Up events
- [ ] Feature: executive summary with dynamic stats
- [ ] Design: visual prominence for counterintuitive findings
- [ ] Content: pre-seed Day 1 events
- [ ] Design: elevate annotation display
- [ ] Feature: lifecycle status badges
- [ ] Design: chapter groupings with summaries
- [ ] Feature: inner life event types
- [ ] IA: cross-link with Data Explorer
- [ ] Content: Hypotheses section
- [ ] Feature: share cards per discovery
- [ ] Feature: proof-of-concept aggregate metrics

### DECISION 16: _(pending — next page)_

---

## UPDATED PAGES REVIEWED
...
### Part 2 (In Progress)
- [x] Inner Life / Mind — `/mind/` (Decision 12)
- [x] Benchmarks — `/benchmarks/` (Decision 13)
- [x] Data Explorer — `/explorer/` (Decision 14)
- [x] Discoveries — `/discoveries/` (Decision 15)
- [ ] Stack — `/stack/`
- [ ] Protocols — `/protocols/`
- [ ] Supplements — `/supplements/`
- [ ] Experiments — `/experiments/`
...
- [ ] Story page — `/story/`
- [ ] About / Mission — `/about/`
- [ ] **Cross-cutting:** Final prioritization + implementation sequencing
