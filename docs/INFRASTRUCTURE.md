...
> Last updated: 2026-08-23 (v8.6.0 — 104 Lambdas, 26 active secrets, 76 MCP tools, ~110 alarms)
...
| CloudWatch alarms | **~110 metric alarms** (base + invocation-count + DDB item size + canary + duration + freshness + pipeline health) |
