...
> Last updated: 2026-09-07 (v8.6.0 — 104 Lambdas, 26 active secrets, 81 MCP tools, ~120 alarms)
...
| Tools | **81** across **29** tool modules (`mcp/tools_*.py`) |
...
| CloudWatch alarms | **~120 metric alarms** (base + invocation-count + DDB item size + canary + duration + freshness + pipeline health) |
