...
> Last updated: 2026-07-27 (v8.6.0 — 99 Lambdas, 21 active secrets, 75 MCP tools, ~80 alarms)
...
| Tools | **75** across **25** tool modules (`mcp/tools_*.py`) |
...
| CloudWatch alarms | **~80 metric alarms** (base + invocation-count + DDB item size + canary + duration + freshness + pipeline health) |
