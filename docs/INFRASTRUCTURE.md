...
> Last updated: 2026-09-19 (v8.6.0 — 105 Lambdas, 26 active secrets, 84 MCP tools, ~127 alarms)
...
| CloudWatch alarms | **~127 metric alarms** (base + invocation-count + DDB item size + canary + duration + freshness + pipeline health) |
