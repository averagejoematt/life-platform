...
> Last updated: 2026-08-07 (v8.6.0 — 99 Lambdas, 25 active secrets, 76 MCP tools, ~92 alarms)
...
| CloudWatch alarms | **~92 metric alarms** (base + invocation-count + DDB item size + canary + duration + freshness + pipeline health) |
