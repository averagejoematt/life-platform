...
> Last updated: 2026-09-04 (v8.6.0 — 104 Lambdas, 26 active secrets, 76 MCP tools, ~118 alarms)
...
| CloudWatch alarms | **~118 metric alarms** (base + invocation-count + DDB item size + canary + duration + freshness + pipeline health) |
