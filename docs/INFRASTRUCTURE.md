...
> Last updated: 2026-08-10 (v8.6.0 — 103 Lambdas, 26 active secrets, 76 MCP tools, ~96 alarms)
...
| CloudWatch alarms | **~96 metric alarms** (base + invocation-count + DDB item size + canary + duration + freshness + pipeline health) |
