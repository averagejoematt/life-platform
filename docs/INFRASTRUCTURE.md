...
> Last updated: 2026-09-07 (v8.6.0 — 104 Lambdas, 26 active secrets, 81 MCP tools, ~121 alarms)
...
| CloudWatch alarms | **~121 metric alarms** (base + invocation-count + DDB item size + canary + duration + freshness + pipeline health) |
