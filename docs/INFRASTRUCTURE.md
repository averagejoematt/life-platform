...
> Last updated: 2026-07-18 (v8.6.0 — 94 Lambdas, 21 active secrets, 64 MCP tools, ~69 alarms)
...
| CloudWatch alarms | **~69 metric alarms** (base + invocation-count + DDB item size + canary + duration + freshness + pipeline health) |
