...
> Last updated: 2026-09-14 (v8.6.0 — 105 Lambdas, 26 active secrets, 81 MCP tools, ~122 alarms)
...
| CloudWatch alarms | **~122 metric alarms** (base + invocation-count + DDB item size + canary + duration + freshness + pipeline health) |
