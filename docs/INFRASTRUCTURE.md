...
> Last updated: 2026-08-13 (v8.6.0 — 104 Lambdas, 26 active secrets, 76 MCP tools, ~99 alarms)
...
| CloudWatch alarms | **~99 metric alarms** (base + invocation-count + DDB item size + canary + duration + freshness + pipeline health) |
