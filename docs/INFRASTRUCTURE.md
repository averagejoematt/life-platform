...
> Last updated: 2026-07-19 (v8.6.0 — 94 Lambdas, 21 active secrets, 67 MCP tools, ~75 alarms)
...
| CloudWatch alarms | **~75 metric alarms** (base + invocation-count + DDB item size + canary + duration + freshness + pipeline health) |
