...
> Last updated: 2026-08-03 (v8.6.0 — 99 Lambdas, 25 active secrets, 76 MCP tools, ~86 alarms)
...
| CloudWatch alarms | **~86 metric alarms** (base + invocation-count + DDB item size + canary + duration + freshness + pipeline health) |
