...
> Last updated: 2026-08-01 (v8.6.0 — 99 Lambdas, 21 active secrets, 76 MCP tools, ~81 alarms)
...
| CloudWatch alarms | **~81 metric alarms** (base + invocation-count + DDB item size + canary + duration + freshness + pipeline health) |
