...
> Last updated: 2026-07-19 (v8.6.0 — 94 Lambdas, 21 active secrets, 66 MCP tools, ~71 alarms)
...
| Tools | **66** across **23** tool modules (`mcp/tools_*.py`) |
...
| CloudWatch alarms | **~71 metric alarms** (base + invocation-count + DDB item size + canary + duration + freshness + pipeline health) |
