...
> Last updated: 2026-08-11 (v8.6.0 — 103 Lambdas, 26 active secrets, 76 MCP tools, ~97 alarms)
...
| CloudWatch alarms | **~97 metric alarms** (base + invocation-count + DDB item size + canary + duration + freshness + pipeline health) |
