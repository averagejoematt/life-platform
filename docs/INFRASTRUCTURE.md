...
> Last updated: 2026-08-16 (v8.6.0 — 104 Lambdas, 26 active secrets, 76 MCP tools, ~100 alarms)
...
| CloudWatch alarms | **~100 metric alarms** (base + invocation-count + DDB item size + canary + duration + freshness + pipeline health) |
