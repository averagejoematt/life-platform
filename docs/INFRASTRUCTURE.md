...
> Last updated: 2026-08-24 (v8.6.0 — 104 Lambdas, 26 active secrets, 76 MCP tools, ~111 alarms)
...
| CloudWatch alarms | **~111 metric alarms** (base + invocation-count + DDB item size + canary + duration + freshness + pipeline health) |
