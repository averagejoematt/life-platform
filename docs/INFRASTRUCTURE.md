...
> Last updated: 2026-09-14 (v8.6.0 — 105 Lambdas, 26 active secrets, 82 MCP tools, ~123 alarms)
...
| Tools | **82** across **29** tool modules (`mcp/tools_*.py`) |
...
| CloudWatch alarms | **~123 metric alarms** (base + invocation-count + DDB item size + canary + duration + freshness + pipeline health) |
