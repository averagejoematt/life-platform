...
> Last updated: 2026-07-20 (v8.6.0 — 94 Lambdas, 21 active secrets, 68 MCP tools, ~77 alarms)
...
| CloudWatch alarms | **~77 metric alarms** (base + invocation-count + DDB item size + canary + duration + freshness + pipeline health) |
