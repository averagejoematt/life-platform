...
> Last updated: 2026-09-24 (v8.6.0 — 106 Lambdas, 26 active secrets, 86 MCP tools, ~129 alarms)
...
| Tools | **86** across **34** tool modules (`mcp/tools_*.py`) |
...
| CloudWatch alarms | **~129 metric alarms** (base + invocation-count + DDB item size + canary + duration + freshness + pipeline health) |
