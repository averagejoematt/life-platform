...
| `get_date_range` | source, start_date, end_date | Get time-series records for a single source. Returns raw daily data for windows up to 90 days, monthly aggregates beyond that. Use get_aggregated_summary for multi-year trends. |
