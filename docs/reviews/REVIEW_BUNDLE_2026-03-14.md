...
S3 lifecycle script for deploy artifacts, confirmed Partner email address already
...
- `aws sesv2 create-email-identity --email-identity [partner-address-redacted] --region us-west-2`
...
### Infrastructure (14)
`life-platform-freshness-checker` · `dropbox-poll` · `insight-email-parser` · `life-platform-key-rotator` · `dashboard-refresh` · `life-platform-data-export` · `life-platform-qa-smoke` · `life-platform-mcp` · `dlq-consumer` · `life-platform-canary` · `data-reconciliation` · `pip-audit` · `partner-weekly-email` · `sick-day-checker`
