...
- `deploy/p3_attach_shared_utils_layer.sh` — expanded from 11 → 16 Lambdas: adds `partner-weekly-email`, `daily-metrics-compute`, `adaptive-mode-compute`, `dashboard-refresh`
