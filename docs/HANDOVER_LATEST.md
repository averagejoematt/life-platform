...
|--------|----------|----------|
| `partner-weekly-email` | `lambda-weekly-digest-role` | `life-platform-email-role` |
...
- `life-platform-email-role` — 8 email Lambdas (daily-brief, monday-compass, nutrition-review, wednesday-chronicle, weekly-plate, anomaly-detector, partner-weekly-email + freshness-checker)
