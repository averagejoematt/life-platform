...
| A door a first-time reader can't say the purpose of, or wouldn't know what to click | Comprehension judge — ADVISORY until 2026-10-10 (#4182 M4) | `tests/comprehension_qa.py`; `visual-qa.yml` step |
