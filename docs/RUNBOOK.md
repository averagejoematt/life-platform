...
Last updated: 2026-07-25 (v8.6.0 — 71 MCP tools, 37-module package, 97 Lambdas, 20 data sources)
...
15. `restart_verify_rendered.py --old-genesis <outgoing>` — hard gate over the 92-URL v4 surface (apply mode only)
