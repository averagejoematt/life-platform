...
Last updated: 2026-08-09 (v8.6.0 — 76 MCP tools, 38-module package, 101 Lambdas, 20 data sources)

**Ground truth (point-in-time values are drift — run the command instead):**
- Lambda functions defined (CDK): 101 — re-derive via `python3 deploy/sync_doc_metadata.py` (AST discoverers)
