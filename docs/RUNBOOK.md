...
Last updated: 2026-08-04 (v8.6.0 — 76 MCP tools, 37-module package, 99 Lambdas, 20 data sources)
...
15. `restart_verify_rendered.py --old-genesis <outgoing>` — hard gate over the 95-URL v4 surface (apply mode only)
