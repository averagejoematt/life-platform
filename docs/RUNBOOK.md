...
Last updated: 2026-07-27 (v8.6.0 — 75 MCP tools, 37-module package, 99 Lambdas, 20 data sources)
...
15. `restart_verify_rendered.py --old-genesis <outgoing>` — hard gate over the 94-URL v4 surface (apply mode only)
