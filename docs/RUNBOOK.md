...
Last updated: 2026-09-26 (v8.6.0 — 86 MCP tools, 62-module package, 106 Lambdas, 20 data sources)
...
15. `restart_verify_rendered.py --old-genesis <outgoing>` — hard gate over the 98-URL v4 surface (apply mode only)
