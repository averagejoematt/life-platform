...
| `life-platform/notion` | Notion integration token | **Manual** | 180 days | 120 days |
| `life-platform/dropbox` | Dropbox app key | **Manual** | 180 days | 120 days |
...
# Walks through Garmin login + writes garth tokens to life-platform/garmin
```

**Withings / Strava / EightSleep:** similar — see `setup/` directory.
...
### `notion`, `dropbox`, `todoist`, `habitify`
