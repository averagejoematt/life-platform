...
> **Sources of truth:** `lambdas/compute/daily_metrics_compute_lambda.py` (`compute_readiness`, :443-483), `mcp/tools_health.py` (`tool_get_readiness_score`, :15-400), `lambdas/training/training_load.py`, `lambdas/health/personal_baselines.py` (`readiness_hrv_score`, :286-300)
