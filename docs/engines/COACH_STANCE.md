...
report = sync invoke coach-quality-gate      # fails OPEN on infra errors only
                                             ...
                                             #  allow-list + canonical facts — ai_calls.py:2126)
