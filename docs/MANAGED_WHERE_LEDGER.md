...
- Re-verified: 2026-08-23 — every row probed live (gh api + read-only AWS). Three rows
  ...
  `main-required-fast-lane` + `allow_auto_merge` explicitly marked NOT YET APPLIED
