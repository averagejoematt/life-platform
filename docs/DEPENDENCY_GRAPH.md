...
712 edges from the two-pass AST sweep (#2805 mechanism). Directions:
...
- Edge sites: 1242 total · 887 resolved · 355 dynamic (unresolvable at AST time, tagged — never guessed)
