...
687 edges from the two-pass AST sweep (#2805 mechanism). Directions:
...
- Edge sites: 1187 total · 850 resolved · 337 dynamic (unresolvable at AST time, tagged — never guessed)
