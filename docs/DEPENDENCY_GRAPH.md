...
684 edges from the two-pass AST sweep (#2805 mechanism). Directions:
...
- Edge sites: 1184 total · 847 resolved · 337 dynamic (unresolvable at AST time, tagged — never guessed)
