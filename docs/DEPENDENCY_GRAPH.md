...
| `freshness-checker-errors` | operational_stack | unresolved |
| `grading-stalled` | monitoring_stack | digest |
| `hae-webhook-no-invocations-24h` | monitoring_stack | digest |
| `hevy-restamp-errors` | operational_stack | unresolved |
| `hevy-routine-cron-errors` | operational_stack | unresolved |
...
| `key-rotator-errors` | operational_stack | unresolved |
| `life-platform-daily-brief-memory-high` | monitoring_stack | digest |
| `life-platform-data-export-errors` | operational_stack | unresolved |
| `life-platform-delete-user-data-errors` | operational_stack | unresolved |
...
- Edge sites: 1112 total · 802 resolved · 310 dynamic (unresolvable at AST time, tagged — never guessed)
- Schedules: 81 resolved · 0 dynamic of 81 scheduled lambdas (104 lambdas total)
- Alarms: 45 explicit declarations (helper-default `ingestion-error-*` alarms are a stated scope cut)
