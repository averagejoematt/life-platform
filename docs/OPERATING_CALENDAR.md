...
- **fullreview-delta** — declared 2026-09-19, resumes 2026-09-26. #3603 (PR #3904, merged 2026-09-19) rewrote the instrument this clock measures — frozen anchors per run, the 28-day carry-forward cap, the planted calibration controls, and the rubric text in SKILL.md + references/full.md — and the change surface since the 2026-09-05 baseline is 896 files across every area, so more than ~70% of the panel qualifies. Both are the rubric's own 'delta is INVALID' tests (references/full.md § Delta mode): a delta across an instrument rewrite measures the rubric moving, and a delta touching nearly everything is a full run wearing worse anchors. Decision (Session AL, 2026-09-19): do NOT run the overdue delta; the next fullreview run is a NEW BASELINE under the rewritten instrument (a full, suffix-free grades file, `method` naming #3904), and this clock is re-anchored once to 2026-09-26 so the 2026-09-16 hard date is discharged by a written decision rather than a silent lapse. Precedent: the 2026-08-27 hold for #3245 (#3250, Session I). One-time: after 2026-09-26 the ordinary cadence applies and a missed run reds like any other.
