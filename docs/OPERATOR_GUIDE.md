...
The Life Platform is a personal health intelligence system. It pulls data from ~20 sources (wearables, apps, food logs, labs), stores everything in DynamoDB single-table (`life-platform`, us-west-2), and makes it queryable by Claude through 81 MCP tools. **104 Lambdas** run the ingest → compute → email pipeline daily.

**Pipeline (UTC, ADR-052):**
- Ingestion: hourly at UTC hours 12–23 + 0–5 (`INGEST_HOURLY`, `ingestion_stack.py` — skips the overnight-PT hours). Exceptions: **Habitify all 24 hours** (`HABITIFY_HOURLY`, #3666 — the skipped UTC 6–11 is 23:00–04:00 PT, when evening habits are ticked), Weather 2x/day, Todoist 1x/day (14:00 UTC), **Hevy all 24 hours** (#3720 — a 5:30 PM PT lift landed after the old 16:00 PT cutoff and stayed invisible until 5 AM), Garmin PAUSED (no schedule — ADR-074)
...
AWS run-rate: measured steady state **~$172/mo** (Cost Explorer unblended $5.74/day, sd $4.32, n=25 over 2026-08-01..08-25; 95% CI $121–223 — the derivation behind the ADR-133 2026-08-28 amendment, #2801) against a **$215/mo enforced ceiling** ($252 in reader-traffic surge mode; cost-governor degrades AI by tier). For August 2026 only, a dated window set that pair to $200/$235; it auto-reverts 2026-09-01 **upward** to the base, since the new base exceeds the window. Bedrock AI is the swing factor and is ~62% of spend: live governor breakdown 2026-08-28 reads AI $5.07/day vs non-AI $1.14/day, MTD $165.15, projected $176.34. <!-- drift-ok: $200/$235 above is the August window's own value, history from 2026-09-01; the current claim on this line is the $215/$252 base --> See `docs/COST_TRACKER.md`.
