...
> 133 ADRs total (ADR-001 → ADR-135). (Some numbers were skipped/merged, so the record count and the max number diverge — see #817.)
...
| ADR-027 | MCP Two-Tier Structure: Stable Core → Layer, Volatile Tools → Zip | Active | 2026-03-14 |
