...
| `DenyDataStoreDestruction` | `dynamodb:DeleteTable` / `DeleteBackup` / `UpdateContinuousBackups` / `UpdateTimeToLive` (the table is imported too) and AWS Backup vault / plan / recovery-point deletion |
