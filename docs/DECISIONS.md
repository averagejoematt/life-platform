...
*Last updated: 2026-09-26 (v8.6.0)*
> 154 ADRs total (ADR-001 → ADR-156). (Some numbers were skipped/merged, so the record count and the max number diverge — see #817.)
> The index table below is auto-generated by `scripts/generate_adr_index.py` — run it with `--apply` after adding an ADR; never hand-edit the table.
...
| ADR-010 | Reserved Concurrency over WAF for MCP Endpoint | Active | 2026-02-28 |
...
| ADR-013 | Shared Lambda Layer for Common Modules | Superseded by ADR-131 (2026-07-06) | 2026-03-05 |
| ADR-014 | Secrets Manager: Dedicated vs. Bundled Principle | Active | 2026-03-05 |
...
| ADR-019 | SIMP-2 Ingestion Framework: Adopt for New, Skip Migration of Existing | Active | 2026-03-09 |
| ADR-020 | MCP Tool Functions MUST Come Before TOOLS={} Dict | Active | 2026-02-26 |
...
| ADR-027 | MCP Two-Tier Structure: Stable Core → Layer, Volatile Tools → Zip | Superseded by ADR-131 (2026-07-06) | 2026-03-14 |
...
| ADR-030 | Google Calendar Integration: Retired | Active | 2026-03-15 |
| ADR-031 | MCP Lambda Deploy: Always Use Full Zip Build | Active | 2026-03-15 |
...
| ADR-038 | In-Memory Rate Limiting over DynamoDB Counters | Active | 2026-03-20 |
...
| ADR-053 | S3 Encryption + CloudFront Website Endpoint Incompatibility | Active (decision shipped 2026-05-17… | 2026-05-17 |
| ADR-054 | CloudFront Origins: S3 Website Endpoint over REST+OAC (Status Quo) | Active (decision 2026-05-17, v7.20.0) | 2026-05-17 |
| ADR-055 | Coach Prediction Loop Closure: 4-Step Chain | Active (v7.15.0–v7.18.0, 2026-05-17) | 2026-05-17 |
| ADR-056 | SIMP-2 Ingestion Framework: 8 Sources Migrated, 6 Pattern-Exempt | Active (v7.10.0–v7.13.0, 2026-05-17) | 2026-05-17 |
| ADR-057 | Audit Items Formally Closed With Rationale | Active (v7.19.0, 2026-05-17) | 2026-05-17 |
| ADR-058 | Experiment Restart — single source of truth for genesis date | Accepted (2026-05-23) | 2026-05-23 |
| ADR-059 | Deploy Governance — `restart_pipeline.py` as the Single Safe Entry Point for Multi-Step State Changes | Accepted (2026-05-24) | 2026-05-24 |
| ADR-060 | Hevy Workout API as Independent Source — Dedicated Secret, Webhook + Cursor Backfill | Accepted | 2026-05-25 |
| ADR-061 | MacroFactor Unofficial-API Puller as Tier 1 Food-Level Nutrition Path | Accepted | 2026-05-25 |
| ADR-062 | Migrate Claude inference from direct Anthropic API to AWS Bedrock | Code complete | 2026-05-27 |
| ADR-063 | $75 Monthly Budget Guardrails with Tiered AI Degradation | Implemented + enforcement enabled | 2026-05-29 |
| ADR-064 | Self-healing Remediation Agent as the Default Triage Loop | Phase 1 (shadow) validated | 2026-05-29 |
| ADR-065 | Auto-merge as a Deterministic Gate, Not the Agent | Retired 2026-08-30, #2833 | 2026-05-29 |
| ADR-066 | Hevy Routine Write-Loop — One Path, Two Front Doors, Cron Disabled at Birth | Implemented (chat path + cron Lambda +… | 2026-05-31 |
| ADR-067 | Hevy Routine Title Convention — "<Phase> - <Type> - <N> - <Y>" | Implemented (code shipped | 2026-05-31 |
| ADR-068 | Per-Exercise Notes — Deterministic History Cues, LLM Never Computes | Implemented (code shipped | 2026-05-31 |
| ADR-069 | Custom Routine Authoring — `draft_custom` Escape Hatch for Hand-Designed Sessions | Implemented (chat path only | 2026-05-31 |
| ADR-070 | Vacation Fund Tracker — $1 per workout mile, additive across sources | Implemented (MCP + site-api + daily… | 2026-06-01 |
| ADR-071 | v4 "The Measured Life" front-end — one engine, three doors | Live on `averagejoematt.com` | 2026-06-01 |
| ADR-072 | Experiment restart zeroes the accountability ledger | Implemented | 2026-06-02 |
| ADR-073 | Site API returns shaped-empty 200 on sparse data (not 503) | Code committed | 2026-06-02 |
| ADR-074 | Garmin direct-API ingestion retired (paused) — vendor anti-automation | Paused | 2026-06-03 |
| ADR-075 | Budget guard early-month guard + AI cost trim (remediation agent) | Implemented | 2026-06-03 |
| ADR-076 | Visual + AI-vision UI test harness | Implemented | 2026-06-05 |
| ADR-077 | Phase taxonomy — one classification for experiment-restart semantics | In progress | 2026-06-07 |
| ADR-078 | Commercial wedge — sequence, don't choose (PG-00) | Decided | 2026-06-07 |
| ADR-079 | Defer GuardDuty + AWS Config — accept the gap with compensating controls | Decided | 2026-06-08 |
| ADR-080 | CI quality gates — enforced mypy (tier-1), coverage floor, Lambda size gate | Accepted (2026-06-08) | 2026-06-08 |
| ADR-081 | Adopt the orphaned intelligence Lambdas into CDK (drift elimination) | Accepted (2026-06-08) | 2026-06-08 |
| ADR-082 | Security & supply-chain hardening (SAST, action pinning, Dependabot) | Accepted (2026-06-09) | 2026-06-09 |
| ADR-083 | Single-region is an accepted risk (no cross-region DR) | Accepted (2026-06-09) | 2026-06-09 |
| ADR-084 | Test-coverage philosophy + the ratchet cadence | Accepted (2026-06-09) | 2026-06-09 |
| ADR-085 | Infra-liveness is a separate signal from data-freshness (ER-01) | Accepted (2026-06-09) | 2026-06-09 |
| ADR-086 | Public honesty surfaces — and the line we will not cross (the ghost-projection refusal) | Accepted (2026-06-13) | 2026-06-13 |
| ADR-087 | Podcast audio realism is bounded by a two-stage (script → TTS) pipeline; monitor for a NotebookLM-grade API | Accepted (2026-06-14) | 2026-06-14 |
| ADR-088 | Hevy Title Counters — performed-derived N (per-phase) + reset-epoch Y; force_title lockdown | Implemented (code shipped + tested | 2026-06-16 |
| ADR-089 | Cut benchmarking (BENCH-1) — descriptive divergence vs his own proven cut, weekly-computed, no predictor | Implemented (code + tests shipped | 2026-06-19 |
| ADR-090 | Derived meal layer — best-effort meal grouping as a recomputable projection over raw MacroFactor | Implemented (Phase 0–1 live: layer v86… | 2026-06-19 |
| ADR-091 | Source-state honesty guard as a cross-coach standard (no confident verdict on data you can't see) | Standard adopted | 2026-06-19 |
| ADR-092 | Detect silent ingestion gaps — source-of-truth reconciliation + interior-gap scan (DI-2) | ✅ Active | 2026-06-21 |
| ADR-093 | Recovery-adaptive night-before authoring — tier-agnostic branches + freshness gate | ✅ Active | 2026-06-21 |
| ADR-094 | Derived training-note signal layer — never mutate raw Hevy notes; notes overlay numbers, never overwrite | ✅ Active | 2026-06-21 |
| ADR-095 | Privacy-clean traffic measurement — weekly digest from CloudFront access logs | ✅ Active | 2026-06-27 |
| ADR-096 | Coherence as a monitored property — the Self-Management & Coherence Program | ✅ Active | 2026-06-29 |
| ADR-097 | Two GSIs for the reading domain — the first GSIs on `life-platform` (amends ADR-005) | ✅ Active | 2026-06-29 |
| ADR-098 | Content-hash the full JS module graph, not just HTML references (extends ADR-039) | Active | 2026-07-03 |
| ADR-099 | GitHub Issues become the single source of truth for forward work (supersedes BACKLOG.md's role) | Accepted | 2026-07-03 |
| ADR-100 | The budget ceiling protects readers — the public ask endpoints degrade LAST | Accepted | 2026-07-03 |
| ADR-101 | Distribution before monetization — no paid-product work until an audience trigger | Accepted | 2026-07-03 |
| ADR-102 | Single-table DynamoDB, chosen on purpose — keep it, do not migrate (ER-08) | Accepted | 2026-07-03 |
| ADR-103 | The complexity-posture ledger — every subsystem carries its frame (ER-07) | Accepted | 2026-07-03 |
| ADR-104 | Honest numbers everywhere — behavioral-absence semantics + the grounded-generation gate | Accepted | 2026-07-03 |
| ADR-105 | The rigor bar — uncertainty on every claim, every forecast graded, deterministic before narrative | Accepted | 2026-07-04 |
| ADR-106 | Coach portraits — commissioned engraved identity | Accepted (program) | 2026-07-04 |
| ADR-107 | The coverage floor actually ratchets + a mypy tier-2 for the public serving surface | Accepted | 2026-07-05 |
| ADR-108 | Coach quality gate promoted advisory → blocking, on the measured signal (N-06) | Accepted | 2026-07-05 |
| ADR-109 | The honesty gates cover DERIVED/proxy values too — TSB first, via the scheduled scan not the tight guard (M-8) | Accepted | 2026-07-05 |
| ADR-112 | Board follow-up sessions — short-lived, server-side, opaque-token, no-PII (#546) | Accepted | 2026-07-05 |
| ADR-113 | Retire the unified-sleep reconciler — a dead merge that mislabelled a public page (A-2/A-3, #487) | Accepted | 2026-07-05 |
| ADR-119 | Keep polling Whoop, do not adopt v2 webhooks (A-8, #508) | Accepted | 2026-07-05 |
| ADR-120 | The OIDC automation identities are codified now, and the trust-tighten is staged as a watched follow-up (DEVOPS-02, #401) | Accepted (codify half shipped | 2026-07-05 |
| ADR-117 | A deploy-critical test lane gates the pipeline; auto-rollback covers the site (+ layer runbook) | Accepted | 2026-07-05 |
| ADR-116 | The CloudWatch alarm bill pays rent — surgical orphan cleanup, coverage never traded for dollars (cost-05, #411) | Accepted | 2026-07-05 |
| ADR-115 | DLQ escalation that actually escalates — a durable content-keyed retry ledger (REL-02/REL-03, #402) | Accepted | 2026-07-05 |
| ADR-118 | Retire the Eight Sleep bed-temperature pipeline — a dead endpoint that silently fed five permanently-empty surfaces (A-4, #489) | Accepted | 2026-07-05 |
| ADR-121 | Keep State of Mind — restart the habit, fix the mis-keyed consumers, don't prune (#507) | Accepted | 2026-07-05 |
| ADR-114 | One code-drawn card engine — every off-site card rides the same renderer (#595) | Accepted | 2026-07-05 |
| ADR-122 | Todoist filters query the endpoint that actually filters — and the decision-fatigue threshold measures pressing load, not the backlog (E-1, #478) | Accepted | 2026-07-05 |
| ADR-123 | Source-of-truth reconciliation generalized to Whoop; Garmin deliberately NOT reconciled (TR-07, #415) | Accepted | 2026-07-05 |
| ADR-124 | The fulfillment capture channel — options memo + publication posture (E4.1, #745) | ✅ Accepted 2026-07-06 | 2026-07-06 |
| ADR-125 | The budget degradation ladder sacrifices by audience — internal/dev AI dies first, the reader product last (E5.2, #737) | Accepted | 2026-07-06 |
| ADR-126 | Hash-and-reuse unchanged coach generation briefs — stop paying to re-say the same silence (E5.3, #738) | Accepted | 2026-07-06 |
| ADR-127 | Make "0 flags" falsifiable — a golden-brief eval harness with seeded-fault canaries (E6.1, #742) | Accepted | 2026-07-06 |
| ADR-128 | No standing multi-model LLM Council — the bottleneck is accountability data, not deliberation diversity (E8/#757) | Accepted (non-decision recorded) | 2026-07-06 |
| ADR-129 | Remediation agent returned to `shadow` until it earns `auto` — zero merged safe-class PRs in ~6 weeks (E8/#754) | Accepted | 2026-07-06 |
| ADR-130 | GitHub Pages disabled — a second, unmanaged public surface redundant with the canonical CloudFront site (E8/#752) | Accepted | 2026-07-06 |
| ADR-131 | One code-distribution channel — retire the shared layer, bundle the whole tree (#781, 2026-07-06) | — | 2026-07-06 |
| ADR-132 | Batch inference for scheduled content — evaluated, deferred; the seam ships dormant behind the 100-record floor (#409, epic #344) | Accepted (evaluated-deferred) | 2026-07-07 |
| ADR-133 | Surge-mode ceiling — the budget floats to $100 on real reader traffic, never on spend creep; base raised $75 → $85 (E5.4, #739) | Accepted | 2026-07-08 |
| ADR-134 | Character math v2 — XP zero-point at "a decent day", dark stretches hit the headline, uninstrumented pillars neither earn nor drag (epic #956) | Accepted | 2026-07-11 |
| ADR-135 | Podcast no-touch contract — deterministic structure repair, convergent revision, bounded escalation (#1170/#1171/#1172, epic #1082) | Accepted | 2026-07-12 |
| ADR-136 | Site auto-deploy without a human click is the chosen posture — gated by the 3-layer QA estate + auto-rollback, not a person (#750/#897/#793, #1343) | Accepted | 2026-07-18 |
| ADR-137 | The evening intake ledger stays one-tap drinks-only — no second numeric tap (#1484, epic #1476) | Accepted | 2026-07-19 |
| ADR-138 | Release topology — prod-only, single-account/single-region, detect-and-revert (#1338) | Accepted | 2026-07-20 |
| ADR-139 | Testing topology — post-merge full suite blessed, advisory pre-merge lane in git (#1344) | Accepted | 2026-07-20 |
| ADR-140 | The anti-auto-posting stance, amended — content syndication is sanctioned under five normative rules; milestone posting stays denied permanently (#1630) | Accepted | 2026-07-25 |
| ADR-141 | Conversational self-calibration — check-in answers move the same CONFIDENCE#/LEARNING# machinery as data, bounded and provenance-tagged (#1481) | Accepted | 2026-07-25 |
| ADR-142 | The journal privacy three-tier model — verbatim-private by default, consent-per-line public verbatim, theme-referenceable allude (#1568, shared with #1483) | Accepted | 2026-07-25 |
| ADR-143 | Paging posture — email is the default channel; one dedicated SNS→SMS topic pages a named ≤5-alarm P1 set (#1333) | Accepted | 2026-07-26 |
| ADR-144 | Proportionality — complexity must earn its keep; the ledger becomes a legible standing artifact (#1666) | Accepted | 2026-07-26 |
| ADR-145 | The video-diary public form — text + prosody cards; raw audio/video never; avatar is a gated future revisit (#1570, #1388) | Accepted | 2026-07-27 |
| ADR-146 | lambdas/ is packaged by domain — the flat root is retired, and moving code must never reduce coverage (#1653) | Accepted | 2026-07-28 |
| ADR-147 | The smoke oracle answers two questions — only deploy health may revert a deploy (#1921, measured by #1920) | Accepted | 2026-08-02 |
| ADR-148 | Branch protection is scoped to the fast lane — required checks that always run, auto-merge, and nothing that needs a second human (#1662) | Accepted | 2026-08-03 |
| ADR-149 | Native social embeds get one third-party frame origin, shipped inert — the CSP is built once, and the facade stays the fallback (#1678) | Accepted | 2026-08-06 |
| ADR-150 | DynamoDB native vector search — evaluated, declined; brute-force cosine stays until the corpus and the latency path both change (#1384) | Accepted (evaluated-declined) | 2026-08-08 |
| ADR-151 | Telegram coach chat — the conversational surface, its trust boundary, and the private-tier egress decision | Accepted | 2026-08-09 |
| ADR-152 | One TDEE definition — measured exercise energy, and the deficit lives in the target | Accepted | 2026-08-09 |
| ADR-153 | Coaching Team v2 — MOS character adoption, texting tiers, and the roster restructure | Accepted | 2026-08-10 |
...
**Amended by:** ADR-097 (2026-06-29) — the reading/Mind domain gets exactly two Global Secondary Indexes, additively; this record's "no GSI" rule stands for every other domain, GSIs remain the documented exception, added only with an ADR.
...
**Status:** Superseded by ADR-131 (2026-07-06) — the shared layer this record created is retired; see ADR-131.
**Date:** 2026-03-05  
...
**Current layer version:** `life-platform-shared-utils:4` (historical — the layer no longer exists, see below)

**Outcome (historical):** Layer in use. `deploy_lambda.sh` automatically attaches the current layer version.

**Superseded 2026-07-06 (ADR-131, #781).** The `life-platform-shared-utils` layer this record created is retired — shared code now ships inside every function's own code bundle (`deploy/build_bundle.py`), the ONE distribution channel. This record is kept for its P0-incident history (the 2026-03-09 stale-copy failure that motivated a layer in the first place); do not follow its "Decision" for new work.
...
**Amended by:** ADR-150 (2026-08-08) — this record's reasoning holds for STRUCTURED memory (`platform_memory` is still a category+date lookup, still no embeddings) but it was written as if it settled embeddings platform-wide, and #1384 later shipped Titan-v2 embeddings over the NARRATIVE corpus without reconciling the two. The line is: structured recall is keyed, narrative recall is embedded. Neither uses a vector database.
...
**Status:** Superseded by ADR-131 (2026-07-06) — never implemented, and the Layer tier it depends on is retired; see ADR-131.
...
**Outcome (historical — never executed):** Implement before next major MCP expansion. Script ready. See `deploy/build_mcp_stable_layer.sh`.

**Superseded 2026-07-06 (ADR-131, #781).** This split was never migrated (no Layer rebuild ever ran; `build_mcp_stable_layer.sh` stayed unexecuted) and the Layer tier it's predicated on no longer exists — ADR-131 collapses all code distribution, MCP included, to ONE bundled channel (`deploy/build_bundle.py --mcp`, the mcp-shaped full tree). This record is kept for the R11 stable/volatile framing's history; the Layer-based mechanics do not apply to any live deploy path.
...
**Files changed:** All 8 migrated `lambdas/*_lambda.py` files (full rewrites or near-full), `lambdas/ingestion/ingestion_framework.py` (`refresh_today` flag added for habitify), `tests/test_numeric.py` (shim list pruned per migration), `tests/test_ddb_patterns.py` (D4 gap removed for garmin), `docs/CHANGELOG.md` (v7.10–v7.13).
...
- **Secrets are per-source, not per-user** (`lambdas/common/secret_cache.py` caches by secret
...
- **The raw S3 zone is three-generation fractured** (X-9/#498, `lambdas/ingestion/source_registry.py`):
...
- **Read-path filter** — `lambdas/experiment/phase_filter.py` provides `with_phase_filter()`
...
- **Inference profiles required.** On-demand 4.x Claude models reject the bare
  ...
  `lambdas/ai/bedrock_client.py` `_MODEL_MAP`.
...
- New primitive: `lambdas/ai/bedrock_client.py` (`invoke()`, `resolve_model_id()`),
...
**Amendment (2026-08-31, #1631 — the ceiling meters AWS only; per-post third-party spend is OUTSIDE it, and that is a do-not-build rule, not a gap to paper over).** This record's invariant — *one budget covers ALL spend* — is true of everything the platform runs today because everything it runs is billed through AWS: `cost_governor_lambda` reads Cost Explorer plus Bedrock token usage, `budget_guard` gates on the tier it writes, and the AWS Budgets backstop (#2801) watches the same bill. Any vendor billed off-AWS — X's per-post API pricing (#1631), ElevenLabs (#1742), avatar-video vendors (the #1388 decision above) — is invisible to every one of those instruments: no tier would rise, no alarm would fire, and the first signal would be the vendor's invoice. The standing rule, recorded here so it stops being rediscovered per-vendor: **nothing that bills outside AWS is built until an amendment to THIS record first states (a) how that spend is metered into the governor's month-to-date figure, (b) what the combined cap is, and (c) which pre-charge mechanism (the `rate_limiter.py` atomic-counter pattern, charged BEFORE the external call) stops a runaway loop past it.** X syndication specifically is *not built* under this rule (#1631 closed 2026-08-31 as a decision, not as work; its design and acceptance list survive in that issue for the day the amendment exists). The Bluesky poster (#1629) is unaffected — Bluesky's API has no per-post charge, which is exactly why it was the sanctioned candidate.
...
2. **`lambdas/ai/budget_guard.py`** (shared-layer module) — `current_tier()` reads SSM with 5-min cache (fail-open to 0). `allow(feature)` returns False once tier ≥ that feature's cutoff. `BudgetExceeded` raised by `bedrock_client.invoke()` at Tier 3 as a hard chokepoint failsafe.
...
- **band 3 (operator truth):** `reader_truth_qa`, `visual_ai_qa` — tier 3 (moved out of band 1 by the ADR-125 2026-08-03 amendment, #1927 — a deploy gate may not be the first thing sacrificed)
...
**Date:** 2026-05-29
**Status:** Retired 2026-08-30, #2833 · was Implemented + enabled (mode=auto), then `shadow` from 2026-07-06 (ADR-129); the gate never merged a PR — see the ADR-129 amendment of 2026-08-30.
...
### Amendment 2026-09-01 (#3418) — the deployed side is a lossy READ: GetTemplate transcode equivalence on the advisory path

Six `Pending owner cdk deploy` warnings re-minted within hours of a verified full-fleet deploy (#3365), and the discriminating experiment showed why: **CloudFormation's GetTemplate returns every non-ASCII character in the stored template as a literal `?`**, while synth, the staged S3 template and the provisioned resource all carry the real character (proven by triangulation on `LifePlatformWeb`'s `AmjDistribution` Comment — staged S3 object `\xe2\x80\x94`, live CloudFront `U+2014`, GetTemplate `?`). Any template field containing an em-dash therefore could never equal its own deployed read: 18 of the 20 warned items were this false diff, unclearable by deploying — a treadmill that retrains the operator to wave the annotation list through (#1966). The gate's `pending_non_iam` comparisons now treat the deployed value as equal when it matches the synthesized value **after** the exact GetTemplate transcode (`transcode_equal`, one-directional, synth side only — a deployed real character never equalizes against a synth `?`). Every IAM-relevant comparison stays strict `==`; no registry set changed, so the R5 baseline above is untouched. Priced residual of the equivalence: a repo edit that changes ONLY non-ASCII characters in a non-IAM text field (e.g. `—` → `?` verbatim) is invisible through GetTemplate and will not warn — the same trade the CDK CLI ships when its diff omits "likely mangled non-ASCII characters" unless `--strict`.
...
**Related:** ADR-066 (Hevy routine write-loop), `lambdas/training/routine_title.py`, `config/training_phases.json`.
...
**Related:** ADR-066 (write-loop), ADR-067 (title + WHY-note), `lambdas/training/exercise_history.py`, `config/training_week.json:exercise_notes_mode`.
...
**Related:** ADR-066 (write-loop), ADR-067 (title), ADR-068 (per-exercise notes), `mcp/tools_hevy_routine.py`, `config/movement_catalog.json`, `lambdas/training/hevy_template_cache.py`.
...
**Related:** `lambdas/content/vacation_fund.py`, `config/vacation_fund.json`, `mcp/tools_vacation.py`, `lambdas/web/site_api_lambda.py` (`/api/vacation_fund`), `lambdas/emails/daily_brief_lambda.py` + `lambdas/content/html_builder.py`, `handovers/HANDOVER_2026-06-01_VacationFund.md`.
...
**Date:** 2026-06-07
**Status:** In progress — `lambdas/experiment/phase_taxonomy.py` registry + `tests/test_phase_taxonomy.py` (180 live families) + `docs/PHASE_TAXONOMY.md` landed; restart-script rewiring, write-time stamping, cycle stamping, and the 7 mechanism fixes follow under the same ADR.
...
**Amendment (2026-09-21, #3601 box 3 / session AQ — the owner's cadence ruling is now "never": cycle 17 is the terminal cycle; reset-gated acceptance closes on REHEARSAL proof; the reset machinery goes dormant with a revive checklist).** *The ruling (owner, 2026-09-21 ~19:00 PT, in his words):* "I don't intend to reset ever again." Recorded with the number it was made on: 12 resets in 55 days before the 30-day-minimum ruling above, 16 lifetime loss episodes with zero held, and a cycle-17 plan (v0.3, approved the same evening) whose whole design is a 26-week landing rather than a new genesis. *Consequences, each enforced or named:* (1) **No future genesis is planned.** `EXPERIMENT_START_DATE` stays 2026-09-06; the 30-day refusal in `deploy/restart_pipeline.py --apply` stands as belt and braces; a future reset is a NEW owner ruling recorded here first, never an SSM flip or a pipeline run. (2) **Reset-gated acceptance boxes close on rehearsal proof, not on a reset.** An issue whose proof event was "the next reset" (as of this amendment: #3671, #4008, #3621 boxes 2b/5, #3599, #3643 boxes 2–4, #3552, and this record's own #3601 box 3) carries BOTH `closure:live-proof` and the new `closure:rehearsal-proof` label and closes on a comment line `**Rehearsal proof:** <UTC instant> — <command or fixture> — <observed output>` — a `restart_pipeline.py --dry-run`, the `tests/test_restart_double_reset_3621.py` fixture, or a scratch-genesis run — **never a write to the live table** (the attest-never-backfill rule: a synthetic reset row in a measured partition is indistinguishable forever). The opt-in is the second label, so the live-proof contract (#3595) does not widen for any instrument that CAN still run live; `scripts/closure_contract.names_rehearsal_proof` + `closure_sweep` enforce the line structurally, mutation-tested in `tests/test_live_proof_closure_3595.py` §5. Where a box has a LIVE half that needs no reset (#3671's counter re-anchor against the current genesis; #4008's one-off backfill of the 411 archived rows), the live half is still proven live. (3) **The phase machinery is DORMANT, not deleted.** `docs/PROPORTIONALITY.md`'s phase-machinery row moves from Load-bearing to Dormant with ONE revive condition (a new owner ruling here) and ONE dead-man that keeps the code from rotting: the double-reset premerge fixture, which must keep passing whether or not anyone thinks about resets. Epic #3490 (the reset↔writer contract) closes as superseded once the rehearsal pass lands; the revive checklist — every closed issue with its rehearsal command, the demoted row, the reopen condition — lives on ONE Roadmap epic outside the debt count (ADR-099 amendment 2026-08-22). (4) **What does not change:** the taxonomy classes still govern every read and write (`phase_taxonomy` is about provenance, not about resetting); the phase-stamp census, the scoped-writer guards and the pre-seal truth gate stay as the guards they are; the archive of cycles 1–16 stays navigable by `cycle=N`.
...
**Amendment 2026-08-27 — the ruling was overridden once, scoped, and the operation stopped (#2961).** The "owner-run, in-the-loop" rule above is the general one, and it still stands. It has been explicitly overridden exactly once: the owner authorized a session to run a `cdk import` non-interactively for the three us-east-1 CloudWatch alarm orphans on `LifePlatformWeb`, scoped **to that issue and that operation only** (the authorization comment says so, and disclaims generalising to other `cdk import` work or other stacks). Recorded here because a future session landing on this paragraph should see that the precedent exists and how narrow it is. The import was never run: the authorization's own "stop on the first surprise" safeguard fired when read-only pre-flight falsified the lead item's premise — `life-platform-cf-auth-errors` watches a function detached from every CloudFront distribution, so adopting and routing it would have shipped a permanent false `OK`. The resolved dispositions and evidence are in `docs/reviews/CLOUDWATCH_AUDIT_2026-07.md` §9a; nothing in ADR-081's own adoption mechanics changed.
...
> **Amendment 2026-09-06 (#3549 — the survival odds are horizon-checked and derived):** the `n=2 is narrative, not statistics` caveat above was a literal, and it outlived the two-prior era it was written in by thirteen cycles while the code beside it counted a cycle re-anchored on day 1 as a day-30 survivor (`cd is None or cd > 30`, no window check) — `/api/survival` served **47% odds of day 30** over a record in which no cycle had ever been observed at day 30. The rule now: a prior cycle counts as reaching the horizon ONLY if it is known engaged through it; a censored cycle shorter than the horizon stays in n and never counts as a survivor (the Laplace estimate can only understate); the odds are served ONLY once at least one cycle has actually been observed at the horizon — until then `p_reach_30_pct` is `null` and the formula's residue 1/(n+2) is served as `p_reach_30_ceiling_pct`, named as the prior's, not the record's. Every served string (`method`, `confidence`) is derived from the served counts (`n_prior_cycles`, `reached_horizon_n`, …), and `tests/test_survival_horizon_3549.py` holds that any `n=<int>` in served prose equals a numeric field of the same payload.
...
> **⚠️ Amended 2026-07-27 (#1741, epic #1737) — the central claim below was already false on the day this record was accepted.** The marked passages are retained verbatim for history; read them together with **the ADR-087 Amendment at the end of this record**, which corrects the ceiling claim, closes monitor trigger #1, parks ElevenLabs with its trade-off, withdraws the "no bracketed stage directions" instruction, and sets a dated re-check.

**Context:** The podcast ("The Panel" + Episode 0) should feel like a real NotebookLM-style conversation — natural overlaps, interjections, laughter, banter. Our architecture is deliberately two-stage: **Bedrock (Sonnet) writes a script** (a list of `{speaker, line}` turns), then **Gemini 2.5 multi-speaker TTS reads that finished script** single-pass (`lambdas/ai/gemini_tts.py`). NotebookLM, by contrast, uses Google's internal Audio-Overview model that *generates the performance holistically* — it can overlap speakers, improvise backchannel, and laugh because writing and performing are one model.

**Decision — accept the Gemini two-stage approach for now, and name the ceiling explicitly:**
- **[SUPERSEDED 2026-07-27 — factually wrong when written; see the amendment below. Retained verbatim.]** ~~**The audio model is a real ceiling.**~~ Gemini TTS performs *exactly* the turns it is given, sequentially. It will not truly overlap speech, interrupt, or laugh unless the script implies it — and even then it renders read text, not improvised performance. This is a property of the public API, not our prompt. We have **pushed the lever we control** — the script + style prompts now instruct genuine back-and-forth (short interjections, reactions, gentle interruptions, varied turn length; no bracketed stage directions) — which is where most of the perceived "podcastiness" comes from.
- **[SUPERSEDED 2026-07-27 — the survey it rests on was incomplete; see the amendment below. Retained verbatim.]** **Why not the better tech:** Google's **Studio MultiSpeaker** voice (closest to NotebookLM's conversational audio) is **allowlist-only** (`403 PERMISSION_DENIED`), and there is no public "Audio Overviews" generation API. Gemini 2.5 multi-speaker is the best generally-available primitive and is what we ship.
...
**[SUPERSEDED 2026-07-27 — trigger #1 has fired and is now permanently CLOSED, trigger #3 has fired, and the triggers carried no re-check date, which is why neither firing was noticed. Retained verbatim; see the amendment below.]** **Monitor trigger (revisit this ADR when):** Google ships a public **Audio Overviews / conversational-audio generation API**, OR grants **Studio MultiSpeaker allowlist** access, OR Gemini TTS adds true multi-speaker overlap / non-verbal control. Any of these → swap the synth backend in `gemini_tts.py` (the script stage + the whole QA pipeline stay; only the voicing call changes). Until then the realism gap is a known, accepted limitation, not a bug.

**[SUPERSEDED 2026-07-27 — the "tracked rather than re-litigated" clause is exactly what stopped the tracking; see the amendment below. Retained verbatim.]** **Consequences:** expectations are set — the show is "two AI voices reading a genuinely conversational script," not generated banter; the upgrade path is a single isolated backend swap; and the gap is tracked rather than re-litigated each time an episode "doesn't feel quite like NotebookLM."

### ADR-087 Amendment (2026-07-27, #1741 — the ceiling claim was wrong when written; Podcast API closed, ElevenLabs parked, the no-brackets instruction withdrawn)

**Status of this amendment:** it corrects the **record** only. **No podcast code has changed as a result of it** — see "What has NOT shipped" below. Every external fact here was re-confirmed live on 2026-07-27, not copied forward.

**1. The ceiling claim was inaccurate as written — and the dates are the whole lesson.** `gemini-3.1-flash-tts-preview` shipped **2026-04-15** (Gemini API / AI Studio / Vertex AI, preview) with **inline bracketed audio tags** (`[laughs]`, `[whispers]`, `[sighs]`, `[sarcastic]`, pacing) plus per-speaker voice/style configuration for a two-speaker dialogue — i.e. precisely the "non-verbal control" the original record's own trigger #3 named. This record was accepted **2026-06-14**, two months later, and still asserted that sequential, unperformed delivery "is a property of the public API, not our prompt." **That was false on the day it was written.** The failure mode is not "we picked the wrong vendor" — it is that **a monitor trigger fired before the ADR that defined it was written, and nobody re-checked**, because the record deliberately discouraged re-litigation and named no date on which anyone would look again.

**2. Monitor trigger #1 (a public NotebookLM-grade Audio-Overviews API) — FIRED AND PERMANENTLY CLOSED.** Google's standalone Podcast API does exist (`POST https://discoveryengine.googleapis.com/v1/projects/PROJECT_ID/locations/global/podcasts`; context array capped under 100,000 tokens; MP3 out). Its documentation carries, verbatim (re-read 2026-07-27):

> "The Podcast API is deprecated. Google isn't allowlisting new customers."

We are not an allowlisted customer, so this path is closed to us and will not re-open. **It would also be the wrong tool even if it were open:** it is a black box from source material straight to MP3, so adopting it would mean discarding the entire ADR-135 script → gate → craft pipeline (structural repair, the deterministic `panelcast_qa.py` gates, the taste judge, the bounded-attempt ledger) — the part of the show we actually control and audit. **This trigger is closed, not pending.** It must stop reading as an upgrade someone is waiting for.

**3. Monitor trigger #3 (Gemini TTS adds non-verbal / delivery control) — FIRED (2026-04-15).** The response is not a vendor swap: it is a **model-ID change on the same vendor and the same call**, because `gemini_tts.py:30` already reads the model from the `GEMINI_TTS_MODEL` env var. Trigger #2 (a **Studio MultiSpeaker** allowlist grant) is **left open but demoted to moot** — we made no new allowlist request and have no evidence its status changed; it is simply no longer the interesting path now that a generally-available model exposes the control we wanted. Do not read "moot" as "checked and denied."

**4. ElevenLabs is PARKED with its trade-off stated — not "better tech we can't have."** The only dismissal previously on record (2026-03-01, *"require external API access"*) is **withdrawn as stale**: we call Whoop, Withings, Garmin and Gemini over `urllib` on a schedule; an outbound vendor HTTP call is not a constraint here. The real trade-off, re-confirmed live 2026-07-27: **ElevenLabs v3 Text-to-Dialogue** is GA and is the only engine that genuinely interrupts and overlaps speakers, but its own documentation instructs callers to *"Keep the total length of all `inputs[].text` values at or below 2,000 characters per request for reliable generation"* and documents **no continuity/stitching parameters for dialogue** (no `previous_text`/`next_text`/`request_ids` equivalent) — the guidance is to split and concatenate client-side. A ~6,000-character episode therefore becomes ~3 concatenated chunks, which reintroduces the exact prosody seam `gemini_tts.py:33-36` was written to avoid (*"an 8-turn split produced an audible 'handoff' ~2 min in"*). **Posture: a listen-test candidate, never adopted unheard** — tracked as **#1742** (`gate:owner`, Later; needs a vendor account + card + a new secret). It is parked because of a measurable seam risk, not because it is unreachable.

**5. The "no bracketed stage directions" instruction is WITHDRAWN as an instruction.** On 2.5 it was sound (brackets were dead weight the model might read aloud); on 3.1 brackets *are* the control surface, so the instruction as written would forbid the fix. Nothing in this ADR any longer tells the script layer to avoid bracketed delivery tags. **Honest current state: the instruction is still live in the code** — `lambdas/emails/panelcast_scripts.py:40` ("No bracketed stage directions (no '[laughs]'); put the warmth in the words.") and `:129` ("No preamble, no stage directions, no JSON fences."). Changing those strings, and hardening the deterministic gates that regex over raw turn text against a trailing `[warmly]`, is **#1740 — open, not started, blocked on #1738.** Until #1740 ships, the code's instruction stands and this ADR simply no longer endorses it.

**6. New bounds to design against (verified 2026-07-27, `gemini-3.1-flash-tts-preview`).** Input limit **8,192 tokens** (down from 32k on 2.5) and output limit **16,384 tokens**; at the observed ~25 audio-tokens/second that output cap is **≈10.9 minutes of audio per call**. Episodes run 6–7 minutes, so a single-pass call still holds — but the input drop is the sharper edge, and **whoever ships the model change must assert both bounds in code rather than assume them** (`MAX_TURNS_PER_CALL = 40` in `gemini_tts.py` was tuned against the 2.5 limits). Rollback stays trivial: flip `GEMINI_TTS_MODEL` back.

**7. What has NOT shipped (stated plainly so no future session misreads this amendment as a changelog).** As of 2026-07-27, **nothing in the podcast pipeline has changed**:
- **#1738** (the owner listening bake-off: one published script re-rendered through 2.5 / 3.1-bare / 3.1-tagged, picked by ear) is **open, `gate:owner`, not yet run.** Nothing merges before it.
- **#1739** (ship the winning backend — `gemini_tts.py` model default + prompt restructure + `INTRO_STYLE`/`WEEKLY_STYLE` rewrite) is **open and `blocked:dep` on #1738.** `gemini_tts.py:30` still defaults to `gemini-2.5-flash-preview-tts` in production.
- **#1740** (tag-aware script layer + gate hardening) is **open and `blocked:dep`.**
- **The voice-bleed hack still exists.** `INTRO_SIGNOFF` (`lambdas/emails/coach_panel_podcast_lambda.py:543-549`, appended as the final turn at `:867`) is still in the tree and still running: it strips any LLM-authored "I'm Elena Voss" close and appends a fixed Elena sign-off so that a Gemini multi-speaker voice-bleed — which carries the *prior* speaker's voice forward — lands Elena's own voice on her own sign-off. It is a mitigation for a 2.5 defect and it is **not removed**; #1739 re-tests whether 3.1 still needs it. A future session finding it there is finding the correct current state, not a leftover.

**8. Monitor cadence — the actual fix (AC3).** The lesson is not "we chose wrong", it is that **a monitor trigger with no scheduled re-check is a trigger that never fires.** So this record now carries a date, an owner, and a ritual that already runs:

- **Next re-check: 2026-10-27. Owner: Matthew.** Scope: the podcast TTS/dialogue landscape — the shipping Gemini TTS model ID vs. what `GEMINI_TTS_MODEL` is actually set to, the ElevenLabs dialogue char-cap/continuity situation (#1742), and any newly generally-available conversational-audio API.
- **The mechanism that surfaces the date** is the existing quarterly re-read of `docs/PROPORTIONALITY.md` (ADR-144: *"quarterly re-read (with `/platform-review` or `/sdlc-review`)"*). The "Weekly Panel podcast pipeline" row there now carries the dated re-check, alongside the ledger's other dated triggers (the 2026-Q3 chronicle-podcast delete window, the 2026-Q4 State-of-Mind flip). The date lives in a table a standing ritual already walks, rather than in a paragraph nobody re-opens.
- **Every re-check is recorded here, including the boring ones.** A re-check that finds nothing appends one dated line to this amendment ("re-checked YYYY-MM-DD, no change, next YYYY-MM-DD"). An unrecorded re-check is indistinguishable from one that never happened — which is precisely the state that produced this amendment.

**Re-check log:** 2026-07-27 — amendment written (this record). Next: 2026-10-27.
...
**Supersedes:** the ADR-067 Amendment (2026-05-31). **Related:** ADR-066 (write-loop), ADR-067 (title + WHY-note), ADR-069 (draft_custom), `lambdas/training/routine_title.py`, `lambdas/training/hevy_common.py`, `mcp/tools_hevy_routine.py`, `config/training_phases.json`.
...
- **Y** = distinct PERFORMED workouts since **`EXPERIMENT_START_DATE`**, **+1** (amended 2026-09-07, #3671 — was a hand-maintained `reset_epoch_date` in `config/training_phases.json`). Reset-relative (zeroed by each experiment reset *by construction*), honest (skips don't inflate). Deduped by `workout_uid` across Hevy + MacroFactor.
...
**Phase advancement (operator):** to advance a phase, edit `config/training_phases.json` — flip `current` and bump `current_started` to that date (resets N per type) — then re-upload to S3 (`config/`). No code deploy. **Only `current`/`current_started` live in that file; the Y anchor does not** (amendment below).

### Amendment (2026-09-07, #3671) — the Y anchor is derived, and the second copy is deleted

`reset_epoch_date` was a hand-maintained date in `config/training_phases.json` that **nothing owned**. `deploy/restart_pipeline.py` contains no reference to the file, and ADR-077's phase taxonomy — the registry whose coverage assertion is supposed to stop experiment-scoped state silently surviving a reset — classifies **DynamoDB partitions** and has no jurisdiction over config files. So the anchor sat at `2026-06-16` through **eleven resets** while `EXPERIMENT_START_DATE` moved to `2026-09-06`: day 1 of a cycle rendered `Foundation - Push - 3 - 11`, and the question Y exists to answer — *"is this my first session since the experiment began, or my ninety-fifth?"* — got a wrong answer that looked plausible.

Two things kept it invisible. Nothing failed (a stale anchor yields a number, not an error), and `build_bundle.py` stages only `food_vocabulary.json` / `personas.json` / `config/coaches/*` — **not** `training_phases.json` — so `load_phase_state()` falls through to the **S3** copy. Re-anchoring the repo copy by hand (#3675) therefore did not move the live counter either.

**The fix is a deletion, not a new writer.** `build_title_context` derives `reset_epoch` from `EXPERIMENT_START_DATE`, which every reset already regenerates and which ships in every bundle (#781); the `reset_epoch_date` field is removed from the config. `tests/test_routine_title_y_anchor_3671.py` reds if the field is reintroduced, if the derivation is routed back through config, or if the file is later staged into the bundle without deciding the S3 copy's fate in the same change.

**N is deliberately NOT derived this way** (owner ruling, 2026-09-06): `current_started` stays hand-advanced, because a training phase may legitimately span experiment cycles. Y answers "since genesis"; N answers "Pull #3 of Foundation". Only Y zeroes on a reset.

**Still open** on #3671 (at the time this amendment was written): no registry enumerates which *config* fields are experiment-anchored (`character_sheet.json` and `user_goals.json` are re-anchored by the reset, `vacation_fund.json`'s null `start_date` has never been ruled on), and the reset's report does not name the anchors it moved. This amendment closes the Hevy counter; it does not close the class.

### Amendment (2026-09-15, #3808) — the class closes: `lambdas/experiment/config_anchor_registry.py`

The gap the amendment above named still open is now closed. `config_anchor_registry.py` is the config-file counterpart to `phase_taxonomy.py` (ADR-077): it enumerates every `(file, key)` pair under `config/**/*.json` whose key name is anchor-shaped (`start_date`/`end_date`/`*_started`/`*_epoch`/`baseline_measurement_utc`/bare `date`) and whose value is `None` or ISO-date-shaped — 20 hits across 14 files as audited 2026-09-14 — and classifies each one `reset_to_genesis` / `deliberate_carry` / `derives_live` / `not_anchored`, with a written reason. `character_sheet.json:start_date` and `user_goals.json:{start_date,end_date,baseline_measurement_utc}` are `reset_to_genesis`; `training_phases.json:current_started` is `deliberate_carry` (the owner ruling above, now enforced by a registry entry rather than left to a reset author's memory); `vacation_fund.json:start_date`'s null default is ruled `derives_live` — it already falls through to `EXPERIMENT_START_DATE` at read time in `lambdas/content/vacation_fund.py`, the same derive-don't-duplicate pattern this ADR chose for the Y counter, so nothing needs writing.

`assert_full_coverage()` runs as `deploy/restart_pipeline.py`'s Step 0b preflight (before Step 0's DDB census; `tests/test_reset_cadence_refusal_3601.py` pins the order) and raises `KeyError` naming any anchor-shaped field with no registry entry — a planted or forgotten anchor reds the guard instead of drifting silently for another eleven resets. `update_configs()` prints `report_lines()` on every reset: one line per path-bearing entry, `[treatment] file:field  before -> after`, so a `deliberate_carry`/`derives_live` field that was NOT supposed to move — or a `reset_to_genesis` field that was supposed to move and didn't — is visible in that run's own output (`tests/test_restart_pipeline_hooks.py::test_update_configs_prints_the_config_anchor_report`).

Issue #3671 itself carries `closure:live-proof` (#3595) and stays open: this is implemented and merged, but its proof is the *next real reset* actually printing the report and re-anchoring the `reset_to_genesis` fields, not a fixture — manufacturing that observation from a lane would defeat the point of the label. See `tests/test_backlog_closeability_3861.py` for the backlog tooling's own note that #3671 is "implemented, merged, and correctly still open."
...
**Date:** 2026-06-19
**Status:** Implemented (Phase 0–1 live: layer v86 + MCP + freshness deployed, 780 items / 114 days backfilled 2026-06-19; Phase 2 LLM namer deferred). **Related:** `docs/specs/SPEC_MEAL_GROUPING_2026-06-19.md`, `docs/reviews/REVIEW_MEAL_GROUPING_2026-06-19.md`, `lambdas/health/meal_grouper.py`, `lambdas/health/meal_templates_seed.py`, `lambdas/health/meal_projection.py`, `config/food_vocabulary.json`, `mcp/tools_meals.py`, `deploy/backfill_meals.py`.
...
**Date:** 2026-06-19
**Status:** Standard adopted; reference implementation live for `training_coach` (DI-1.3). **Related:** WORKORDER_DI1, `lambdas/ingestion/source_state.py`, `lambdas/intelligence/intelligence_common.py` (`movement_assessability` / `apply_movement_honesty_guard`), `mcp/tools_health.py::tool_get_readiness_score` (the prior-art guard this generalizes).
...
- **Extractor (deterministic-first, bounded Haiku tail).** `lambdas/training/training_notes.py` (pure core: rule-pass for numeric progression / equipment / logging-quirk / sentiment / form / limiter + the pain net) + `lambdas/training/training_notes_llm.py` (the semantic tail — Haiku, constrained JSON, **hash-cache** so an unchanged note never re-extracts, **monthly cap ~300** with fail-safe to deterministic-only). Both are layer modules — the on-ingest hook lives in `hevy_backfill_lambda` and the read tool + backfill in MCP.
- **Projection.** `pk = USER#matthew#SOURCE#training_notes#EXERCISE#<template_id>`, `sk = DATE#…#WORKOUT#<id>#<occurrence>`; source label `training_feedback_loop`. Idempotent upsert by the stable sk. Correction overlay at `…#WORKOUT#<id>#<occ>#CORRECTION` wins on read. *(Amended 2026-09-20, #3918: the sk gained the `#<occurrence>` suffix — one head per exercise SESSION, because a workout that logs one template twice put both notes on one key. Pre-#3918 rows read as occurrence 0; see docs/SCHEMA.md § training_notes.)*
...
1. **Detect** — a read-only `coherence-sentinel` Lambda (daily 10:45 AM PT) runs pure invariants (`lambdas/experiment/coherence_invariants.py`), each unit-tested by replaying a real past outage: prediction-health, computed-coherence, canonical-facts cross-surface agreement, endpoint non-degenerate shape, cross-surface count-agreement. It emits `LifePlatform/Coherence` → the `coherence-overall` digest alarm and persists a findings artifact to `s3://matthew-life-platform/coherence-log/`.
...
**Amendment (2026-07-18, SDLC review — #1339): bless the review-batch filing mechanics actually practiced.** The original scoring/idempotency/exclusion rules above were written for the one-time BACKLOG.md migration and never fit the dominant filing path since — recurring review batches (`fullreview`, `platform-review`, `site-review`, `sdlc-review`, the frontier/SDLC backlog sessions). Score-line drift (e.g. #1240/#1242/#1246/#1249: `Impact 2 × Confidence 1.0 / Effort M(2) = 1.0 → Later (severity→milestone disposition, PM-set)`) and idempotency-without-a-manifest (`gh issue list --label review:2026-07-16` reconciled with no `BACKLOG_MANIFEST`-style file written) were the dominant path being run against a written contract that only described the other one. This amendment makes both practices the record, alongside the original:

1. **A second, sanctioned score-line form for review-batch findings.** For a story filed FROM a review sweep (carries a `review:*` label), the score line may use **severity→Impact** in place of the four-component composite: **P1 → Impact 4, P2 → Impact 3, P3 → Impact 2**, Confidence fixed at **1.0** (verified findings only file with this form — an unverified finding doesn't get a score line at all), same Effort scale (S=1/M=2/L=4). The PM (Matthew, via the session) may then override the terciled milestone directly — recorded as **"(severity→milestone disposition, PM-set)"** in the score line, same as any other PM override under the original rule. Non-review stories (one-off findings, feature requests, a session's own discovered work) keep the original four-component composite (`Impact = 0.35·returnability + 0.25·credibility-moat + 0.20·monetization-readiness + 0.20·durability`) — the severity form is additive, not a replacement.
2. **Idempotency for review batches is the `review:*` label, reconciled before refiling — not a manifest file.** Before filing a review batch's findings, run `gh issue list --label review:<review-slug> --state all` and reconcile against it (skip already-filed findings, comment on ones an old finding extends). This **replaces the per-review manifest file** as the review-batch idempotency mechanism (`docs/reviews/BACKLOG_MANIFEST_2026-07.json` remains the historical record of the one-time BACKLOG.md migration this ADR originally described; it is not maintained per-review, and no new review needs one). `docs/reviews/` SWEEP/DSR-style manifests, where they exist, are supplementary session notes, not the idempotency mechanism.
3. **`gate:owner` is wired into the contract — owner-gated items ARE filed, labeled, and excluded only from the actionable seed query.** The original **Exclusions** clause above ("gated/won't-do/owner-capture items are NOT filed") described intent that was never practiced: every review since has filed human-only-act items as normal stories (e.g. #741, #1029, #748, #1187, #1114, #1243). This amendment corrects the written rule to match: **owner-gated items ARE filed as `type:story` issues** — filing is never skipped — and get the `gate:owner` label (`#FBCA04`, "Blocked on a human-only act by Matthew") stamped at creation by the filing agent. `/uplevel`'s Phase 1 seed query excludes `gate:owner` (`gh issue list --label type:story --milestone Now --state open` minus any issue carrying `gate:owner`), so a session can see its actionable queue — possibly empty — in one command instead of re-deriving the human/machine split in prose every session. A `won't-do` decision (as opposed to a pending human act) still lives in the review report's parked register per the original clause; that half of the Exclusions rule stands.
...
**Correction (2026-07-27, #1871): the PR-template half of the addendum above is superseded — `.github/PULL_REQUEST_TEMPLATE.md` is live again.** #1663 (2026-07-24) reinstated it as a lightweight What/Why + checklist scaffold (the old unused Backfill/Lambda-parity checkbox is deliberately not part of it — that rationale stays preserved as above, it just isn't a live form field anymore); `CONTRIBUTING.md`'s land-a-change steps now point contributors at it. `docs/_lint/tombstones.txt` already reflects this (its PR-template retirement rule was removed by #1663; only the `.github/ISSUE_TEMPLATE/` rule remains). **The `.github/ISSUE_TEMPLATE/*` half of the addendum is unaffected and stands as written:** issue forms stay retired, `gh issue create` per the ADR-099 conventions IS the intake.
...
### ADR-099 Amendment (2026-08-08, #1872 — the filing-contract linter promoted advisory → blocking; `check_story_labels.py` retired)

**Story:** #1872 (epic #1863) · **Amends:** the 2026-07-27 amendment above (#1865/#1867/#1868/#1870)

**Context.** The 2026-07-27 amendment named the precondition for this flip: `scripts/check_backlog_hygiene.py` could only move from advisory to blocking once #1868's backfill brought the open corpus to zero violations and that state held. Measured at session start: `python3 scripts/check_backlog_hygiene.py --advisory` → `OK — 56 open issue(s) satisfy the ADR-099 filing contract.` (56 — down from the 68 the 2026-07-27 amendment measured and the 60 recorded earlier the same day; issues filed and closed in the interim moved the count, never the zero-violation result). Re-measured immediately before pushing this change (the number the flip is actually being attempted against, not the session-start snapshot): **`OK — 56 open issue(s) satisfy the ADR-099 filing contract.`** — the same zero-violation result, confirmed fresh at push time, not merely carried forward. This mirrors the ADR-108 promotion pattern: flip on a measured signal, not the calendar.

**Decision.**
1. **`scripts/check_backlog_hygiene.py`'s default is now blocking.** `main()` exits 1 when any `severity=violation` finding exists, with no flag required. `--advisory` remains as an explicit opt-out (print the report, always exit 0); `--blocking` remains as an explicit flag for callers that want to say so even though it is now redundant with the default.
2. **Live-fetch failure stays fail-open in the new default, unconditionally.** `_fetch_live_issues()` returning `None` (no `gh` auth, no network, a malformed response) short-circuits `main()` to `return 0` before the blocking/advisory branch is even reached — a missing credential or a network blip can never wedge a wrap. `tests/test_backlog_hygiene_gate.py::test_cli_is_fail_open_when_gh_is_unavailable_in_both_modes` pins this for the bare invocation, `--blocking`, and `--advisory` alike.
3. **`scripts/check_story_labels.py` (#1349) is deleted**, along with `tests/test_story_label_gate_1349.py`. Its one rule — an open `type:story` carries *some* `model:*` label — is a strict subset of this linter's `rule_one_model_label` (exactly one `model:*`, corpus-wide, not story-type-only), so nothing it checked stops being checked. `.claude/skills/wrap/SKILL.md` step (e6), which invoked it, is removed; step (e7) (the hygiene gate) is now the sole filing-contract wrap check, and `docs/CONVENTIONS.md`'s gate-registry row for the old gate is folded into (e7)'s row.
4. **Net script budget for the whole #1863 program is +1** (`check_backlog_hygiene.py` added, `check_story_labels.py` removed) — the 2026-07-27 amendment already committed to this under the ADR-103/144 proportionality posture; this amendment is where that arithmetic is proven against the actual tree rather than merely asserted in prose.

**Why not tighten anything else while flipping it.** The measured evidence supports exactly one claim — the corpus was clean at flip time — not a broader claim that every rule's severity is correctly tuned. `later_staleness` stays advisory (an aged `Later` issue is a triage signal, not a defect) even under the new blocking default; the score-line value checks (two-decimal-place formatting, arithmetic agreement) stay advisory for the reason the 2026-07-27 amendment already gave — cosmetics must not outrank the unreachable-work defects that now get a real gate.

**Consequences.** A future filing that skips the ADR-099 contract now fails `/wrap` step (e7) the moment it runs, rather than being printed and ignored. The corpus can still regress (nothing stops a hand-edited issue from violating the contract outside the filing agent), but doing so now costs an immediate red at the next wrap instead of a silent miss. `--advisory` remains the documented way to see the report without blocking for a deliberate, reviewable exception — never a silent way to disable the gate, since invoking it requires visibly changing `.claude/skills/wrap/SKILL.md` itself.

**The precondition caught a real defect mid-implementation, not just a hypothetical one.** Between the session-start measurement and the push-time re-measurement above, a concurrently filed issue (#2235) briefly dirtied the corpus — filed with only a `type:story` label and none of `area:*`/`model:*`/`prio:*`, no `## Outcome`, no `## Acceptance`, no `**Epic:**` line, six rules deep. The implementing session re-checked the corpus per this issue's own written instruction before opening the PR, found it dirty, and stopped rather than land a blocking gate on top of a known violation — exactly the failure mode ADR-108's "flip on evidence" pattern exists to prevent (shipping a gate that reds the very next wrap on work nobody has done yet). #2235 was brought into contract compliance and the corpus re-verified clean before this PR was opened. The near-miss is the proof the precondition is load-bearing, not ceremonial: it fired on a real, unplanned violation during this exact implementation.
...
### ADR-099 Amendment (2026-08-27 — ¶3 gets an actor and a procedure: the `Now`-refill plan is derived, #3254)

**Context.** The 2026-08-22 amendment above declares the `Roadmap`→`Now` promotion path in ¶3 and stops there — it names no actor, no trigger and no procedure. Meanwhile `check_backlog_hygiene.rule_now_liveness` is **blocking** (#1872) below three startable `type:story` on `Now`, and the refill it points at, `/wrap` step (e9), walked **`Next` only** and, on an empty `Next`, reported honestly and stopped. The blocking gate and the sanctioned remedy were connected by prose in two files and by nothing executable.

Measured on the live corpus 2026-08-27: `Now` held exactly **3** startable stories — the floor — while `Next` held **1** startable story and `Later` held **0**. One more closure fires a blocking wrap gate whose documented remedy is one issue deep, and the next one after that has no remedy at all. `Roadmap` held 11 startable stories the wrap had no procedure to reach.

**The documented remedy also did not work.** `gh issue edit <N> --milestone Now` is *half* a promotion: ¶5 of the amendment above requires the score line's `→ <milestone>` arrow to equal the real milestone, and `rule_score_line_canonical` enforces that at VIOLATION severity. Running (e9) verbatim on the measured corpus swapped a blocking `now_liveness` finding for a blocking `score_line_canonical` finding — exit 1 either way. Proof, on the real corpus with one `Now` story removed: gate before = `1 violation … now_liveness`, exit 1; after the documented milestone-only edit = `1 violation … score_line_canonical`, exit 1.

**Decision.** ¶3's promotion path gets the three things it was missing, derived rather than remembered:

1. **The actor is the wrapping session, at `/wrap` (e9).** Same actor ADR-099's closure contract already names — the only one holding the corpus and the wrap's exit code at the same moment.
2. **The procedure is computed, not recited.** `backlog_next.plan_now_refill()` derives the ordered promotion plan from the same corpus the gate judges: donor walk `Next → Later → Roadmap` (from `MILESTONE_ORDER`, never re-typed), `type:story` only (nothing else clears the rule), ordered inside each milestone by the issue's **own stored score**, `Roadmap` capped at `ROADMAP_PICKS_PER_REFILL = 1`, and **both edits emitted per pick** — the milestone command and the retargeted score line. `python3 scripts/backlog_next.py --refill-now` prints it; `rule_now_liveness` embeds the short form **in its own blocking message**, so the gate can no longer fire while pointing at a ritual's name.
3. **Exhaustion is a distinct, loud verdict.** When the full sanctioned walk still cannot reach the floor, the finding prints `NO REMEDY IN THE CORPUS`, the shortfall, how many `Roadmap` stories the ¶3 cap deliberately held back, and the levers in order: file work · unblock a **named** `gate:owner`/`blocked:*` story · amend ¶3 to raise the product-pick rate. **Lowering the floor is explicitly not a lever** — `NOW_LIVENESS_MIN` lives in `backlog_contract.py` (one definition, aliased by the gate) and moves by ADR only.

**The second measurement, and the reason this amendment is not just plumbing: `now_liveness` counts stories, not startable work for the running model.** On 2026-08-27, labelling #2978 `blocked:date` honestly (it is date-blocked to ~09-24 with zero available work) dropped `Now` to 2 startable and fired the blocking gate. Ranking the sanctioned refill supply then produced the finding: `Next` held **1** startable story and `Roadmap` held **11**, and **all 12 were `model:fable`** while the running session was all-Opus. A lane-blind refill would have promoted one, taken the count to 3, turned the gate green — and added **zero** work the session could start. That is this repo's recurring class, an instrument reporting success without doing its job, sitting inside the very remedy this amendment was written to build. So:

6. **The plan is lane-scopable and the count always states its composition.** `plan_now_refill(..., lane=)` and `check_backlog_hygiene.py --lane <sonnet|opus|fable>` (env `BACKLOG_LANE`) scope the floor to the running session's own lane; off-lane candidates are **refused and counted**, and the verdict says `N startable story(ies) exist OUTSIDE lane model:X … promoting one would make the count green while adding nothing this session can start. That is not a remedy.` Lane-blind remains the default (the historical contract), but the remedy then prints a `LANE-BLIND COUNT` caveat naming each pick's lane. A remedy dischargeable dishonestly is not a remedy.
7. **`now_lane_coverage` — a new ADVISORY rule for the case the count reads live and is lying.** It fires only while `now_liveness` is silent (at or above the floor) and some sanctioned lane has zero startable `Now` stories, printing the histogram with its zeros. It is advisory, not blocking, and the promotion criterion is written down rather than left to taste (the ADR-108 pattern): blocking would impose a ≥1-story-per-lane floor nobody has argued for. Flip it when a measured 30-day window shows a lane starved while the count read live.

**On honest blockage labelling firing the gate.** The trigger above was an accurate label, and the gate going red for it is the gate *working* — the queue genuinely was not live and the label revealed it. What was broken is that the reward for honesty was a red wrap pointing at a step that had already run out of supply. That is what this amendment fixes; the blocking severity is deliberately **not** relaxed, because `now_liveness` is only defensible as blocking now that it carries a remedy or a named exhaustion verdict. Not fixed here, and stated rather than left implicit: `blocked:date` (self-clearing on a known date) and `gate:owner` (clears only on a human act) are collapsed into one "blocked" bucket by `bc.blocking_labels`, so the gate cannot say "this queue is live again on 09-24".

**What stays a human call, stated plainly (ADR-104).** The corpus cannot derive how many `Roadmap`→`Now` promotions a cycle has already taken — the promotion rewrites the very arrow that would have recorded the origin. So the cap is expressed **per refill**, a deliberate under-approximation, and the plan prints an explicit `CONFIRM no other Roadmap→Now promotion was taken this experiment cycle` line beside the product pick. That is the only human-memory step left in the procedure, and it is named as one rather than assumed.

**Consequences.** The blocking gate now carries its own remedy, with issue numbers. A drained debt corpus reads as the distinct state it is — "your one sanctioned product pick is #N, and after it you are still k short" — instead of a generic nudge toward a step that had already run out. `tests/test_now_refill_remedy_3254.py` keeps the must-fail case live: the milestone-only promotion must still measurably fail, or the two-edit instruction has become decoration.
...
| Weekly Panel podcast pipeline | **Load-bearing** (STORY) | Live since 2026-07-13 — the no-touch pipeline shipped (ADR-135), ep0 LIVE; the #374 revival is done (was "currently dark") |
| Reading pillar (2 GSIs, tools, page) | **Load-bearing (small)** | The owner's real instrument; Phase-E stays finish-gated |
| MCP server | **Load-bearing** | The instrument itself is core; the ~105-unused-tool overweight was pruned 143 → 60 tools on 2026-07-08 (#395/ER-04, ledger `docs/MCP_TOOL_AUDIT.md`) — no longer overweight |
...
| ~105 unused MCP tools + the 64-entry orphan allowlist | **RETIRED 2026-07-08** (#395/ER-04) | The AUDITED_AT ratchet prune executed against 30-day EMF telemetry: 143 → 60 registered tools, orphan allowlist 64 → 0. Ledger: `docs/MCP_TOOL_AUDIT.md`; further removals go through its dated AUDITED_AT ratchet |
...
| ADR-108 coach quality gate — scope (#968, narrowed #3413) | **Load-bearing on the daily brief ONLY; withdrawn from the board 2026-09-01; deliberately NOT extended further** | Added 2026-07-11 (#968) covering the daily brief (regenerate-or-hold) and the public board `/api/board_ask`. **Narrowed 2026-09-01 (#3413): the board is out.** Measured — callee p50 10434ms (7d, n=211) against a 10s client cap and a 14s budget written from an assumed "≈2-5s"; 7 days of live board traffic gave 8 attempts and **0 verdicts**, while costing ~10s of reader latency per coach and producing 504s on launch day. Withdrawing forfeits no measured capability; the board's true voice-fidelity rate stays **unknown** and is #3414's question, not a settled one — #3414 (2026-09-01) added the observe-only async verdict channel to measure it (`BoardQualityGateVerdict`; enforcement scope unchanged), with the row's keep-or-delete decision deferred to ≥30d of datapoints. `inter_coach_dialogue` + `coach_memoir` stay grounding-only ON PURPOSE: internal/narrative surfaces, lower stakes, and ADR-108's 10.2% failure rate was measured on daily outputs — extrapolating it to those voices is unmeasured. `/api/ask` + `/api/explain` are narrator-voiced (no coach_id/voice spec), so a per-coach voice-fidelity gate cannot apply there; their ADR-104 grounding gates stand. Re-open only with a measured failure rate on the excluded voices. **Priced tolerance (owner decision on #3424, option (a), 2026-09-02): the brief leg's 30s fail-open ceiling is ACCEPTED as-is** — a gate invocation exceeding the caller's 30s ceiling ships that coach section ungated, silently. Measured at decision time (CloudWatch REPORT, 7d ending 2026-09-02T20:17Z): n=109, p50 10.6s, p90 20.6s, **over-30s 0/109 (0.0%, Wilson 95% [0%, 3.4%])** — the originally-filed 8/211 (~4%) tail predates the #3413 board withdrawal and has not recurred since. Zero engineering; the honest-label option (d) is the PRE-NAMED upgrade path, not a fresh debate. **Re-measure triggers: quarterly (next ≤2026-12-02), OR p90 crossing 25s, OR any observed over-ceiling invocation; if the re-measure shows the ungated rate above ~2%, implement (d) — surface ungated sections in the brief — rather than widening the tolerance** |
| The SDLC estate — 4 review rituals: `/fullreview`, `/platform-review`, `/site-review`, `/accuracy-review` (2026-07-18, #1341) | **Load-bearing (rotating)** | ~2–3M subagent tokens per run; each grades a distinct surface (fullreview: whole-platform expert-panel grade-to-A; platform-review: R22-style 9-lens consultancy sweep — 10 minus the retired `sdlc` lens, below — now the monthly/pre-milestone workhorse; site-review: human-in-the-loop page-by-page reader experience; accuracy-review: the deterministic truth audit of data/DB/AI-prompt materialization, CI-enforced layer). Trigger to demote any one ritual: two consecutive runs against a stable platform surface findings-empty (nothing CONFIRMED) — retire or fold into a sibling. See the `/sdlc-review` supersession note below for the fifth ritual and the one lens it retires. |
| The SDLC estate — `/sdlc-review` itself (2026-07-18, #1341) | **Load-bearing** | The lifecycle-audit companion to `/fullreview` (ideation → issue → worktree → AI implementation → verify → PR → deploy → oversight, as one pipeline) — this ADR-103 row, ADR-099's amendment, and this hygiene sweep are its first output. Trigger to demote: the machinery/practice layer stops changing quarter-over-quarter (unlikely while the platform is under active development). |
| 3 autonomous scheduled workflows: `remediation-agent.yml` (self-healing triage + gated auto-merge, ADR-064/065/129), `fresh-eyes.yml` (weekly board-perspective survey), `golden-brief-eval.yml` (deterministic-verdict regression canary on every push + weekly complement) | **Portfolio → remediation-agent; Load-bearing → golden-brief-eval; Portfolio (new) → fresh-eyes** | All three green-on-schedule (verified via `gh run list`, 2026-07-17/18). `remediation-agent` stays **Portfolio**, not Load-bearing: ADR-129 already demoted it to `shadow` after zero merged safe-class PRs across every sampled run — the safety design is exemplary, the yield isn't there yet; earns Load-bearing only if it ships real fixes monthly post the #1264/#1282 loop-closure fixes. `golden-brief-eval` is **Load-bearing**: it gates every push with deterministic canaries, not advisory. `fresh-eyes` is **Portfolio**: one run ever (2026-07-12) — too new to grade efficacy; revisit at 3+ runs. |
| Social syndication poster (#1629 `lambdas/syndication/`, gated/unbuilt; governed by ADR-140) | **Portfolio** | Added 2026-07-25 (ADR-140, #1630, board verdict `review:social-boards-2026-07-21`). Projection-only announcer of already-published content; never load-bearing — the site, feed, and email remain the distribution of record. **Dated retire trigger: 90 days live with no measured referral traffic** (UTM-attributed sessions / confirmed subscribers, #1621) → delete the lambda, keep `scripts/post_social.py`. Precedent: the remediation agent's ADR-129 demotion — automate a proven habit, never a hoped-for one. If the Phase 0 gate (≥15/30 days of manual use) is never met, #1629 closes unbuilt and this row records the decision |

**`/platform-review`'s `sdlc` lens — retired, superseded by `/sdlc-review` (2026-07-18, #1341).** `/platform-review`'s Phase 1 lens list carried an `sdlc` lens ("CLAUDE.md/memory/skills/agents ergonomics") that the dedicated `/sdlc-review` ritual now covers in far greater depth (a full ideation→oversight pipeline audit vs. one ~10-finding lens inside the original 10-lens sweep). The lens is **removed** from `.claude/skills/platform-review/SKILL.md`'s Phase 1 lens list in this same change — `/platform-review` is NOT superseded as a command (it remains a 9-lens whole-platform consultancy sweep over the other 9 lenses, which `/sdlc-review` does not cover), only its one redundant lens is retired. This answers the supersession question the review flagged rather than leaving it implicit: **kept — `/platform-review` and `/sdlc-review` are siblings with a corrected non-overlapping lens boundary, not a superseded/superseding pair.**
...
> **2026-07-26 (ADR-144, #1666):** the ledger's maintained home is now **`docs/PROPORTIONALITY.md`** — one legible page with rent classes and demote triggers per row. The table above is the frozen 2026-07-03→07-25 state, kept for history; edit the new home, not this table.
...
**Arm 2 — the grounded-generation gate (`lambdas/ai/grounded_generation.py`, layer + bundled):**
...
**Amendment 2026-08-28 (#3252 box 2) — "logging" has one definition, and it counts auto-synced sources.** ADR-104's absence semantics said an unlogged behavior scores 0 and is narrated honestly, but never defined *what counts as logged*. The gap surfaced on `/method/board/`: the weekly priority asserted "no active logging (food, training, or journal entries since August 17th)" while DynamoDB held two Strava activities inside that exact window. Nothing lied — the training-absence answer was derived from Hevy alone (Hevy is the `engagement_channel` for training; Strava is not), so the narrative and the data could disagree without either being wrong.

**Owner ruling: an auto-synced source counts as logging.** If the data arrived, it was logged, regardless of whether Matthew typed it. "You didn't log a run" is **wrong** when Strava synced one. Auto-sync is not a lesser class of evidence for an absence claim.

Consequences, all structural (`lambdas/ai/absence_sourcing.py`, #3252):
- **The rule is "name every source you consulted", not "name the manual ones."** An absence claim must be grounded against the FULL set of sources that could have supplied the fact, and it must name them; an auto-synced source cannot be silently excluded from the denominator.
- **The denominator is DERIVED, never hand-listed** — the `evidence_for` facet in `lambdas/ingestion/source_registry.py`, read through `evidence_sources_by_category()`. A hand-typed "sources that count" list is the same defect one layer up, which is what `engagement_channel` had accidentally become.
- **The detector is structural, not phrase-matched.** The trigger is the grounding FACT that licensed the sentence — an `AbsenceTransition` of kind `never_logged`/`paused`, or a `LogAvailability` category that is covered-and-not-present — computed in code before any model runs (ADR-105). The module contains no regex and takes no text argument.
- **A paused or stale source is not an absent one** (#3268). Which silence is which is the registry's own `behavioral` facet: a behavioral source's silence IS the absence (a quiet Strava is a week without a run), while a paused source (Garmin, ADR-074) or a dark infrastructure pipe (Apple Health) can only yield `stale` — a hole in the record, never a fact about Matthew.
- **Fail-closed, not advisory.** `sourced_availability` / `sourced_transitions` delete the unlicensed answer before a prompt is built, so the false claim is unbuildable rather than discouraged — the #2382 discipline. Known cost, accepted: the presence- and recency-derived availability maps can no longer carry a `workout` absence at all, because neither has ever consulted Strava or Apple Health. Restoring that arm means wiring those sources into the derivation (`sources_observed=`), not relaxing the rule.
...
> **Amendment 2026-09-06 (#3550, #3551 — two rigor-bar corollaries recorded once):** (a) **A pooled statistic may not claim a property no stratum has.** The platform-wide calibration card pooled coach calls and interval forecasts and scored the pool against ONE pooled base rate; because the strata's base rates differed, the pooled reference Brier was worse than either stratum's own and the card read `skilled / well-calibrated / reliable` (skill +0.17) while both strata were unskilled. Pooled cards are scored by `calibration_core.score_strata` against a *stratified* climatology (Σ nᵢ·bs_refᵢ / Σ nᵢ), the over/under-confidence verdict is driven by the worst stratum's gap, and each stratum's own numbers ride on the card. (b) **A numeric level claim is graded as the level the coach stated, never as a slope sign.** "Recovery score will be approximately 53.5%" is a `point` spec — confirmed iff the reading on the target date lands within ±1 SD of the metric's trailing 30-day personal series (rule 4 of this ADR; the tolerance and its rule are frozen into the spec at emission) — never a 14-day `directional` bet; direction words are matched at word boundaries with the metric's own name excluded (`recover` no longer reads `recovery` as "up"). Past verdicts graded the other way are corrected on the record by `scripts/regrade_level_claims_3551.py` (a `verdict_correction` field + the prior verdict kept), never edited silently.
...
**Scope extension (2026-07-11, #968) — RETIRED 2026-09-01 by the #3413 amendment below; read that first, this paragraph is history.** The gate also covered the other reader-facing coach-voiced surface: the public board (`/api/board_ask`, initial answer + follow-up turns, `lambdas/web/board_quality_gate.enforce`). Same lambda, same payload/correction-note machinery (reused from `ai_calls`), different disposition by design: a reader is synchronously waiting, so the board runs evaluate-then-regenerate-once under a hard time budget off the real Lambda deadline and **fails open** (a fired verdict that can't be corrected in budget is served, with log + `BoardQualityGateFired` metric + eval retention) — fabrication is already fail-closed there via ADR-104, so this gate protects voice fidelity only, and an off-voice-but-grounded answer beats a reader-facing timeout or hold. `inter_coach_dialogue` and `coach_memoir` are deliberately NOT gated, and `/api/ask`/`/api/explain` cannot be (narrator-voiced, no voice spec) — the ADR-103 ledger row records the full scope posture.

**Amendment (2026-08-29, #3083 — owner decision): the gate's own judge failure now fails CLOSED.** Point 4's fail-open covers TRANSPORT errors only (unreachable Lambda, timeout, malformed payload — no gate ever judged). The gate's internal fallback (`coach_quality_gate._build_fallback_report`, returned when its own Haiku judge call raises or replies non-JSON) also returned `passed: True` — fail-open by accident, not by this ADR's letter — and green-lit 84 of 484 drafts (17.4%, on 24 of the 30 days to 2026-08-23) that the blocking gate never evaluated (#2893). It now returns `passed: False` with an honest `reason` naming the infrastructure failure, so an unjudgeable draft rides the SAME regenerate-or-hold path as a failing verdict: one regeneration gives the judge a second chance on a fresh draft, and a hold darkens only that coach's section (`CoachHold` is terminal per-domain, #966) — never the whole brief. Priced on the re-measured rate, not the filing-time one: #3081 removed the dominant trigger (the gate's 800-token cap; post-fix fallback rate **0/42**, rule-of-three ceiling ≤7.1%) and `LifePlatform/AI TruncatedResponses` guards its recurrence. Unchanged: the transport fail-open (point 4), the board surface's #968 evaluate-under-time-budget fail-open, and the handler's own crash-path 500 (a failure *around* the gate, not of its judge — left open, named in #3083's PR).

**Amendment (2026-09-01, #3413): the board surface is WITHDRAWN from this gate's scope — it never once worked there.** The #968 scope extension above is retired. `web/board_quality_gate.enforce` and both `site_api_ai_lambda` call sites are removed; the module keeps only the deterministic #1973 cycle-boundary rule, which `ai_calls._invoke_quality_gate_sync` still merges into the report for BOTH coach-voiced surfaces, so that rule's coverage is unchanged.

The withdrawal is on measurement, not preference. The board ran the gate synchronously behind a 10s client-side cap and a 14s evaluate budget, both sized from a source comment asserting the gate cost "≈2-5s". `coach-quality-gate`'s real Duration (CloudWatch Logs REPORT lines, to 2026-09-01): **7d n=211 p50=10434ms p90=20580ms max=30637ms**; 48h n=68 p50=16371ms p90=30000ms. The cap sat below the callee's **p50 in both windows** — the gate could not return at its typical speed, never mind its slow end. The live consequence over 7 days of real board traffic: **8 gate attempts → 6 "skipped", 2 read timeouts, 0 verdicts**, and `BoardQualityGateFired` has no datapoint in all of August. It was ~10s of guaranteed reader latency per grounded coach with the result discarded, inside a 30s budget already shared with up to 8 sequential coach generations — which is how `/api/board_ask` came to serve 504s to readers on launch day.

What this does and does not settle. It forfeits no *measured* capability, because the instrument never produced one. It does NOT establish that the board's voice fidelity is fine — that rate is **unknown**, and saying otherwise would be the same assumption that caused this. Recovering it belongs to **#3414** (async invoke, verdict captured callee-side; the gate lambda already runs to completion today and is already paid for, so the measurement is near-free). Unchanged by this amendment: the daily brief's regenerate-or-hold enforcement, the #3083 fail-closed judge rule, the transport fail-open (point 4), and ADR-104 grounding on the board — which is where fabrication protection actually lives, is pure/deterministic/fail-closed, and is independent of this gate. Per this gate's own #968 rationale, "an off-voice-but-grounded answer beats no answer"; readers were getting no answer.

**Amendment (2026-09-01, #3414): the board's verdict is recovered on an ASYNC channel — observe-only, the enforcement scope does NOT re-widen.** The #3413 withdrawal left the board's voice-fidelity failure rate unknown; this closes the measurement gap without touching the reader path's latency or behavior. Shape: after a grounded board answer is already being served, `web/board_verdict_observer.observe()` queues ONE fire-and-forget `InvocationType="Event"` invoke of `coach-quality-gate`; the event carries the `emit_verdict` opt-in (`ai/quality_gate_contract.EMIT_VERDICT_KEY` — attached only when a caller asks, so the daily brief's enforcement wire payload is byte-unchanged), and the gate captures its own verdict on completion (`_emit_async_verdict`): `BoardQualityGateVerdict` (Surface; + Outcome ∈ passed/failed/unjudged — an `_fallback` report counts as *unjudged*, never as a failure, per ADR-104 honest absence) and, on a real failed verdict, `BoardQualityGateFired` (CoachID — the #968 metric, finally with datapoints) + eval retention with disposition **"observed"** — honest that nothing was regenerated, refused or held. The structural #3413 guard is EXTENDED, not loosened: the synchronous-invoke needles still red the reader lambda, and the observer module gets its own needle set (Event-only, no payload consumption) with a mutation proof. Decision rule stands from #3414's acceptance: after ≥30 days of datapoints the measured rate decides the ADR-103 row — and a negligible rate means DELETING this machinery, not keeping it.
...
**What is guarded / unchanged.** The `production` **manual-approval gate on `deploy` is untouched** — auto-rollback reverts, it never auto-deploys past the gate. The site rollback fires on the visual-QA gate (the reader-facing net); the Lambda rollback stays smoke-only (visual-QA is gating-not-rollback for backend code, unchanged from the 2026-06-05 posture). **Scope note (ADR-136, 2026-07-18):** the `production` manual-approval gate referenced here is `ci-cd.yml`'s Lambda/CDK `Deploy` job. The site's own deploy path (`site-deploy.yml`, #750/#897) has never carried that gate by design — its "unchanged" safety property is this rollback mechanism, not an approval click; see ADR-136.
...
**Amendment (2026-08-03, #1927 — the two AI CI gates leave band 1 for the operator-truth placement at the hard stop).** ADR-125 classified `reader_truth_qa` (#1095/#1096) and `visual_ai_qa` (#1428) as "internal QA, sacrifice first". Correct as far as it went — they are QA, and neither is a reader surface. What it did not anticipate is that both are also **CI gates that report green when paused**: the deploy pipeline's post-deploy prose pass, the `visual-qa` job's AI-vision pass, and the nightly `qa_smoke` "Reader Truth" category. Cutoff 1 therefore made the pipeline's own truth-telling a function of month-boundary spend arithmetic.

*Measured, not assumed (#1920 + #1927).* SSM parameter history for `/life-platform/budget-tier` shows **tier ≥ 1 continuously for 26 of the 30 days** 2026-07-06 → 08-01 (broken only by two manual flips totalling ~22 seconds), corroborated by `QAPausedByBudget` firing on every qa-smoke invocation over the window. Both gates were dark for that entire period, and the pipeline was green for that entire period, because a gate that does not run produces no findings. Re-measured on 2026-08-03 against the governor's own live breakdown (mtd $5.57, projected $73.76, burn $2.38/day, ceiling back to the $85 base after `_TEMP_CEILING_WINDOW` self-reverted): replaying the real `_decide_tier` forward over August yields **tier 1 from day 5 and tier ≥ 1 on 27 of 31 days**. Tier 1 is not an exception; it is where this platform lives. No ceiling below ~$101 changes that at the current burn (the bands are fixed fractions of the ceiling, and `_decide_tier` lets the projection escalate one tier above actual spend once `EARLY_MONTH_DAYS` passes).

**Decision.** `reader_truth_qa` and `visual_ai_qa` move to cutoff **3**, documented as an **operator-truth** placement inside band 3 rather than a fourth band.

*Why this keeps ADR-125's ordering rather than breaking it.* The ladder sacrifices by AUDIENCE. These two do not serve an internal analysis loop; they serve the **operator** deciding whether the deploy that just landed is safe — an answer upstream of every reader surface below it, and worthless if it can be switched off by a spend threshold. Their cost profile agrees with the placement: both are per-DEPLOY and bounded (one Haiku batch over ≤ 8 surfaces; ≤ 3 images × 6 tier-1 doors at ~$0.001/image — pennies per run), not per-day and open-ended like their former band-mates, and their value peaks exactly when shipping, which is when a pause is most likely to be in force. Internal AI still dies first (`ensemble`, `coherence_semantic`, `chronicle_editor`, `eyeball_estimate`, `conversation_enrichment` — the band-1 set is unchanged) and the reader product still outlives it. At cutoff 3 the gates stop exactly when `bedrock_client` stops everything: they run whenever Bedrock runs at all.

**Amendment 2026-08-27 (#3240's attribution, measured) — the cost sketch above was wrong; the placement it supports is not.** The parenthetical "one Haiku batch over ≤ 8 surfaces … pennies per run" is an accurate description of the **nightly `qa_smoke` Lambda** copy of reader-truth, applied by mistake to the **CI** copy. CI runs `--reader-truth` over the **full page surface**, not over 8 surfaces. First measurable once #3240 split `LambdaFunction=unknown` into per-gate rows; from `LifePlatform/AI::EstimatedCostUSD`, 2026-08-27, n=5 deploy-time runs, all Haiku, in the `--ai-qa --ai-qa-max-tier 1 --reader-truth` mode both `ci-cd.yml` and `site-deploy.yml` run:

| unit | calls/run | input tok | $/run |
|---|---:|---:|---:|
| `reader_truth_qa` (CI) | ~20 | ~156K | **~$0.194** |
| `visual_ai_qa` (CI) | 6 | 40.4K | **~$0.045** |
| **the pair** | | | **~$0.24** |
| reader-truth in the `qa_smoke` Lambda, for contrast | 2 | 12.3K | ~$0.014 |

The pair is ~24 cents a run, not pennies, and the **prose** gate is the expensive half — ~13x the Lambda copy's unit and ~4x the vision gate, the opposite of where the images-are-expensive intuition pointed. **What the placement actually rests on survives intact:** per-run cost is stable to the cent across runs, so "per-DEPLOY and bounded" holds; the daily total is merge-cadence-driven — $0.90–$2.84/day over the only three complete UTC days the `CallerClass` dimension has existed for (2026-08-24..26, mean $1.63, sd $1.06), 08-27 already $3.10 partial, and $1.04/day averaged over the cost governor's own trailing-7d window — which is a cadence question, not a band question. Not priced here: the Sunday full-surface `--ai-qa` pass (`visual-qa.yml`, no tier cap) and the daily standalone `--reader-truth` fire. The cadence decision this opens is filed separately.

*Why this is not the `coherence_semantic` defect in reverse.* That bug was an **unlisted** feature defaulting to 3 by accident. These two are listed, commented, and pinned by a named `_OPERATOR_TRUTH` band in `tests/test_budget_guard_ladder.py`, with `budget_guard.CI_GATE_FEATURES` as the one derived list every consumer reads.

*A paused gate must still be legible as paused.* Cutoff 3 makes the pause rare; it does not make it silent. `tests/test_budget_ci_gate_visibility_1927.py` pins the CI output contract: the stdout summary line, the `$GITHUB_STEP_SUMMARY` block, and — new — a `::warning::` **annotation**, which is the only one of the three visible without opening the job log (the same instrument ADR-147 chose for `content_truth` findings). A gate that ran raises no annotation, so the signal cannot decay into noise. The `QAPausedByBudget` metric and the qa_smoke ⏸ check are unchanged.

*Visibility of the tier itself.* `budget_guard.paused_features(tier)` derives what a tier has switched off from `_FEATURE_CUTOFF`, and the daily brief's existing budget line now carries it (`… · paused: 5 AI features (…)`) — #1927's "why nobody noticed" was partly that the tier number alone required reciting the cutoff map from memory. Nothing is added at tier 0.
...
**Amendment 2026-08-23 (#2889) — the seam spreads to the other daily narrative surfaces, and a rule comes with it: a hit skips the GENERATION, never the GATE.**

The realization was measured first, per the story's box 1, and the number was zero: on 2026-08-23 `GenerationSkippedUnchanged` had **zero metric variants** in CloudWatch — never emitted in the ~7 weeks since this ADR landed — and all 8 rows of `USER#matthew#SOURCE#coach_gen_cache` carried `reuse_count = 0` with `first_generated == last_generated`. #3001 fixed the cause (the call site hashed the *rendered* prompt, so `canonicalize`'s key-based strip was a no-op) and the corrected code's first run was 2026-08-23 — a forced miss, because the stored hashes predated the new scheme. A **second**, independent blocker is now measured and recorded rather than assumed away: the largest fingerprint part (`brief`) is the orchestrator's Haiku output at `temperature=0.3`, and over 56 consecutive-day brief pairs (8 coaches × 7 day-pairs, live `COACH#*` / `BRIEF#` rows, 2026-08-16→23) **0 were identical** — the model-written narrative fields churn in 55/56 pairs even when the deterministic injected fields do not. The coach-brief path therefore still cannot hit; moving that gate upstream of the orchestrator is filed separately, not smuggled in here.

That is also why the extension does not simply copy this ADR's reuse-the-verdict shape. It is sound for the coach brief only because that gate is a pure function of the fingerprinted inputs. Every other daily narrative surface is gated by `grounded_generation`, whose **fabricated-date (#1242) and cycle-freshness (#1691/#1897) classes are functions of _today_**: a reflection that honestly said "Day 4" when it was written is a stale-Day-N violation when it is republished on Day 9 from byte-identical inputs. So `generation_cache.reuse_if_still_valid(...)` makes the re-gate structural — it takes a `revalidate` callable, runs the surface's own publish gate against today's context on every hit, and falls through to a fresh generation when the verdict is falsy **or raises** (fail-closed, matching this ADR's asymmetry: a spurious regeneration costs money, a spurious reuse costs the truth).

Two surfaces gained the gate, both daily, both with fully deterministic hashable inputs:

- **`coach-daily-reflection`** (8 Haiku calls + up to 16 deterministic gate runs/day) — `_gather_facts` reads each coach's latest `OUTPUT#`, so an ADR-108 HOLD, a budget pause or a stalled coach leaves the inputs byte-identical. Measured headroom: 206 of 240 coach-days produced a new output over 30 days, so **34 coach-days (14%) had unchanged inputs**, and `training_coach` alone contributed 14 consecutive such days. Re-gate = `_accepts` (ER-03 + the #2430 grounding classes).
- **`coach-ensemble-digest`** (the platform's most expensive daily Haiku call — `max_tokens=6000`, and a surviving finding buys a second) — `cycle_date` is deliberately **not** a fingerprint part, which is exactly the mistake that killed the original wiring and is safe only because of the mandatory re-gate. Only a gate-passed *model* digest is cached; a fallback or a grounding HOLD never is, so a degraded cycle cannot be replayed later as if it were real.

`GenerationSkippedUnchanged` gains a second dimension, `Surface`, so a nonzero rate is attributable rather than collapsed across three generators. Forking a dimension normally orphans the existing series; here it cost nothing, because the measured fact was that there was no existing series.
...
### Amendment 2026-08-30 (#2833) — the gate is retired with `auto` mode

The owner decision on #2833 (2026-08-29) made the agent's `shadow` posture permanent (ADR-129 amendment, same date). With no mode in which it could ever run, `remediation/automerge.py` — and its tests, its workflow step, and the `auto_earn_marker.json` streak that measured it — were removed rather than left as dead code behind live tests. The gate's lifetime record: **zero** decisions written to `remediation-log/automerge/`, **zero** `auto-fix-safe` PRs ever opened (`gh pr list --label auto-fix-safe --state all` is empty on 2026-08-30). The principle the ADR stated — the LLM proposes, deterministic code decides — survives in the stronger form: the LLM proposes, a human decides. The agent's in-band `Bash(gh pr merge *)` disallow and the read-only role are unchanged. The `#2611` amendment above is moot: IAM is human-merged because everything is.
...
### ADR-129 Amendment (2026-08-30, #2833 — `shadow` is permanent; the earn-back bar is retired)

**Context.** The 2026-07-20 amendment set a numeric bar for re-promotion to `auto`: 10 consecutive clean scheduled runs, zero dismissed sentinel true positives, and ≥3 spot-audited `auto-fix-safe` proposals. Measured on 2026-08-30, eight weeks after the demotion: `auto-fix-safe` PRs merged in either mode since June = **zero**, and in fact **none was ever opened** (`gh pr list --label auto-fix-safe --state all` returns nothing), so leg 3 could never have been satisfied; the `remediation-log/automerge/` audit prefix holds **0 objects**; `remediation-log/auto_earn_marker.json` is untouched since 2026-07-06 17:31Z — a streak counter surfaced in the Mon/Wed/Fri email (the alternative #2833 floated) would have been counting nothing. Meanwhile #2611 (2026-08-13) removed IAM from the gate's allowlist, so the earnable surface was shrinking, not growing. The issue's own sharpest line held: the undecided middle — full cost, zero self-healing — was the worst state, and "decide later" was a decision being made by default. The E7 reframe (#2849 — capabilities earned per leg of a composite operator) does not need this gate to exist: an earning mechanism for a future leg can be designed when that leg exists, against that leg's own measurements.

**Decision (owner, on #2833, 2026-08-29).** `shadow`, permanently. The remediation agent is a **triage instrument**: it triages, opens PRs a human merges, and sends the one curated needs-human email. Consequently:

1. **`auto` is a retired value** of `/life-platform/remediation-mode`. The live values are `off | shadow`. `remediation/agent.py::gate()` coerces any other value to `shadow` and surfaces a deterministic needs-human line ("reset the parameter") — a stale `auto` is rejected as a grant but does not stop triage. Re-opening a self-merge path is a new ADR, never an SSM flip.
2. **The deterministic auto-merge gate (`remediation/automerge.py`, ADR-065) is retired** with its tests and its workflow step — nothing called it in a mode that could ever run, and dead code behind live tests is the shape this repo does not keep. `gh pr merge` stays in the agent's `disallowed_tools`; the workflow has no merge step; `tests/test_remediation_agent.py` and the public-claims registry (`tests/public_claims_registry.py::compare_remediation_mode`) hold that shape structurally.
3. **The auto-earn path is retired**: `earn_or_shadow_check`, `AUTO_EARN_WINDOW_DAYS`, `EARN_MARKER_KEY` and the S3 marker's writers are gone. The marker object itself is a 54-byte historical artifact the owner may delete (it is outside the delete-protected prefixes).
4. **The 2026-07-20 numeric bar is retired** — not failed, retired: it was a bar for a promotion that is no longer on offer. The three read-only lookups it named remain useful as the *audit* of the agent (are its proposals correct? were sentinel true positives dismissed?), which is now the whole question.
5. **Buckets A/B keep their labels** (`auto-fix-safe` / `needs-review`) as triage classes — "template-shaped, low-risk" vs "behavioural, read closely" — because the taxonomy, the acknowledgement ledger and the public track record all key on them. Neither is a merge grant. IAM (`cdk/stacks/role_policies*`) stays Bucket B (#2611) by the same structure.

**Rent for the chosen shape (ADR-105 — measured, with n and window).** `LifePlatform/AI::EstimatedCostUSD{LambdaFunction=remediation-agent}` (the #3070 emitter, read-only CloudWatch on 2026-08-30): **$1.60 summed over 2026-08-24 → 2026-08-30, n = 9 emitting runs of 11 runs** (3 scheduled Mon/Wed/Fri, 8 urgent-dispatch/manual; a run with no signals invokes no model and emits nothing) ≈ **$0.18 per run**; at that rate the scheduled leg is ~$2/month (~13 runs) and all triggers ~$7/month. Two honesty caveats: the series only exists since #3070 landed on 2026-08-24, and it is the Agent SDK's self-reported cost, which under-counts Cost Explorer (the `CostMetricDriftRatio` caveat, #2883). The `CallerClass=remediation` copy the governor splits on (#2883/#3308) had **no datapoints yet** at measurement time — first emission expected at the 2026-08-31 scheduled run; the PROPORTIONALITY row says to re-cite from it at the next re-read. The reshape itself changes none of this: the gate and the earn check never called a model, so the Bedrock bill was always the triage. What it removes is `surface` (no self-merge path to price), one workflow step, one module, and one recurring "is it earned yet?" question.

**Consequences.** `docs/PROPORTIONALITY.md`: the agent's row is re-priced as a triage instrument (Portfolio; `$` measured; demote trigger = two consecutive re-reads with zero human-merged proposals AND no needs-human line that another channel had not already raised) and a Retired row records the gate + earn path. `CLAUDE.md`'s Self-healing paragraph, `docs/REMEDIATION_TAXONOMY.md` (the LLM's rubric), `docs/RUNBOOK.md`, `docs/OPERATING_DISCIPLINE.md` and the public surfaces (`/method/*` editorial via `scripts/v4_build_evidence.py`, the org-chart essay, the `/api/agent_activity` roster) now describe the permanent shape; `docs/_lint/tombstones.txt` fails any live doc that teaches the gate, the marker or the bar again. ADR-144's "ADR-129 is the demotion template" reading stands, with a coda: a promotion bar nothing approaches for two measurement windows is itself a finding, and the finding is "retire the bar".
...
**Record cross-references (2026-07-18 hygiene sweep, #1343).** This decision retires ADR-013 (Shared Lambda Layer for Common Modules) — the layer it created is gone, not just superseded in practice — and supersedes ADR-027 (MCP Two-Tier Structure: Stable Core → Layer, Volatile Tools → Zip), whose Layer tier never existed to depend on it. Both records are marked at their own Status field per this note.
...
**Amendment (2026-07-19, #1354 — tier-1 residence is the expected state in dev-heavy months; bands deliberately NOT re-derived from the measured floor).** The 2026-07-18 SDLC review measured `LifePlatform/Budget::BudgetTier` residence and found tier ≥1 on 19 of June's 30 days (including a tier-2/3 excursion Jun 15–18) and 14 of July's first 19 (continuous tier-1 since Jul 6) — a steady state no record had decided. The arithmetic makes it structural, not anomalous: the measured non-AI floor is ~$36–43/mo (live Cost Explorer, post-WAF — ~2.5x the "$15–17 all-in" the cost doc used to claim), so at the $85 base the 73% band (tier 1 at $62.33 projected) trips whenever projected AI spend exceeds ~$22/mo (~$0.75/day) — which any sustained dev sprint does. **Decision: tier-1 is the accepted posture in dev-heavy months.** Tier 1 pauses only internal/dev AI (ensemble, chronicle editor, coherence-semantic — the ADR-125 ladder's first band); reader surfaces and the daily brief stay on, which is the ladder working as designed, not a degradation to fix. The alternative — re-deriving the bands upward from the measured floor — is **rejected**: the 73% band exists to degrade *before* the ceiling is threatened, and spending that early-warning margin to make tier-0 the cosmetic norm would leave tier 2/3 as the first observable signal. Residence is now visible instead of invisible: the monthly close in `docs/COST_TRACKER.md` records a **days-at-tier≥1** line per month (derived from the BudgetTier daily maximum — the metric the governor already emits every run; no new storage needed, CloudWatch retains it 15 months and the close ritual banks each month's number into the ledger), and `scripts/check_doc_facts.py` fails CI when that doc's newest Verified: stamp exceeds 45 days.

**Amendment (2026-07-21 — July-2026 ONLY: base $85 → $115, surge $100 → $135, auto-reverting 2026-08-01).** Decided by Matthew in session, explicitly scoped to one month. Live state at the time: **$63.26 mtd, $96.09 projected against the $85 base (113%)**, guard parked at **tier 2** — reader narratives (coach commentary, State of Matthew, chronicle) paused with 9 days left in the month.

**Why $115 and not the $110 first proposed.** The tier bands are fixed *fractions* of the ceiling, not dollar amounts, so the raise has to clear a ratio rather than a number. At $110 the live projection sits at **87.4%** — above the 86.7% tier-2 line, i.e. **still tier 2**. $110 would have paid the full honesty cost of raising the ceiling and bought nothing; it missed by $0.87. $115 puts the projection at **83.6%** → tier 1, with ~$5 of headroom as the projection drifts. Verified against the live numbers: `_decide_tier(projected=96.09, mtd=63.26, elapsed_days=21.0, ceiling=115.0) == 1`.

**Why the surge value moves too.** `_effective_ceiling` returned `SURGE_CEILING_USD` *unconditionally* when surge engaged. With a base above $100 that inverts the entire mechanism — reader arrival would have *lowered* the ceiling from $115 to $100 and tightened the guard at exactly the moment surge exists to loosen it, the same success-punishes-you failure this ADR was written to prevent. Surge moves to **$135** (preserving the ~1.18 ratio), and `_effective_ceiling` now floors surge at the base with `max()` so the inversion is structurally impossible rather than merely avoided by keeping two constants in sync. Regression-pinned by `test_surge_never_lowers_the_ceiling`, which feeds a deliberately incoherent pair. This defect was **latent at any base over $100** and predates this amendment.

**Mechanism — dated window, not a manual revert.** `_TEMP_CEILING_WINDOW = (date(2026,7,1), date(2026,8,1))` (half-open) resolved by `_active_ceilings()`, mirroring the `_active_thresholds()` seam. August 1 reverts to $85/$100 with **no deploy, no SSM flip, and nobody having to remember** — the property the June-2026 threshold override (#169) established and which is tested explicitly across six dates including 2027-07-15 (it must not recur annually). An explicit `MONTHLY_CEILING_USD` in the environment defeats the window entirely, so an operator override during July does something rather than silently nothing. The now-dead `_JUNE_2026_THRESHOLDS` was removed in the same change: its window closed 2026-07-01 and it could never fire again; stacking a second dated one-off on top of dead code is how this file rots. Note the lever changed — temporary headroom is now a raised **ceiling** rather than shifted **thresholds**, which is the better knob since the bands derive from the ceiling as fractions (one number moves the ladder coherently instead of three hand-computed ones).

**Honest notes.** (1) The AWS Budgets backstop in `core_stack.py` is **not** raised — it stays at $85 and will alert during the window. That is deliberate: the backstop is the lagged independent check, and leaving it at the durable number means the month's overrun still generates a signal rather than being silenced by the same decision that permitted it. (2) This does not retire the ADR-133 2026-07-19 finding that tier-1 residence is structural in dev-heavy months; it buys nine days of tier-1 headroom, it does not change the arithmetic that produces tier-1. (3) The ceiling was raised to match a projection, which is the direction of causation this ADR's own framing warns about — accepted here as an explicitly time-boxed exception, which is why the window is dated in code rather than left as a constant someone has to walk back.
...
**Amendment (2026-08-09, #2381 — August-2026 ONLY: base $85 → $115, surge $100 → $135, auto-reverting 2026-09-01).** Decided by Matthew ahead of the session, implemented in week 2 **on purpose** — #2381's whole point was that July's amendment happened as a mid-month scramble at the cutoff, and the August decision should not. Live state at decision time (the 2026-08-09 governor read): **$32.51 mtd, $121.79 projected against the $85 base**, ~$3.9/day actual run-rate. With the projection pinned above the tier-3 band, `_decide_tier`'s actual+1 cap made ACTUAL mtd the binding constraint: tier 2 (reader narratives paused — and, new this month, the ADR-151 Telegram coach chat with them) was on track for mid-August. Same numbers as July deliberately ($115/$135 — the bands are fractions, one number moves the ladder; the $115-not-$110 arithmetic is in the 2026-07-21 amendment above and was not re-derived). The AWS Budgets backstop again deliberately stays at **$85** — the lagged independent check keeps signalling. Honest note carried forward: at $115 the projection still sits above the tier-3 band, so the raise **delays** the tier-2 crossing rather than abolishing it; that residual is exactly what the new crossing-date line exists to surface.

**Mechanism addition (#2381 acceptance): the crossing-date forecast.** The governor now publishes `tier_crossings` in the budget-breakdown payload — the projected date each tier band comes into force this month, derived with the same actual+1-cap arithmetic the verifier used (`_tier_crossing_forecast`) — and `budget_guard.format_headroom_line` renders the next band's date into the daily brief (` · tier 2 ~YYYY-MM-DD at this burn`). The next posture decision's date is visible ~two weeks out, which is the structural fix for the scramble class, independent of any window.
...
**Amendment (2026-08-28, #2801 — the September base re-derived: $150 → $215, surge $176 → $252; permanent, not a dated window).** Taken autonomously under a standing merge+deploy grant, four days before the August window's auto-revert. It **corrects the framing** the preceding amendment's own residual predicted: $150 was derived on 2026-08-18 from a six-day window (`$4.12/day, n=6`) that has since been measured as unrepresentative of the month it was meant to price.

**The premise this amendment had to falsify first.** The circulating claim — carried in the #2801 epic, in Session H's owner batch, and in this session's own plan — was that *"doing nothing selects tier 3 on 09-01."* **That is false, and the error is structural, not arithmetic.** It priced September against August's *month-end* projection ($176.34), a terminal value for a month that is 90% elapsed. `_project_month_end` is month-scoped: on 09-01 `mtd` resets to ~0 and the projection rebuilds as `mtd + trailing_rate × days_remaining`, so the September projection *starts* near $84 and climbs. `_decide_tier` additionally caps the tier at `actual_mtd_tier + 1` (and at `actual_mtd_tier` flat inside `EARLY_MONTH_DAYS`), so early September cannot be tier 3 at any ceiling. Simulated day-by-day through the real `_decide_tier`, the $150 default reaches **tier 1 on Sep 8, tier 2 on Sep 18, tier 3 on Sep 21** — a three-week runway, not a day-one cliff. The cliff is real; its date was wrong by twenty days, and every prior statement of it in this repo has been corrected in place.

**Measured steady state, explicitly not a projection.** Cost Explorer unblended daily total, 2026-08-01 → 08-25: **$5.74/day, sd $4.32, n=25 → ~$172/month, 95% CI $121–223**. 08-26 and 08-27 are excluded as **incomplete, not as outliers** — CE's Bedrock line lags 24–48h, and treating a lagging partial as a low day is the error that produced the $4.12 figure. Trailing-10d is $4.91/day (~$147/mo). Bedrock is **61.8%** of measured spend ($88.61 of $143.45). Month actuals: **May $48.19 · Jun $79.80 · Jul $98.35 · Aug ~$165** — roughly +$30/month, sustained across four months. That trend, not any single month, is what retires the "August was exceptional" reading for good.

**Why $215 and not more or less.** Produced by executing `_decide_tier` over a simulated September at three burn rates — the governor's own live rate (pessimistic), the CE trailing-10d rate, and the CE full-August rate — not by arithmetic on a band table:

| base | governor-live 6.21/day | CE trailing-10d 4.91/day | CE full-Aug 5.74/day |
|---|---|---|---|
| **$150** (the current default) | t1 Sep 8 · **t2 Sep 18** · **t3 Sep 21** | t1 Sep 17 · t2 Sep 24 · **t3 Sep 30** | t1 Sep 11 · **t2 Sep 20** · **t3 Sep 23** |
| $195 | t1 Sep 18 · **t2 Sep 25** | t1 Sep 29 | t1 Sep 21 · **t2 Sep 30** |
| $205 | t1 Sep 20 · **t2 Sep 28** | never | t1 Sep 24 |
| **$215** | **t1 Sep 22 · t2 never** | **never** | **t1 Sep 26 · t2 never** |
| $240 | t1 Sep 27 | never | never |

**$215 is the lowest base that never reaches tier 2 — reader narratives paused — in ANY of the three scenarios**, while still engaging the tier-1 ladder in two of them. That is the criterion, and it is chosen deliberately over "the base that buys tier 0": the 2026-07-19 amendment already ruled that **tier-1 is the accepted posture in dev-heavy months**, and rejected spending the early-warning margin to make tier 0 the cosmetic norm. $240 would do exactly that. $205 — the number this session's plan proposed, and a superset of the "$190–200" in the epic — lands **tier 2 on Sep 28** at the pessimistic rate, so it buys "not tier 3" rather than the posture the ADR accepts.

**Honest note on the uncertainty.** The 95% CI on the measured rate is **$121–223/month**, wide enough to contain both "this base is generous" and "this base is tight" — n=25 with sd $4.32 driven by three genuine spike days ($16.13, $20.57, $11.15). It is priced against the pessimistic end on purpose. The residual risk is *not* an overrun: it is that at the optimistic rate the ladder never engages all month, and a guard that never moves teaches nobody anything. If September closes with the tier never leaving 0, the correct response is to re-derive **downward** at n≈55, not to leave the headroom banked.

**Re-banding stays rejected, and the window is not extended.** `_TIER_THRESHOLDS` is untouched — the 2026-07-19 amendment's rejection stands verbatim. `_TEMP_CEILING_WINDOW` is **not** extended a fourth time; the 2026-08-16 amendment pre-labelled that "a third mid-month scramble," and a permanent base re-derivation is what it asked for instead. One consequence worth stating plainly: **because $215 exceeds the window's own $200, the 09-01 auto-revert is now a RAISE, not a cut.** The window becomes inert on its own date, as designed.

**Surge moves with the base — it has to.** $176 → **$252**, preserving the ~1.173 ratio every prior amendment used (85→100, 115→135, 150→176, 200→235). `_effective_ceiling` returns the surge ceiling unconditionally and floors it at the base with `max()`, so a surge below the base is structurally impossible; keeping the pair coherent means that floor never has to fire.

**Ruling on the AWS Budgets backstop: it moves to $215.** The 2026-08-18 amendment established the rule — a *permanent* base above the backstop pages every month by construction, which is an alarm that means nothing — and measured September spend at the current rate (~$186) would breach a $150 backstop outright. **The mechanism is the trap worth naming:** since #2898 the amount is `BUDGET_AMOUNT_USD`, resolved at CDK **synth** time by parsing `cost_governor_lambda.py`, so there is no literal to edit and **the diff for this change contains zero CDK edits** — yet `cdk deploy LifePlatformCore` is mandatory or the backstop silently keeps the old number. `budget_name="life-platform-monthly-75"` stays historical and is deliberately NOT renamed (it is the CfnBudget replacement key).

**What the preceding amendment's residual bought.** It named the five hand-maintained sites as a charter violation; #2898/#2899 then made the allowed set *derive* from the governor. The payoff is measurable here: `core_stack.py`, `scripts/budget_ceilings.py`, `check_doc_facts.py` and `site_api_budget.py` needed **no edit at all** — the sweep collapsed to two constants plus prose. The prose tail is still ~29 sites and is the honest remaining cost.

**A defect found in the same file, worth recording because it is the class this session kept hitting.** The governor's own module docstring contradicted its own constants in seven places: it stated a base and a surge value that were *both* wrong, carried the **$85**-base tier table for two amendments after the base left $85, and described the dated window as "$115 → $135" — stale by two amendments — while a comment 200 lines below gave the $150 trio. `docs/COST_TRACKER.md` separately pointed readers at "`core_stack.py` `budget_limit=150`", a literal #2898 had already deleted. All were corrected by **removing the dollar figures**, not by updating them: `check_doc_facts` cannot see inside a module docstring, so any number written there is unguarded by construction and will go stale again on the next amendment. The bands are fractions; the constants and `/life-platform/budget-breakdown` are the readable truth.


**Amendment (2026-09-06, #3510 — the surge threshold is DERIVED, hysteretic, and its flip rate is itself a signal).** The original derivation above sized `SURGE_UNIQUES_THRESHOLD = 900` as "~4x the median and ~3.1x the latest reading" of a **165–288 uniques/week** baseline, and closed with "revisit the threshold as the baseline traffic grows — it is one env var." The baseline then grew 3–4x and **nothing carried that revisit**: the weekly `UniqueVisitors7d` readings for 2026-07-01→09-05 were **972, 728, 803, 892, 973, 773, 838, 1011** (mean 873.75, sample SD 104.4), so 900 sat essentially at the MEAN of the series it was supposed to be far above. A bar at the mean of a noisy series flips on the noise: SSM `/life-platform/surge-active` recorded **five edges in seven weeks** (07-13 true, 07-20 false, 08-10 true, 08-17 false, 08-31 true), each an owner email and each a 17% swing in the effective ceiling ($215→$252) and therefore in all three tier bands (tier-1 trip $157.67→$184.80) — on the strength of a 13% weekly bump, not the single-viral-link step this ADR defined surge for.

**The rule now.** The engage bar is computed on **every governor run** from the trailing `SURGE_BASELINE_WEEKS = 8` weekly readings: `threshold = max(900, ceil(mean + SURGE_SIGMA_K·SD))`, sample SD, with the 900 kept as a **floor** so a collapse in traffic can never make surge mode cheap to enter. `SURGE_SIGMA_K = 3` puts today's bar at **1188** — above every reading the platform has ever recorded (max 1011) and still an order of magnitude below a viral step. Under `SURGE_BASELINE_MIN_READINGS = 4` readings there is no SD to measure, so the floor stands and the rule string says so rather than deriving a number from two points. Engagement is **hysteretic**: engage at ≥T, and once engaged hold until traffic falls below `SURGE_DISENGAGE_RATIO = 0.8`·T, so a series sitting on the bar cannot mint an unbounded run of edges. The threshold, its derivation string and the trailing-30d flip count all ship in the budget-breakdown payload and the governor's own log line, so the number is readable rather than inferred; `/api/receipts` `surge_threshold_uniques` now serves the **effective** bar, not the floor constant.

**The revisit clause's carrier.** `tests/test_cost_governor.py::test_derived_threshold_exceeds_every_documented_baseline_reading` asserts the derived bar is strictly above the maximum of the real recorded series listed in this amendment. That test — not a sentence — is what makes the clause survive the next 4x. The old `288 uniques = "the real recent baseline"` fixture is retired in the same change: it pinned a number two orders of traffic ago as ground truth.

**Two flips in 30 days is itself the alarm.** The governor emits `LifePlatform/Budget::SurgeFlip` (one datapoint per edge) and `SurgeFlips30d` (a gauge on every run), and on any edge where the trailing-30d count reaches `SURGE_FLIPS_30D_ALARM = 2` it publishes a distinct **"Surge mode flapping"** notice on the existing alerts topic, quoting the derived bar and its derivation. `scripts/monthly_close.py` prints the month's flip count beside the days-at-tier≥1 line (reading the bar from the governor source by AST, so the close cannot hold a second opinion). **No CDK, no IAM and no new alarm resource:** `cloudwatch:PutMetricData`/`GetMetricStatistics` and the alerts topic were already granted, which is why this costs $0 rather than a metric-alarm's $0.10/mo.

**Correction (2026-09-14, #3661) — what this paragraph said, and what actually happened.** The original "Honest note on the first run after deploy" predicted the opposite of what the code does, and it is corrected here rather than deleted because the error is the interesting part: it was prose reasoning, not a derived literal, so **no doc gate could catch it**, and for eight days the ADR promised $215 while live served $252. It read: *"1011 < 0.8·1188 = 950.4 is false — so hysteresis does not hold it: the first enforcement run after the deploy disengages surge."* The arithmetic is inverted. `SURGE_DISENGAGE_RATIO` is a **hold**, not an exit test — `cost_governor_surge.engaged` returns `recent_uniques >= SURGE_DISENGAGE_RATIO * bar` while engaged — and `1011 >= 950.4` is **true**, so hysteresis held surge ENGAGED. Measured: the runs at 2026-09-07 00:00/08:00/16:00Z all logged `surge_active=True effective_ceiling=$252 surge_threshold=1188`. No `SurgeFlip`, no disengage, no flapping notice.

**The hold rule, as implemented.** Machine-checked by `tests/test_surge_bar_attribution_3661.py` — the worked lines below are parsed out of this ADR and executed through `cost_governor_surge.decide`, so this paragraph cannot go stale in the direction the one above it did:

```
engage from OFF:   recent_uniques >= T
hold while ON:     recent_uniques >= 0.8 * T      (a HOLD, never a second, lower entry)
bar moved:         engaged_at_bar != T  ->  re-decide as if OFF        (#3661)
worked: u=1011 T=1188 engaged_at_bar=900  -> surge OFF ceiling $215
worked: u=1011 T=1188 engaged_at_bar=1188 -> surge ON  ceiling $252
worked: u=1218 T=1383 engaged_at_bar=900  -> surge OFF ceiling $215
worked: u=1218 T=1383 engaged_at_bar=1383 -> surge ON  ceiling $252
worked: u=1400 T=1383 engaged_at_bar=900  -> surge ON  ceiling $252
worked: u=905  T=1355 engaged_at_bar=1355 -> surge OFF ceiling $215
```

**Amendment (2026-09-14, #3661 — an engaged surge names the bar that minted it, and is re-decided when that bar moves).** The wrong note above was covering for a real defect. The surge in force through early September was engaged **2026-09-01T00:00:13Z (2026-08-31 17:00 PT) under the then-constant 900 bar** — SSM `/life-platform/surge-active` version 5, and was then held open by bands derived from bars that did not exist when it was minted: 0.8·1188 = 950.4, and from 09-08 onward 0.8·1383 = 1106.4. Twenty-four consecutive enforcement runs — every one the governor made between 2026-09-07T00:00:14Z and 2026-09-14T16:00:17Z — sat in `0.8·T <= u < T` — every one of them an effective ceiling of **$252 against the $215 base, +17%, and the same +17% on all three tier bands** (the tier-1 trip moves $157.67 → $184.80). It ended only when traffic fell far enough for the *newest* band to release it: 2026-09-15 00:00:15Z, `recent_uniques=905 surge_active=False effective_ceiling=$215`. Nothing in the log, the receipt or the SSM state distinguished that from a surge the reading had actually earned.

**The rule.** `/life-platform/surge-active` now carries the bar that minted the state — `true@1188` — and `cost_governor_surge.decide` re-decides **from OFF** whenever the bar in force is not that bar. Hysteresis keeps doing what it is for, suppressing oscillation around a *stable* bar, and stops carrying a state across a threshold the reading would never have crossed. **An unrecorded minting bar counts as a different bar** (`SURGE_UNATTRIBUTED_IS_CROSS_BAR`): "held by hysteresis" is a claim about which bar engaged the state, an unattributable state cannot support that claim, and the tightening direction is the same fail-closed posture `_effective_ceiling` already has. That makes the deploy migration a one-time re-decision of whatever is in SSM, not an inheritance — and because surge is currently OFF, it is inert on arrival. The engaging bar rides the governor log line and `/api/receipts` as `surge_held_by` / `surge_engaged_at_bar` (`bar (1218 >= 1188, engaged_at_bar=1188)` vs `hysteresis (band 950.4, bar 1188, engaged_at_bar=1188)`), so a 17% ceiling difference is never invisible to whoever reads the receipt.

**Cost of the fix, and what it deliberately is not.** Zero new AWS resources, zero new IAM, zero new schedules, no CDK deploy: the minting bar is a suffix on a parameter the governor already writes on every edge and reads in exactly one place (`_read_surge_state`) — every other consumer reads `surge_active` out of the budget-breakdown payload, so the encoding is private to the governor. It does **not** re-band, re-derive `SURGE_SIGMA_K`, or touch the ceiling pair. Rent: one extra field in one string, one `decide()` call, one parsed doc block in CI. **Demote trigger:** if a year passes in which `surge_held_by` is never `hysteresis` — i.e. the derived bar is far enough above the baseline that the band never holds anything — the band and its attribution are both decoration; drop the hysteresis and keep the bare bar. The measured counter-case is the 23 runs above, so the trigger is falsifiable from the governor's own log.
...
**Context.** The 2026-07 math audit drove the real engine through 420-day simulations and found the model honest at the gate level (post-#954/#957) but miscalibrated at the economy level: XP broke even only at raw 80, so every realistic-good trajectory bled visible debt while levels climbed (slow improver: 0 XP / 700 debt at L57; oscillator: a Mastery character wearing a maxed debt badge); the uninstrumented relationships pillar fed its 50.0 placeholder into the XP bands and accrued a permanent phantom −100; a 30-day silent month cost the headline only ~2 levels (the cycle-4 failure mode); Elite was structurally unreachable (the never-instrumented pillar capped the weighted mean at 93); two post-engine mutations (food-delivery modifier, challenge XP) bypassed every honesty gate; four engine inputs had no producer; and cross-pillar conditions read EMA scores while the config narrative called them tier achievements.

**Decisions (one per audit mechanic, all validated by re-running the sim):**

1. **XP zero-point at "a decent day" (#958).** `daily_xp_decay` 2 → 1: raw 40–59 nets 0, 60+ nets positive, sub-20 still bleeds. Debt becomes a dark-stretch signal that realistic living visibly repays (slow improver now ends 1027 XP / 0 debt; the 30-day-dark character's debt clears during recovery).
2. **XP mirrors the level gate (#964).** `coverage_hold` / `not_instrumented` days carry no XP judgment in either direction — the phantom relationships −100 is gone; a completed challenge still credits on a hold day, debt-first.
3. **Modifiers and challenge XP are engine inputs (#961).** The food-delivery multiplier applies inside the engine before EMA/XP/gates with provenance (`raw_modifier` on the pillar record); challenge XP flows through the signed balance (debt pays first); `xp_consumed_at` marks only after the record stores. The stored raw_score is now always the number the engine leveled on.
4. **A confirmed dark stretch hits the headline (#959).** During `presence_class=dark` past grace (never a planned pause), atrophy-qualifying pillars keep their down-streak armed across drops and the XP demotion buffer gives no shield — anti-flip-flop machinery protects against noisy engaged data, never against provable absence. Sim: the 30-day dark month now costs 12 headline levels (36→24), recovers ~28 days after resuming, and remains a 3-level scar at day 420. Config kill-switch: `leveling.neglect_decay.persistent_down_streak`.
5. **Buffer sized to its purpose (#954 follow-through).** `xp_buffer_cap: 40` — under the v2 economy an uncapped buffer pinned at 100 and silently granted 40+ days of demotion immunity; the cap bounds the engaged-decline shield to the anti-flip-flop scale (~10–20 days).
6. **Headline renormalizes over instrumented pillars (#960).** A pillar that is `not_instrumented` today AND still at level 1 (never earned a level) is excluded from the character-level weighted mean; once it levels it counts forever (going dark later drags honestly). Elite becomes reachable at ~1 year of sustained excellence (sim: day 362 at raw ~90) instead of mathematically impossible; `headline_excluded_pillars` rides the record for transparency.
7. **Dead inputs wired or removed (#962).** `vice_streaks` is lifted from the habit_scores record (the producer always existed — daily_metrics_compute writes it) and drives both the mind pillar's vice_control component and a now data-driven `any_vice_streak` condition (Vice Shield can actually fire). `streak_all_above_30th` and `weekend_weekday_ratio` are derived by `character_engine.derive_consistency_inputs()` from the same 21-day record window the EMA already fetches — the consistency pillar spans its honest range instead of a hardwired 12.5–87.5 band. `buddy_engagement` is removed (B-3 precedent: no producer has ever written `buddy_freshness_days`); relationships weights renormalized.
8. **Cross-pillar conditions stay on EMA scores — deliberately (#963).** Effects model current-state physiology synergies (poor sleep drags today's training), not tier achievements; gating on slow-converging earned levels would fire Sleep Drag on every fresh-cycle character regardless of actual sleep. The config narrative was reworded instead ("held day by day, never a rank you bank").

**Rejected alternatives.** Atrophying device-measured pillars during logging-dark stretches (rejected: wearables still streaming are honest measurement — ADR-104's "a device gap is not a failure" cuts both ways; the headline honesty is carried by the 0.61 behavioral weight share that does fall). Re-banding XP earn instead of retuning decay (equivalent outcome, more moving parts). Gating effects on earned levels (see 8).

**Consequences.** `character_engine.py` is a bundled shared module — this ships via fleet deploy. Config `character_sheet.json` v1.4.0 must be pushed to `s3://…/config/matthew/character_sheet.json` (the engine reads S3, not the bundle). XP totals grow ~5–7× faster than v1 across the board — XP is now a meaningful cumulative score, and per-pillar debt badges appear only during genuine decline. Site contract unchanged (`xp_debt`, `not_instrumented`, `challenge_bonus_xp` fields keep their shapes; `raw_modifier` is additive). The five sim scenarios are the regression harness: rerun `scripts/character_sim_year.py` after any retune.

**Amendment (2026-07-11, same session — #965 source wiring, engine v1.6.0 / config v1.5.0).** The three unwired sources get one component each, all **day-count** metrics (volume-gaming resistant — logging junk sets, marathon page counts, or trivial tasks buys nothing): **hevy → movement `strength_sessions`** (distinct workout days in the trailing 7 vs a 3-day target, weight 0.20, `behavioral: true` — matches the source registry's classing; before this a heavy lifting week read as movement absence because the pillar was Strava-only); **reading → mind `reading_practice`** (distinct ADR-097 session days in the trailing 7 vs a 4-day target via the GSI2 READING_SESSION index, weight 0.10, `behavioral: true` — sessions are manual logs); **todoist → consistency `task_follow_through`** (`100 − 12.5 × overdue_count`, weight 0.15, **measured** class — the record is an automatic daily API pull, so a missing record is an ingestion gap, and follow-through-as-overdue-pressure is the one todoist signal task-volume gaming can't inflate). Movement/mind/consistency component weights rebalanced to keep each pillar summing to 1.0 (movement: freq .15, zone2 .20, TLB .15, overload .10, diversity .10, steps .10, strength .20; mind: SoM and stress .15→.10 each; consistency: variance .35, completeness .15, streak .20, weekend .15, task .15). Timed for genesis Day 0 — no mid-cycle scoring discontinuity.

## ADR-135: Podcast no-touch contract — deterministic structure repair, convergent revision, bounded escalation (#1170/#1171/#1172, epic #1082)

**Date:** 2026-07-12 · **Status:** Accepted · **Story:** #1170/#1171/#1172 (epic #1082) · **Builds on:** ADR-087 (fail-closed audio ceiling), ADR-105 (deterministic-before-LLM), the #1122 fail-closed gate

**Context.** Prompt rules empirically cannot guarantee structural output properties. Measured 2026-07-12 (#1123): **0/15 wk0 regenerations cleared the #1122 gate** across two prompt-hardening iterations (PRs #1168/#1169 taught the intro writer the gate's own rules, including an explicit STRICT-ALTERNATION ban) — and diagnostics confirmed the dominant failure class, consecutive same-speaker turns leaving dangling threads, was written by the model itself in every run (zero gate-side turn drops). Two structural gaps compounded it: the intro path's 15 attempts were **blind re-rolls** (the weekly path's judge-feedback revision loop — the mechanism behind both live episodes — was never ported), and the two graders **disagreed on the line**: the deterministic check allowed 3 consecutive same-speaker turns (`_QA_MAX_CONSECUTIVE=3`) while the Haiku judge's rubric failed every script containing exactly that pattern, so a deterministically-"clean" draft could never converge. Matthew picked the deterministic-repair fork on #1123, generalized to a no-touch weekly contract: never ships bad AND never needs babysitting.

**Decision.** Structure is enforced deterministically, not requested politely — three layers in `lambdas/emails/panelcast_repair.py`, applied to both the intro and weekly paths:

1. **Repair-then-full-regate (#1170).** Post-generation, same-speaker adjacency seams are detected with the gate's OWN primitives (`panelcast_qa.structural_seams`, derived from the same craft/continuity checks — one detection, two consumers). Each seam gets ONE targeted repair generation (writer-tier model) that sees only the local context and restructures it into alternating turns — merge where it flows, split into an exchange where a merge would breach `_QA_MAX_WORDS_PER_TURN`. **The invariant: the repaired script goes back through the FULL unchanged gate (deterministic + Haiku judge). Repair never bypasses, weakens, or pre-clears any check; an invalid or failed repair keeps the original span for the gate to hold. The gate remains the sole fail-closed arbiter.**
2. **Convergent revision + grader agreement (#1171).** The weekly targeted-revision loop is ported to the intro/regeneration path: on judge fail, the judge's exact failure items go back to the writer (≤2 revisions per generation) instead of a blind re-roll. Calibration aligned: `_QA_MAX_CONSECUTIVE` 3 → 2, and both judge rubrics now state the SAME numeric bound via the constant itself (test-enforced: the deterministic bound must be at least as strict as what the judge is instructed to fail). Every gate pass writes a per-attempt verdict ledger (attempt, revision, deterministic verdicts, judge items, repaired seams) — logged under the stable CloudWatch prefix `[panel] qa-ledger` and carried on the hold record — so convergence is measurable across weeks.
3. **Bounded attempts + needs-human escalation (#1172).** Fixed budget: 3 generations × ≤2 revisions each (dry-run: one generation, no extra spend). Safety holds stay immediate and never consume budget or retry; quality failures consume attempts. On exhaustion the run publishes NOTHING (the existing HOLD, unchanged) **and sends ONE email** (existing sesv2 infra, `EMAIL_RECIPIENT`) — subject "Panelcast HOLD — … failed the gate after N attempts", body carrying the ledger's failure-mode summary, never raw transcripts — so the only human contact is when the system has proven it can't meet the bar: never a silent miss, never a bad publish. Budget-tier gating (`SKIP_TIER`) and the ADR-087 ceilings are untouched.

**Consequences.** The intro path converts coin-flip re-rolls into convergence with a floor: worst-case model spend per run is bounded (per-generation seam-repair cap `PANELCAST_MAX_SEAM_REPAIRS=4`), and each SS-02 hold-sweep retry now carries the full in-budget loop (still bounded by `HOLD_MAX_RETRIES`). `coach_panel_podcast_lambda.py` stays under the ADR-080 god-module gate by extracting the mechanics to `panelcast_repair.py` (the weekly revision writer moved there too). The one quality-bar concession is acknowledged: a repair splice may author a short content-free bridging line ("Go on."), the wrinkle recorded on #1123 — bounded, shape/safety-validated, and still judged by the full gate like every other line. Rejected alternatives: turn-by-turn alternating generation (makes the defect unrepresentable at the source, but a bigger pipeline rebuild that still leaves the judge's non-structural items as re-roll territory) and hold-as-is (leaves the show dependent on human babysitting — the opposite of the epic's outcome).

## ADR-136: Site auto-deploy without a human click is the chosen posture — gated by the 3-layer QA estate + auto-rollback, not a person (#750/#897/#793, #1343)

**Date:** 2026-07-18 · **Status:** Accepted · **Story:** #1343 (SDLC review 2026-07-18) · **Amends:** ADR-065 (the "no auto-deploy to prod without a click" claim), ADR-117 (the "production manual-approval gate … untouched" claim) — scopes both to the Lambda/CDK deploy path

**Context.** `.github/workflows/site-deploy.yml` (#897, landed 2026-07-08; the CI wiring extended by #750, 2026-07-09) deploys `averagejoematt.com` to production on every push to `main` that touches `site/**`, with **no `environment: production` approval gate** — the OIDC deploy role runs `deploy/deploy_site.sh` straight through. This is real: `git log` shows `a26ec849 feat(ci): site deploys through CI on merge (#897)`, and `docs/CONVENTIONS.md` §2 documents the mechanism. But it had never been through a governance record — `grep -n '#897\|#750\|#793' docs/DECISIONS.md` returned zero hits before this ADR, while two OTHER records assert the opposite as a platform-wide invariant: ADR-065 ("Production deploy stays human-approved → no auto-deploy to prod without a click") and ADR-117 ("The `production` manual-approval gate on `deploy` is untouched"). Both statements are true for the Lambda/CDK path (`ci-cd.yml`'s `Deploy` job, which does carry `environment: production`) and false as stated for the site path. A governance-consequential decision — production changes flowing to readers with no human in the loop — must not live only in a workflow file and a commit message.

**Decision.** The gate-less site path is the deliberately **chosen** posture, not an oversight, for the blast radius the static site actually carries: content and layout, not data-plane or auth. The click is replaced by a **compensating-control stack**, not removed outright:
1. **Deploy = the merge itself.** A push to `main` touching `site/**` is the approval; there is no separate click.
2. **Automated gating post-deploy, before "done."** `deploy/smoke_test_site.sh` (HTTP/content smoke — v4 pages 200, legacy 301s, API freshness) **and** the visual/AI-QA sweep (`tests/visual_qa.py` + `tests/visual_ai_qa.py`, gating since 2026-06-05) both run against the live deploy.
3. **Auto-rollback on any red.** A failed smoke test OR a failed visual/AI-QA verdict fires `rollback-site-on-failure` (ADR-117), which reverts via `deploy/rollback_site.sh HEAD~1` through the canonical `sync_site_to_s3.sh` path (re-hashes assets, re-stamps `version.json`, re-invalidates CloudFront) — so a bad deploy self-heals inside minutes, not "eventually, if someone notices."
4. **Every deploy and every rollback pages via SNS** (`life-platform-alerts`) — a revert is never invisible, and neither is a clean deploy going out.
5. **The Lambda/CDK path keeps its human click, unchanged.** `ci-cd.yml`'s `Deploy` job still requires `environment: production` manual approval for backend code and all infra. This ADR narrows ADR-065/ADR-117's blanket "no auto-deploy without a click" claims to that path — see the amendment notes on both records.

**Why this is the right trade, not a shortcut.** The failure class the click exists to prevent — a bad change reaching readers unnoticed — is covered here by detection *and* automatic reversal, which a human approval gate does not itself provide (a click only stops a bad deploy if the approver can tell it's bad, which for site content a human eyeballing a diff often can't). The 2026-07-11 mobile-overflow revert is a real true-positive catch of this exact mechanism (CONVENTIONS §2, cited in the 2026-07-18 SDLC review as "a real true-positive catch — so detect-and-revert for the site is earned, not aspirational"). The alternative (add `environment: production` to `site-deploy.yml`) would reintroduce the drift class #750 was built to kill: "merged but not deployed," where a shipped fix sits invisible behind an un-clicked approval — the platform's actual solo-operator failure mode, evidenced repeatedly in `docs/INCIDENT_LOG.md` before #750.

**What this does NOT cover.** The site's `/api/*` contracts are read-only from the front-end (CLAUDE.md) — this posture governs the static asset surface only. Site-api Lambda code/infra changes still deploy via `deploy_site_api.sh` / `cdk deploy`, both gated by the Lambda/CDK path's human click. A future write-capable site surface, or any change to the blast-radius premise (multi-tenant, PII on the static surface, payments), reopens this ADR.

**Consequences.** Every governance-consequential deploy posture the platform runs now has a written record: Lambda/CDK stays human-clicked (ADR-065/ADR-117, as amended), the site is detect-and-revert (this ADR). No code or CI changes ship with this ADR — it documents the posture #750/#897/#793 already put in production. Revisit trigger named above; until it fires, the compensating-control stack — not a click — is the signed answer.


## ADR-137: The evening intake ledger stays one-tap drinks-only — no second numeric tap (#1484, epic #1476)

**Date:** 2026-07-19 · **Status:** Accepted · **Story:** #1484 (chat-journey review 2026-07-18)

**Context.** #1484 unifies the fragmented evening into one conversation (journal interview → Notion write → intake tap → at most one coach check-in question). Its third work item asks whether the private intake ledger (`private_intake`, #1405) should extend beyond the drinks count — the concrete candidate being a 1–5 evening-energy tap — decided via ADR rather than drifting in by accretion.

**Decision.** **No extension.** The ledger stays exactly one tap: `intake_count` 0–4, keyed by the Pacific evening. No evening-energy metric, no second numeric field, no free text.

**Why.**
1. **Evening subjective state is already instrumented — twice.** `mood_valence` lands in the `evening_ritual` partition via the nudge email's signed links, and HAE State of Mind arrives near-real-time via webhook. A 1–5 "energy" tap would be a third overlapping subjective scalar with no analysis engine waiting for it, violating the ADR-103 posture (no machinery without a named consumer) — where `intake_count` exists precisely because the dose-response engine (#1405) consumes it.
2. **Objective energy is measured next morning anyway.** The dose-response ledger grades evenings against next-morning Whoop HRV/recovery/REM — the thing an evening-energy tap would poorly self-report.
3. **The channel hasn't earned widening.** At decision time the ledger has ~0 logged evenings and the dose-response engine is still arming (floor: 15 nonzero evenings). Widening a capture surface that hasn't yet demonstrated capture is scope creep into a second journal — the exact failure #1484 exists to prevent. Friction math: the one-tap close survives *because* it is one tap.
4. **Qualitative evening texture belongs to the journal.** The Notion evening entry (sole journal SOT, dual-SOT rejected) already captures "how did today actually go" in prose; a numeric sibling would fragment that story across surfaces again.

**Revisit trigger.** Reopen only when BOTH hold: the dose-response engine has armed (≥15 nonzero evenings — the channel demonstrably works), AND a named consumer exists for the new metric (an analysis engine or coach input, not "nice to have"). Until then, additions to the evening close route through existing surfaces per the CHAT_MODES route-the-takeaways contract.

**Consequences.** `log_evening_intake` gains only bridging hardening under #1484 (Pacific date keying to match the signed-link write path; observable idempotency via `previous_count`), never new fields. The unified evening flow (`.claude/skills/journal-interview/SKILL.md`, evening variant) bridges the existing surfaces — it does not create new ones.


---

## ADR-138: Release topology — prod-only, single-account/single-region, detect-and-revert (#1338)

**Date:** 2026-07-20 · **Status:** Accepted · **Story:** #1338 (SDLC review 2026-07-18)

**Context.** The platform deploys straight to production: one AWS account (205930651321), one region (us-west-2), no staging environment, no blue-green. The 2026-07-18 SDLC review's commercial lens confirmed the posture is real and deliberately compensated — but nowhere written as chosen (`grep -rn 'staging|prod-only' docs/*.md` found zero posture hits, while ADR-057 writes the analogous multi-user deferral properly). The panel refuted "no staging" as a defect but confirmed it as an undocumented accident. This ADR is the writing.

**Decision.** **Prod-only stays, signed.** No staging environment, no second account/region. The substitute for promote-through-stages is a **detect-and-revert estate**, and that estate — not a staging mirror — is the named compensating control.

**The compensating controls (each live and verifiable, not aspirational):**
1. **The 3-layer QA estate (ADR-076):** HTTP/content smoke (`deploy/smoke_test_site.sh`), nightly data/output health (`qa_smoke_lambda`), and the Playwright + AI-vision browser sweep (`tests/visual_qa.py`) — the visual-QA job **gating** in CI since 2026-06-05.
2. **Auto-rollback on both deploy paths:** ci-cd's smoke-fail rollback and site-deploy's `rollback_site.sh` (ADR-136 signed the site path's human-free variant).
3. **The production approval gate** (GitHub Environment `production`, required reviewer) on the engine path — posture-tracked in `deploy/github_posture.json` since the #1319 silent-drop incident.
4. **The deploy-critical lane (ADR-117):** the fast offline `deploy_critical` subset gates deploy independently of the exhaustive suite.
5. **Build fingerprints:** `/version.json` == git HEAD and Lambda CodeSha256 checks make every deploy verifiable at origin.
6. **The behavioral integration harness** (`deploy/restart_integration_check.py`, #1559): four-leg platform probe + synthetic ingest round-trip, run at resets and on demand.

**Why not a staging environment.**
- **Rent (ADR-103):** a staging copy of a ~94-Lambda single-table platform is a second estate a solo operator must keep truthful; stage-prod drift would itself become the top defect source.
- **Fidelity:** the defect classes that actually bite here (live-data honesty, provider-side OAuth, CloudFront viewer-path caching, reader-visible rendering) reproduce only against production data and edges; a synthetic-data staging would run green through all of them.
- **Blast radius is bounded** by read-only serving contracts, S3 delete-protection on `raw/*`, DDB PITR, and the reversible deploy paths above.

**Revisit trigger (mirrors ADR-057).** Reopen when any of: real multi-user traffic (a second N=1 with their own partition), a paid SLA to readers, or a compliance regime requiring pre-prod signoff. The first step then is a staging *account* (org-level separation), not a staging stack inside the prod account.

**Consequences.** `/sdlc-review` Phase 3 carries a standing deviation-register line: enumerate textbook deviations, assert each has an ADR or DR-doc row — a deviation without a writing is a finding by definition. This ADR is the register's first entry; ADR-139 is the second.

---

## ADR-139: Testing topology — post-merge full suite blessed, advisory pre-merge lane in git (#1344)

**Date:** 2026-07-20 · **Status:** Accepted · **Story:** #1344 (SDLC review 2026-07-18)

**Context.** The exhaustive suite (6,200+ tests), full lint, mypy, and coverage floor run **post-merge** (ci-cd triggers on push to main); no required status checks exist on PRs. Implementers are agents with a documented ~50% false-positive rate on "tests pass" claims, and reds have landed directly on main (the #1297 collection-error class; Unit-Test reds 2026-07-17/18). The review asked: bless it or fix it.

**Decision.** A three-part posture:
1. **The post-merge full suite stays** as the exhaustive verdict — it is the only place the full test + visual-QA estate can afford to run every time, and ADR-117 already decoupled deploy-gating from it.
2. **A minimal pre-merge lane lands IN GIT** (`.github/workflows/pr-checks.yml`, `pull_request` trigger): `pytest --collect-only` (kills the collection-error class at the door) + the `deploy_critical` marker subset + `black --check`. ~1 minute, advisory by default.
3. **Required-ness is an owner toggle, not a default** — the #1319 incident proved GitHub protections silently drop on repo-visibility flips, so correctness must not depend on a setting that evaporates. The *lane* (in git) is the durable control; making it a required status check is an explicit owner action recorded in `deploy/github_posture.json` in the same PR (the sentinel GET-verifies weekly; the `main_ruleset` entry currently pins "no required_status_checks rule"). Until that toggle, the merge ritual's compensating control stands: **full local suite, no `-x`, before every merge** — the discipline that carried 13 merges through the 2026-07-19 CI-dead window.

**Reconcile-bot compatibility.** The reconcile job pushes directly to main; PR status checks never gate direct pushes, so the lane is structurally compatible with it regardless of the toggle.

**Regression guards.** (a) `tests/test_premerge_lane.py` pins the workflow's existence, `pull_request` trigger, and all three checks — the lane cannot silently vanish; (b) the posture file + `drift_sentinel.check_github_config()` assert the live required-checks config matches the declared posture.

**Revisit trigger.** Flip the lane to required (owner toggle + posture-file flip, same PR) when either: a red lands on main that the advisory lane had flagged on its PR, or merge volume moves beyond the babysat-session pattern (unattended agent merges).

**Consequences.** `ci-cd.yml` is untouched. PR authors see the lane's verdict and can merge past it until the toggle. The wrap ritual's ci-cd-conclusions check now includes pr-checks conclusions on the day's PRs.

### ADR-139 Amendment (2026-08-03, #1662 — the revisit trigger fired; the lane is now REQUIRED)

The toggle above is taken. `pr-checks.yml`'s `fast-lane` job (context `Collect + deploy-critical + format`) and `secret-scan.yml`'s `gitleaks` job are required status checks on `main` via the `main-required-fast-lane` ruleset, with auto-merge on. **Everything else in this ADR stands unchanged**: the full suite is still post-merge and still non-gating for deploy (ADR-117), the lane still lives in git as the durable artifact, and the posture file is still the declared truth the sentinel GET-verifies. What changed is only that "can merge past it" is no longer true for those two checks. Scoping rationale, the checks deliberately left advisory, and the failure mode a required check introduces: **ADR-148**.

---

## ADR-140: The anti-auto-posting stance, amended — content syndication is sanctioned under five normative rules; milestone posting stays denied permanently (#1630)

**Date:** 2026-07-25 · **Status:** Accepted · **Story:** #1630 (epic #1619, three-board convening 2026-07-21 — `docs/BOARDS.md`, label `review:social-boards-2026-07-21`)

**The prior stance this record amends.** The repo's written anti-auto-posting position lives in `lambdas/content/chronicle_share_kit.py` (the #405 share kit): *"One channel only, no auto-posting — the human step stays optional by design."* Two properties of that stance matter here. First, its **stated rationale is ergonomic, not ethical** — the surrounding docstring frames posting as a 60-second paste "rather than a recurring content chore"; the stance was protecting the owner from a content treadmill, not drawing a safety boundary. Second, the module already carries `CHANNEL = "x"` as data with a comment noting a channel switch is one line — the code was built to move even while the docstring said it never would. Leaving that sentence in place next to a sanctioned poster would mean a future reader trusts neither the docstring nor the poster; hence this written amendment rather than a quiet deletion.

**Why the ergonomic rationale no longer binds.** The 2026-07-21 three-board convening (Product / Personal / Technical) separated the two concerns the old one-liner had fused:

- The **ergonomic** concern (no recurring content chore) is dissolved, not overridden, by projection-only syndication: the poster announces an artifact that is *already published* on averagejoematt.com — title, standfirst, link — so no new authorship, judgment, or daily human beat is created. The chore the stance guarded against structurally cannot occur.
- The **ethical** concern the old stance only implied — a bot making public claims on the owner's behalf — was examined on its own and split: automated **content** announcement was **approved, gated and phased**; automated **milestone / achievement / weigh-in posting was DENIED on the merits** (not deferred, not descoped — the board found automated public victory-claims a documented harm pattern for this user, and the fraud-surface of a bot asserting an achievement the instrument cannot durably prove unacceptable on a public credibility moat). This ADR records that verdict as permanent.

**Decision — the five normative rules.** Any automated posting surface (the #1629 Bluesky poster and any successor) is governed by ALL of the following. These are requirements, not guidance; each MUST be enforced in code and asserted by test in the PR that ships a poster.

1. **Projection only, never generation.** The poster MUST only project an existing public artifact — the title, standfirst, and canonical link of a piece already published on averagejoematt.com. It MUST NOT compose new claims, numbers, or narrative, and the posting path MUST contain zero LLM calls (no `bedrock_client.invoke()` reachable — ADR-108's measured 10.2% quality-gate failure rate is a managed risk on a correctable email and an unacceptable one on an irreversible public post).
2. **Approval moved upstream, not absent.** Every syndicated artifact MUST already have passed the human approval step of its own publish pipeline (chronicle approve, podcast publish, essay/build-beat merge). The human click is relocated to the publish step — it did not disappear. An artifact that reached the public site without a human approval step MUST NOT be syndicable.
3. **Kill switch — SSM, phone-operable.** Posting MUST be gated on SSM `/life-platform/syndication-mode` (`off | shadow | live`), checked per invocation, operable from a phone with no laptop and no deploy. `off` halts all posting immediately.
4. **Rate cap and spend cap.** A hard per-day post cap MUST be enforced in code (not convention), and any channel with per-post third-party cost (X API tiers) MUST NOT be built until the ADR-063 budget amendment covering third-party per-post spend is signed. Bedrock spend in the posting path is zero by rule 1.
5. **Inherited category exclusions — permanent.** Milestones, achievements, weigh-ins, and anything body-composition-related are excluded from automated posting **permanently**, by the 2026-07-21 board verdict this ADR records. The poster MUST be structurally incapable of selecting them (candidate derivation cannot reach those artifact classes), not merely configured not to. Reversing this exclusion requires a new three-board convening, not an ADR edit.

**What survives of the old stance.** Manual-first remains the default posture: the share kit stays manual, `scripts/post_social.py` (Phase 0, #1622) is the gate on ever building the poster (≥15 of 30 days of real use), and the #1629 poster itself must clear a 14-consecutive-shadow-day / ≥90%-approved-unmodified bar before going live. The human step stays real at every stage — what changed is *where* it sits, per rule 2.

**Complexity posture (the ADR-103 row, recorded here and in the ledger).** The syndication poster is **Portfolio**, never load-bearing. Dated retire trigger: **90 days live with no measured referral traffic** (UTM-attributed sessions / confirmed subscribers per #1621's instrumentation) → the syndication lambda is deleted and the manual script stands. Precedent: the remediation agent — exemplary safety engineering demoted to `shadow` after zero merged output (ADR-129). Automate a proven habit; never a hoped-for one.

**Operational preconditions (written before the first post, per the R22/#893 precedent).** Both runbooks exist as of this ADR, before any poster is built:
- **Token rotation (routine + leaked):** `docs/RUNBOOK_SYNDICATION.md` §Runbook 1, with the `life-platform/bluesky` row added to `docs/SECRETS_ROTATION.md`.
- **Post recall ("delete a bad post and rotate a leaked token"):** `docs/RUNBOOK_SYNDICATION.md` §Runbook 2.

**Consequences.** `lambdas/content/chronicle_share_kit.py`'s docstring now points here instead of asserting the blanket stance; a tombstone rule (`docs/_lint/tombstones.txt`) keeps the retired blanket claim from reappearing as current truth in any live doc. The #1629 poster, when its Phase 0 gate is met, cites this ADR instead of re-litigating the posture; if the gate is not met, #1629 closes unbuilt and this ADR still stands as the governance record. No public milestone bot exists, and none can be built under rule 5 without a new convening.

---

## ADR-141: Conversational self-calibration — check-in answers move the same CONFIDENCE#/LEARNING# machinery as data, bounded and provenance-tagged (#1481)

**Date:** 2026-07-25 · **Status:** Accepted · **Story:** #1481 (epic #1476, chat-journey review 2026-07-18)

**Context.** The coach check-in loop (#915) captures Matthew's verbatim answers, but nothing closed the calibration loop: a coach could learn something decisive in conversation and its Bayesian `CONFIDENCE#{subdomain}` state (Beta(α, β), written only by `coach-prediction-evaluator`) never moved, and no `LEARNING#` trail recorded the qualitative takeaway. Qualitative conversation was context, never calibration — so the coach's self-assessment ("how well do I understand this pillar?") could only ever be moved by graded predictions.

**Decision.** A deterministic conversational write path (`lambdas/coach/coach_calibration.py`, MCP tool `log_coach_calibration` in `mcp/tools_coach_checkin.py`) lets the ASKING coach re-grade its per-subdomain confidence from an ANSWERED check-in and record what it learned. It reuses — never forks — the existing machinery: the same `CONFIDENCE#{subdomain}` Beta rows and the same `LEARNING#{date}#{slug}` audit trail the evaluator writes. Rules, each enforced in code and pinned by test:

1. **Grounding (ADR-104).** Every conversation learning is attributable BY ID (`checkin_id`) to the `CHECKIN#` answer it derives from and stores a VERBATIM `answer_quote` of that answer. A caller-supplied excerpt must actually appear in the stored answer (whitespace/case-insensitive substring check) or the write is refused. **No LLM anywhere in the write path** — the model conversing in chat supplies the takeaway, but nothing it invents can enter the trail unquoted or unattributed.
2. **Bounds — one chat never outweighs one graded prediction.** The confidence move is a fractional pseudo-observation on the SAME Beta distribution the data path increments: weight clamped to [0.1, 1.0] (default 0.5), where 1.0 equals exactly one data-derived outcome. At most 2 subdomains per answer; exactly one write per (answer, subdomain) — the learning SK is deterministic (`LEARNING#{date}#conv-{checkin_uid}-{subdomain}`) and the put is conditional, so replays are idempotent, never double-counted. A skip is a boundary, never evidence: only `status=answered` check-ins qualify.
3. **Provenance — data vs conversation is explicit everywhere.** `CONFIDENCE#` rows record `source` (`data`|`conversation`) for the last update plus running `conversation_alpha`/`conversation_beta` accumulators (the evaluator's full-item put carries them forward); conversation `LEARNING#` rows are tagged `channel=conversation` with `status=insight` — a status deliberately OUTSIDE the confirmed/refuted vocabulary, so every hit-rate surface (site `_track_record`, MCP `get_coach_track_record`, observatory 30-day panel) stays data-derived by construction. Consumers distinguish, not blend: the stance/compression grounding renders conversation learnings in their own labeled block (`coach_history_summarizer`), `get_coach_track_record` reports `by_channel` + a separate `conversation_learnings` list, and the observatory card carries `confidence_provenance`. The ADR-108 quality gate consumes conversation learnings transitively (its inputs are coach outputs generated from the compressed state this feeds) — its evidence-ceiling checks apply unchanged.
4. **Privacy tier.** `answer_quote`/`takeaway` quote Matthew's verbatim check-in answers → **Matthew-private** (same tier as the CHECKIN# answers themselves, `docs/DATA_GOVERNANCE.md`). Public surfaces must never render `channel=conversation` learning text; `lambdas/web/site_api_coach.py` filters explicitly (track record + timeline), defense-in-depth on top of the status-vocabulary exclusion. *(Amended 2026-07-26 — see the §4 amendment below for the `takeaway` prompt carve-out and its deterministic screen.)*

**Why bounded this tightly.** The failure mode is a persuasive conversation swinging a coach's self-assessed understanding harder than a month of graded evidence ("no ±3-tier swings off one chat" — the story's own bar). Capping one conversation at one pseudo-observation makes the qualitative channel exactly as strong as one data point and no stronger, and the per-answer subdomain cap stops a single chat from repainting the whole confidence surface.

**Consequences.** Coaches visibly self-grade from conversation: a check-in answer can now produce a confidence move + learning the stance engine cites in its next `how_my_read_changed`/`confidence_note` — distinguished from data verdicts. Field additions are documented in `docs/SCHEMA.md` (§Conversational Self-Calibration). The evaluator's data path now stamps `source=data`/`channel=data` for symmetry. Revisit trigger: if conversation-sourced moves ever dominate a coach's confidence state (conversation_α+β exceeding the data-derived share on most subdomains), that is the signal to re-examine the weight cap — calibration should stay data-led with conversation as the corrective, not the reverse.

**Amendment (2026-07-26, #1789 — the §4 `takeaway` carve-out is stated explicitly, and it is gated in code).** *What was wrong.* §4 lumped `answer_quote` and `takeaway` into one Matthew-private tier while §3 deliberately designs conversation learnings INTO the stance/compression grounding — whose prose serves publicly. Both statements were true of the implementation; together they read as a contradiction, and the 2026-07-26 hardening comment in `coach/coach_history_summarizer.py` overstated the result ("leakage structurally impossible") for a hardening that only removed `answer_quote`. The deep-quality sweep filed it at P3: a defense-in-depth gap plus a doc-wording tension, not a live leak.

*The carve-out, stated.* The two fields are NOT the same tier for the same purpose:

| field | what it is | public RENDER | publicly-served PROMPT (§3 grounding) |
|---|---|---|---|
| `answer_quote` | Matthew's verbatim words | never | **never** — absent from both prompt builders by construction |
| `takeaway` | the coach's own LLM-authored synthesis (≤600 stored, ≤200 into a prompt) | never | **only through the deterministic screen below** |

*The deterministic screen (this amendment's operative clause).* A `takeaway` reaches `_build_compression_prompt` or `_summarize_track_record`'s stance grounding only via `coach_calibration.public_prompt_takeaway()`, which screens the FULL stored text with `coach_dossier.find_dossier_violations` — the same reused vocabulary the public dossier is fail-closed on (journal_quotes' taboo list over `privacy_guard.VICE_KEYWORDS`/banned real names, family specifics, private events, chronological age, genotype strings, and `broadcast_sensitivity_gate.find_pii`). A hit, an empty value, an unimportable screen, or any raised exception all substitute `TAKEAWAY_WITHHELD_MARKER` — an honest absence in the prompt (ADR-104), never the unscreened text. **Privacy gates fail closed even where the sibling quality gates in the same module fail open**; the module's existing grounding/untrusted-text shims are deliberately the other way, and that asymmetry is intended.

*What this does NOT change.* No public surface renders `channel=conversation` learning text — `site_api_coach` still filters and `coach_dossier` still excludes wholesale, both before any projection. §3's grounding design, §1's `answer_quote` grounding requirement, and the §2 bounds are untouched. The screen is an added barrier on the one sanctioned prompt path, not a licence to render.

*Honest residual.* The screen is a vocabulary/pattern check: it deterministically closes the standing content-absolute classes, not "a sensitive sentence built from ordinary words" — the same residual ADR-104 records on every deterministic gate. Pinned by `tests/test_adr141_takeaway_screen_1789.py`; widening the vocabulary is a `journal_quotes`/`privacy_guard` change (and a `GUARD_VERSION` bump), inherited here for free.
## ADR-142: The journal privacy three-tier model — verbatim-private by default, consent-per-line public verbatim, theme-referenceable allude (#1568, shared with #1483)

**Date:** 2026-07-25 · **Status:** Accepted · **Story:** #1568 (epic #1563; the allude tier lands later via #1483)

**Context.** The Notion journal is the platform's richest first-person corpus and is deliberately invisible to readers: the chronicle's rule is "deep background — NEVER quote the journal directly" (`lambdas/emails/chronicle_prompt.py`), and every AI surface inherits it. That wall is correct as a default — but it also silences the most authentic voice the site has. #1574 (`lambdas/privacy/diary_consent.py`) already broke the wall at ENTRY level for coach reactions, fail-closed, and noted the per-LINE schema was deferred to "the #1483 ADR". This is that ADR: one privacy model governing every future journal-to-public channel, so #1568 (verbatim quotes) and #1483 (allude tier) implement tiers of the SAME contract instead of accreting bespoke gates.

**Decision — the three tiers.** Every journal line is in exactly one tier, and the tier is an explicit owner marker, never inferred from content:

1. **verbatim-private** — the default, for every line, forever. Unmarked journal text never crosses into any public generation or render. There is no bulk opt-in, no entry-level "publish all", no model-inferred consent. (This tier IS the chronicle's never-quote rule; nothing in this ADR loosens it.)
2. **theme-referenceable (allude)** — an explicitly marked line/entry may inform public narrative at THEME strength only: the coarse 8-way laundered `dominant_theme` (the `diary_consent.public_theme` reducer), never verbatim text, never a paraphrase that functions as a quote. #1483 implements this tier per-line; until then `diary_consent`'s entry-level allude stands.
3. **public-delta (verbatim-public)** — a single line Matthew explicitly marked publishable, published as the EXACT text he approved: dated, labeled as his words, with a receipts link to that day's data. #1568 implements this tier; it is the only path journal words may take to the public site.

**The verbatim-public channel's contract (#1568, enforced in code):**
- **Write path & single-SOT stance:** the mark is written by the `mark_journal_quote` MCP tool (`mcp/tools_journal.py`) to DDB `USER#matthew#SOURCE#journal_quotes` / `QUOTE#<date>#<hash>`. The consent record is the source of truth for *publishability* — a consent event freezing the approved bytes at mark time. Notion stays the source of truth for the journal itself. Chosen over a Notion property because: (a) marking happens in the interview conversation, where the MCP tool is the native write path; (b) a page-level Notion property cannot carry per-line marks; (c) a later Notion edit must never silently mutate an already-published "verbatim" quote — consent attaches to the exact approved text, so freezing it is the honest semantic, not a dual-SOT violation; (d) revocation is an explicit `unmark` (the record is deleted and the surface drops the line on next fetch), not a pipeline-lagged property read.
- **Consent is explicit, per line:** the tool refuses unless `approved` is exactly `true`, given for that specific line. Cap: 2 marked lines per entry date (the "0–2 per close" nomination discipline, in code).
- **The mark-time taboo gate (fail-closed):** `lambdas/journal_quotes.find_mark_violations` machine-enforces the ELENA_PREQUEL_BRIEF abstract/omit list for the categories a deterministic check can honestly carry — substances (reusing `privacy_guard.VICE_KEYWORDS` as the base set, widened with the alcohol family that stays deliberately soft elsewhere), family-specifics, age disclosure (PhenoAge Option A: chronological age is never public), private events (wedding/funeral/therapy/work specifics), and the privacy_guard real-name set. The workflow rule (`.claude/skills/journal-interview/SKILL.md` step 5) says Claude refuses to *nominate* such lines; the code gate guarantees it regardless (prompt rules are hopes, code gates are guarantees — the privacy_guard doctrine). Categories a regex cannot honestly carry (e.g. "relationship questioning") remain covered by the nomination rules + the human approval step — defense in depth, recorded here as a known limit.
- **Grounding (ADR-104):** a mark must appear verbatim (whitespace/case-normalized) in that day's ingested entry; a mismatch is refused as a paraphrase. An entry not yet ingested records `grounding: pending_ingestion` honestly.
- **Serve path:** `/api/journal_quotes` (`lambdas/web/site_api_coach.handle_journal_quotes`) reads ONLY the consent partition — never the journal — and screens each verbatim line all-or-nothing at serve time (`_public_decision_note`, the #1569 rule: a quote the content filter would alter at all is withheld, never mangled). Volume cap in the payload: `featured` is the at-most-one line home may show per ISO week (first-marked line of the current week — deterministic and stable mid-week); the archive lives on the story hub. Empty ⇒ `{"quotes": [], "featured": null}` and both surfaces stay dormant.
- **Retention:** `journal_quotes` is RAW_TIMESERIES in `lambdas/experiment/phase_taxonomy.py` — consent artifacts are kept across resets like the journal they excerpt; they leave the surface only by explicit unmark.

**What this ADR does NOT change.** The chronicle/coach/podcast never-quote prompts are untouched; `diary_consent.py`'s entry-level gate for coach reactions is untouched (it becomes the entry-level projection of this model); the content-policy scanner and privacy guard keep their existing scope (the new surfaces fall inside it — `site/` is scanned, and quote content paths are never allowlisted, per the #1567 rule).

**Revisit trigger.** When #1483 ships the per-line allude tier, it implements tier 2 of THIS model (extending `journal_quotes`/`diary_consent` with the allude mark) — a new ADR is needed only if the tier semantics themselves change. Reopen also if any surface ever wants entry-level bulk publishing: that is a new decision, not an extension of this one.

**Consequences.** One consent grammar for every journal-to-public channel; the public site gains a small, honest first-person surface whose every line carries an explicit, revocable, per-line consent record; and the "deep background" default stays exactly as strong as it was — stronger, in fact, because the one sanctioned exception now has a written boundary.

## ADR-143: Paging posture — email is the default channel; one dedicated SNS→SMS topic pages a named ≤5-alarm P1 set (#1333)

**Date:** 2026-07-26 · **Status:** Accepted · **Story:** #1333 (SDLC review 2026-07-18, ops lens; owner decision recorded on the issue 2026-07-26)

**Context.** Every human-visible alert lands in one email inbox: `aws sns list-subscriptions` showed a single email endpoint on `life-platform-alerts`, and the INCIDENT_LOG carries the founding accident — a Garmin ingestion alarm that fired continuously for ~44 days with no inbox follow-through. The 72h stuck-alarm escalation (#1282) and the two-tier urgent/digest split (ADR-050) both terminate in the same inbox, so the away-for-a-week MTTR story for genuinely urgent classes (pipeline dead, budget hard-stop, site down) was an accident of history, not a decision. Matthew chose option B on the issue: one phone-visible channel for a tiny named set.

**Decision.**
1. **Email stays the default channel for everything.** The urgent/digest topology (ADR-050) is unchanged; nothing is removed from it.
2. **One DEDICATED paging topic — `life-platform-paging` (CoreStack)** — carries SMS. It is deliberately NOT the alerts topic: subscribing a phone to `life-platform-alerts` would page on every alarm and burn the channel to alarm fatigue inside a month.
3. **The paged P1 set is named, tiny (≤5), and guard-tested:**
   - `paging-budget-tier-3` — BudgetTier ≥ 3 (the ADR-063 hard cutoff; website AI dark, brief degraded).
   - `paging-pipeline-dead` — StaleSourceCount ≥ 8 of the ~15 ingestion sources (total-failure class, not one flaky source — single-source staleness stays a digest item).
   - `life-platform-canary-ddb-failure` / `life-platform-canary-s3-failure` — the serving path's true-outage signals (the canary legs serve_stack's own comments name as the outage detectors; degradation alarms stay digest-only).
   `tests/test_paging_alarms_1333.py` pins the set and its wiring; **growing the set is an amendment to this ADR, not a tweak** — the whole value of the channel is that a page is always worth standing up for.
4. **The phone number never enters the repo, the CFN template, or shell history.** It lives at SSM `/life-platform/paging-phone` (SecureString). CloudFormation cannot resolve a SecureString into an SNS subscription endpoint, so the subscription is wired out-of-band by `deploy/wire_paging_phone.sh` (idempotent: reads SSM at run time, subscribes only if absent). The guard test asserts the script exists and reads the sanctioned parameter; the live subscription is the operator-verifiable artifact (`aws sns list-subscriptions-by-topic`).

**Compensating controls (why email-only remains safe for everything else):** the daily digest batches the long tail (ADR-050); #1282 escalates any alarm stuck ≥72h; the remediation agent triages alarm state Mon/Wed/Fri; and the sentinel drift sweep reads alarm posture weekly.

**Revisit triggers.** (a) A paged incident SMS didn't materially beat email on — or two false pages in a quarter — reopen the set's membership. (b) #1444's urgent-topic reconciliation may re-route alarms between topics; if it touches a paged alarm, re-run the guard test's premises. (c) If the paged set ever wants to grow past 5, that is a posture change: amend here first.

**Consequences.** The single-channel accident becomes a signed two-channel posture; an away-week no longer means a dark week for the three classes that can't wait for an inbox; and the alarm-fatigue failure mode is structurally fenced by the guard-tested ≤5 cap.

## ADR-144: Proportionality — complexity must earn its keep; the ledger becomes a legible standing artifact (#1666)

**Date:** 2026-07-26 · **Status:** Accepted · **Story:** #1666 (epic #1648, 2026-07-21 engineering-excellence audit, CIO lens; owner approved option (a) 2026-07-25)

**Context.** The CIO note that opened #1666: "14 workflows, 139 ADRs, a self-healing agent, canary judges, a 4-tier cost governor — for a single-user platform. The capabilities are right; the ask is whether the surface is legibly right-sized." The platform already prunes on measurement — ADR-103 is the posture ledger, ADR-129 the worked demotion — but the ledger lives ~3,000 lines deep in this file and carries neither a cost dimension nor a stated cadence. The discipline existed; the legibility didn't.

**Decision.**
1. **The maintained ledger moves to `docs/PROPORTIONALITY.md`** — one scannable page: per-subsystem posture, the RENT it pays (five honest classes: `$`, `CI`, `attention`, `surface`, `mind` — categories, not invented dollar figures, per ADR-105), what earns its keep, and the demote/retire trigger. Active and Retired are separate tables — the prunes are the proof.
2. **ADR-103's landing rule is unchanged and restated there:** new enterprise-pattern infrastructure names its frame (load-bearing / portfolio) or does not land. ADR-103's table is frozen as history with a pointer note.
3. **ADR-129 is the demotion template, generalized:** demotions cite a measurement (the agent's zero merged PRs in ~6 weeks), promotions cite a numeric bar (its 10-clean-run re-promotion gate). "Exemplary design" never outranks "measured yield".
4. **Cadence:** quarterly re-read; any review ritual that comes back findings-empty on a subsystem twice consecutively proposes a demotion row.

**Consequences.** The proportionality question gets a one-page answer instead of an archaeology exercise; every standing subsystem is priced and triggered; and the successor-continuity goal (the #1650 discussion) gains the single document a new operator would read to learn what can be safely turned off.

## ADR-145: The video-diary public form — text + prosody cards; raw audio/video never; avatar is a gated future revisit (#1570, #1388)

**Date:** 2026-07-27 · **Status:** Accepted · **Story:** #1570 (epic #1563) + #1388 (epic #1364); owner decision recorded 2026-07-27

**Context.** The Diary Studio (epic #1564) produces private video-diary footage with Claude as the live interviewer; the raw recordings never leave Matthew's own devices — that half was settled at filing. What #1570 and #1388 both gated on was the *public form*: what a reader sees of a diary day. The naive form (publish the footage, or the audio) is not available — a voice is identifying, and voice de-anonymization only improves over time, so any published audio is an irreversible exposure. Both issues carried `gate:owner` on exactly this decision, per their acceptance criteria: "the anonymity/form decision is documented BEFORE first public exposure."

**Options weighed.** (1) Text-only diary cards — code-drawn: date + consent-per-line transcript excerpts + the day's already-public numbers + optionally a coach reaction. (2) The same cards plus a *prosody* layer — visual rendering of delivery (pace, pauses, energy) from the SRT vocal metrics that #1843 already extracts; still no audio. (3) Pitch-shifted audio — disguised voice; visceral but not reliably irreversible as de-anonymization improves. (4) Avatar video — an animated character speaks the words. Priced 2026-07: HeyGen API ~$1–4/min of video (≈$30–240/mo at daily use), D-ID $79.90/mo for 40 min, Synthesia Creator $67/mo — against the platform's **$85/mo total AI ceiling** (ADR-063/133), and, decisively, all of it **third-party billing invisible to `cost_governor`/`budget_guard`** (Cost Explorer + Bedrock only) — the same budget-blind-spot class that parked X syndication (#1631) and ElevenLabs (#1742). A code-drawn avatar avoids the vendor but is a large effort for a stylized result.

**Decision (Matthew, 2026-07-27).**
1. **The public form is options 1+2 combined:** code-drawn diary cards — date, transcript excerpts under the ADR-142 consent-per-line mechanism, the day's already-public computed numbers as the receipt, optional coach reaction — plus a visual prosody/delivery layer sourced from the #1843 vocal metrics. Cost ~$0; reuses the existing card/OG machinery.
2. **Raw video and raw audio are never published.** Pitch-shifted audio (option 3) is not sanctioned; adopting it ever would be an explicit amendment to this ADR, not a config change.
3. **Avatar rendering (option 4) is a gated future revisit, not a dead end.** Revisit only if the diary cards demonstrate real reader engagement, and only via (a) a code-drawn avatar at ~$0, or (b) an ADR-063 amendment that first makes off-AWS vendor spend visible and capped — the invariant "one budget covers ALL spend" must be corrected in writing before it is broken in code (the #1631 rule).

**Consequences.** #1570 (diary cards) and the public-artifact half of #1388 are unblocked — `gate:owner` clears on both; the anonymity-design acceptance criterion each carries is satisfied by this record. The consent boundary stays where ADR-142 put it (nothing becomes public without a per-line mark), and the avatar question stops resurfacing: the conditions to reopen it are on the record.

---

## ADR-146: lambdas/ is packaged by domain — the flat root is retired, and moving code must never reduce coverage (#1653)

**Date:** 2026-07-28 · **Status:** Accepted · **Story:** #1653 (epic #1648, from the 2026-07-21 engineering-excellence audit)

**Context.** `lambdas/` had 132 loose `.py` files at its root alongside 12 real subpackages — packaging half-done since the 2026-05-25 reorg stopped partway. A reviewer opening the directory could not tell the inference chokepoint from a one-off helper without reading 132 filenames. The audit filed it as structure failing to communicate architecture.

The constraint that shaped the migration: `deploy/build_bundle.py` stages the whole `lambdas/` tree at the zip root (#781), so `import ai_calls` resolves to `/var/task/ai_calls.py`. There is no shim layer. Moving a module rewrites its import path for every caller simultaneously — 1,570 import statements across 499 files — and a single missed site is a cold-start `ImportError`, not a test failure.

**Decision.**

1. **Nine domain packages**, by subject matter rather than by consumer count: `common` (infrastructure: constants, logging, retries, time, HTTP), `ai` (inference, budget, guardrails, TTS), `experiment` (the scientific apparatus: phase, gates, calibration, stats), `coach`, `health`, `training`, `content`, `privacy`, plus the pre-existing `ingestion` / `operational` / `intelligence` / `web` / `emails` / `compute` / `reading`. Placing modules purely by "who imports it" was rejected: it collapsed 88 of 132 into one `common`, which is the flat root with a new name.

2. **`lambdas/` holds package directories only.** No loose modules, no data files. Enforced by `tests/test_lambdas_packaging_guard.py`, subset-style so the tree can only improve. The guard defends the packaged *shape*, not any module's specific package — the taxonomy above is a judgment call, and moving a module between packages later is ordinary refactoring.

3. **Moving code must never reduce coverage.** Every path-keyed registry moves in the same commit as the code. Four exist, and none of them are obvious until they break: `ci/lambda_map.json` (deploy map + `skip_deploy`), `ci/lambda_s3_paths.json` (S3 key-shape evidence), `tests/mypy_clean_set.py` (whose `CLEAN_DIRS` globs are **non-recursive** — omitting a new package silently drops its modules from the mypy gate), and `mypy.ini`'s per-module sections. Where a package's directory is not yet clean, the moved modules are listed individually in `CLEAN_FILES` rather than dragging ~40 unrelated modules and their pre-existing debt into the gate.

4. **Module-relative resource loading searches upward, never a fixed depth.** `lambdas/common/repo_config.py` is the shared helper. The banned pattern is `dirname(dirname(__file__))/config/...`, which silently encodes "this module sits one level below the repo root."

**Consequences.**

The migration ran as ten verified slices. Its most useful output was not the tree but the failure catalogue, because *the tests were not the thing that caught most of it*:

- Eight tests stubbed inference via `sys.modules["bedrock_client"]`. Once the code says `from ai import bedrock_client`, CPython's `_handle_fromlist` prefers the parent package's already-bound attribute and never consults `sys.modules` — so the stubs stopped applying and the "unit" suite began making **real Bedrock calls**, failing only because CI has no credentials. Order-dependent: green when the file ran alone. Fixed by `tests/bundle_stubs.py`.
- Three config loaders (`persona_registry`, `persona_core`, `coach_stance`) prefer S3 and treat a missing local file as a soft miss. Their depth assumption broke offline only, surfacing as 44 tests asserting that coaches had no names.
- `meal_grouper` and `redirect_spotcheck` read data files that `build_bundle` stages at the **bundle root** precisely because they "look alongside their own module." That stopped being the same place. Invisible to the suite, which has a real `config/` to fall back on — only the bundle came up empty.
- `deploy/session_postflight.py`'s asset canaries match zip namelists **exactly**. Unfixed, the guard against silently-corrupt deploy assets would have reported false missing modules on every deploy. Its own unit tests stayed green because they build synthetic zips from the same literals.

The through-line: every one of these fails *soft* — a warning, an empty registry, a green test — and none were caught by pytest. `scripts/verify_bundle_boot.py` (added in the first slice) is the answer to that class: it stages the real bundle and imports every module in a subprocess whose only first-party `sys.path` entry is the bundle root, which is what `/var/task` actually gives a Lambda. `tests/conftest.py` deliberately adds `lambdas/` **and each subpackage** to `sys.path` so legacy flat-name imports keep resolving; that convenience is exactly what lets a stale import pass the suite and fail in production.

Pre-#1653 dated artifacts — `docs/CHANGELOG.md`, `docs/reviews/*`, `docs/restart/*`, handovers, and the content-hash-sealed `deploy/generated/channel_divergence_prereg.json` — keep their original flat paths. They record what was true when written, and the prereg's whole value is that it cannot be edited.

---

## ADR-147: The smoke oracle answers two questions — only deploy health may revert a deploy (#1921, measured by #1920)

**Date:** 2026-08-02 · **Status:** Accepted · **Story:** #1921 (epic #1890), with #1920 supplying the measurement

**Context.** `qa-smoke` is ci-cd's smoke oracle: a FAIL auto-rolls-back the fleet. But its checks answered **two unrelated questions** under one verdict — *"is the code that just shipped broken?"* (handler imports, MCP tool calls, secret references, deterministic receipt replay) and *"is the published state honest right now?"* (yesterday's ingestion, an artifact a cron wrote hours ago, an AI read on live prose).

Only the first is evidence about the deploy in flight, and only the first is repaired by reverting it. Content drifts on its own schedule whether or not anyone deploys, and **reverting code cannot un-publish a stale number** — so for that class the rollback was not merely disproportionate, it was *ineffective*.

Three fleet rollbacks fired on content findings and reverted healthy code: 2026-07-27 16:15Z (98 functions, a dashboard-freshness check whose 4h window was stale-by-design against a 1×-daily writer) and 2026-08-01 00:18Z (100 functions, `reader_truth` flagging a defect that had been live for weeks). Two of them re-published content that had already been fixed.

**The measurement that reframed it (#1920).** The obvious response was to demote `reader_truth` for imprecision. Measuring first produced a better answer and a worse problem:

- Precision on HIGH findings was **2/10 = 20%, Wilson 95% CI [5.7%, 51.0%]** (n = 10) — but all ten came from a single day on one payload being actively edited, so the interval is uninformative and the number could not carry a policy decision.
- More importantly, `reader_truth` had been **budget-paused for 26 consecutive days** (2026-07-06 → 08-01; its `budget_guard` cutoff is tier 1). Both the "too noisy to gate" position and its rebuttal were arguing about a check that had been switched off for 26 of the 30 days in question.
- It looked green throughout because `Check.pause()` set `passed = True` and printed nothing — a paused check and a passing check were byte-identical in every recorded signal, the same shape as #1908's doc-index check.

The disqualifying property is therefore **not** precision. It is that the gate's availability is decided by month-boundary spend arithmetic, and its pause is *positively correlated with* the drift it exists to catch: it goes dark for weeks, drift accumulates unobserved, then it resumes and attributes the backlog to whatever deploy is in flight. At 00:00:12 UTC the month rolled over and the tier dropped to 0; at 00:18:20 the check FAILed on a weeks-old defect; at 00:18:29 the fleet reverted. **Even at 100% precision that verdict would not have been about the deploy.**

**Decision.**

1. **Every `Check` carries a `partition` — `deploy_health` or `content_truth` — required at construction.** No default to inherit and no name/category convention consulted: a convention drifts the moment someone adds a category. The test is causal, not topical — *could a deploy that landed minutes ago have caused this, and would rolling it back repair it?*

2. **Only `failed_deploy_health` gates the pipeline.** `deploy/lib/smoke_oracle_decision.py` reads it, and **falls back to the total `failed` when the key is absent** (an older zip, or the canary — which has no partitions and whose every check *is* deploy health). The oracle never fails open on a missing key.

3. **Re-routing, not muting.** A `content_truth` failure still sends the same red email (now with the split in the subject), still prints to the log with its partition, still counts in the **unchanged** `FailCount` that the `qa-smoke-failures` alarm fires on, emits its own `ContentTruthFailCount`, and raises a `::warning::` at the CI surface where the deploy happened. Only the exit code changed.

4. **The partition set is enforced by derivation, not enumeration.** `tests/test_qa_smoke_partition.py` AST-scans every `Check(...)` construction site in the operational package and fails any that omits a partition — including sites in modules that receive the class by injection. Hand-listing the surfaces is the failure mode #1917 documented.

5. **A paused check must be distinguishable from a passing one.** Paused checks are named in the oracle payload and logged `[QA] PAUSE`. Without this, no future measurement of any budget-gated gate can be trusted — which is precisely why #1920 could not answer the question it was written to answer.

**Consequences.**

The net is narrower and the canary is unchanged, so the pipeline is not unguarded: the canary still gates unconditionally, and #1345's synthetic-failure drill is deliberately partitioned `deploy_health` so it keeps proving the rollback path fires for real.

Verified on live data within an hour of deploying: the deployed Lambda returned `failed: 1, failed_deploy_health: 0, failed_content_truth: 1`. The old oracle would have reverted the fleet on that `failed: 1`; the new one shipped the deploy and still emailed, logged and alarmed the finding.

Two things this ADR deliberately does **not** settle. Whether `reader_truth` should keep its `impossible_number` category at all is #1922's question — most of its false positives are arithmetic a deterministic check does better and identically every time (ADR-105's "deterministic computation before any LLM verdict"). And the budget-band problem underneath it is #1927's: the cutoff-1 band contains seven features including two CI gates, and at current burn tier ≥ 1 is the platform's *default* operating state rather than an exception.

The generalisable rule, which is the third instance of the #1911 pattern in three sessions: **an automated response must be able to repair the thing it fires on.** If reverting cannot fix it, reverting is the wrong response no matter how confident the detector.

---

## ADR-148: Branch protection is scoped to the fast lane — required checks that always run, auto-merge, and nothing that needs a second human (#1662)

**Date:** 2026-08-03 · **Status:** Accepted · **Story:** #1662 (epic #1648, from the 2026-07-21 engineering-excellence audit)

**Context.** `main` had no merge gate at all. `gh api repos/<owner>/<repo>/branches/main/protection` returned 404, and the only ruleset was `main-block-force-push-and-deletion` (id `19162901`, #1325) — deletion + non-fast-forward blocks, no required checks, no PR rule. Every pre-merge signal the repo produces was **advisory by construction**: ADR-139 made that explicit and named the compensating control (run the full suite locally before every merge). That control is a habit, and a habit is not evidence. "Always-green `main`" was a claim about discipline, not a property of the repository.

The obvious fix — require the checks — has an equally obvious failure mode, and it is the one that actually bites: **a required check that some PR class never reports blocks that class forever.** GitHub matches a required check by its check-run *name*, and treats "never reported" and "reported failing" identically. Three of this repo's PR gates are structurally incapable of being required:

- `docs-ci.yml`, `surface-drift.yml`, `v4-gate.yml` are **path-filtered**. A docs-only PR never produces `Surface-drift gate (…)`, so requiring it would leave every docs PR sitting on "Expected — Waiting for status to be reported".
- `dependabot-validate.yml`'s `validate` job is `if:`-gated to `dependabot[bot]`. On a human PR it reports **`skipped`**, and a skipped check never satisfies a required check.
- `codeql.yml`'s `analyze` is a **matrix** job (one check-run per language), and its `analyze` step never exits non-zero on a finding — requiring it buys latency and no verdict.

There is a second trap that is specific to this repo. ci-cd.yml's `reconcile` job pushes one regenerated-artifact commit **directly to `main`** as `github-actions[bot]` — not through a PR. A required-status-checks rule blocks *any* ref update whose head has no passing checks, so under classic branch protection that push is rejected on every merge day, and `enforce_admins: false` does not help because the bot is not an admin. This is why the control is a **ruleset** and not classic protection: rulesets carry `bypass_actors`.

**Decision.** Option C, from the three the issue weighed (A: require the full suite; B: leave everything advisory; C: require the fast lane only).

1. **Required = exactly the two checks that run on every PR to `main`, unfiltered and un-gated.**

   | Context (== the job's `name:`) | Workflow · job | Typical | Why it always runs |
   |---|---|---|---|
   | `Collect + deploy-critical + format` | `pr-checks.yml` · `fast-lane` | ~90s | `on: pull_request: branches: [main]`, **no** `paths:`, no job-level `if:` |
   | `gitleaks (PR commit range only, not full history)` | `secret-scan.yml` · `gitleaks` | ~45s | `on: pull_request: branches: [main]`, **no** `paths:`, no job-level `if:` |

   Together they are ADR-139's fast lane plus the #1659 credential scan: the collection gate (the #1297 class), the `deploy_critical` marker subset (ADR-117), `black --check` over the six enforced dirs, and a gitleaks scan of the PR's own commit range. Under two minutes, fully offline, no AWS.

2. **Everything else stays advisory and post-merge**, by name and with a reason, in `deploy/github_posture.json`'s `advisory_not_required` list: the full `Unit Tests` suite, `Lint + Syntax Check`, the visual/AI-vision QA estate, CodeQL, Dependabot Validate, and the three path-filtered gates. This is not a bar we failed to clear — the full suite runs on push and still reds `main`, and ADR-117's split already established that the exhaustive suite must not gate the chain. **This ADR resolves the deferral written into `codeql.yml`'s own header**: CodeQL stays advisory.

3. **Auto-merge on** (`allow_auto_merge: true`). Required checks only cost wall-clock if a human waits on them. The operator arms the merge once, and GitHub lands it when the two checks go green.

4. **No required reviews, ever.** One operator: a `pull_request` rule would make every merge un-landable by its author. This is refused *structurally*, not by convention — `scripts/apply_branch_protection.py::assert_no_review_requirement()` raises on any approval-shaped rule in the spec **and** in the built payload, and the drift sentinel reports one appearing live as drift, because this tool never applies one.

5. **`strict_required_status_checks_policy: false`.** Requiring "branch up to date with base" would force a rebase of every open PR each time a sibling merged — which is precisely the concurrent-PR wave this repo runs.

6. **One bypass actor: the `github-actions` Integration, `always`.** It exists for the `reconcile` push, not to weaken the gate — removing it does not make `main` safer, it wedges merge-day artifact reconciliation. The applier resolves the app id live from `GET /apps/github-actions` rather than hardcoding `15368`, because a wrong literal produces a bypass that matches nothing and fails only on the day it is needed.

7. **Settings-as-code, driver-applied.** The desired state is `deploy/github_posture.json` (the existing #1320 posture mirror); `scripts/apply_branch_protection.py` prints a plan by default, mutates only under `--apply`, and re-verifies with `--check`. It selects the ruleset by name and **refuses** to touch `main-block-force-push-and-deletion` by either name or id. Classic branch protection is not used at all, so the drift-discovery table's "`branches/main/protection` must 404" row stays true.

8. **Two independent drift checks, in slots that already exist.** `drift_sentinel.check_github_config()` gains `main_required_checks_ruleset` and `repo_settings` surfaces (weekly, GET-only, fail-soft on token scope). Offline, `tests/test_branch_protection_spec.py` runs the applier's `preflight_contexts()` against the real workflow YAML, so a later edit that path-filters the fast lane or renames its job reds the suite — with the guard proven to fire against the three real workflows it must reject, not asserted in the abstract.

**Consequences.**

Between this PR merging and the driver running `--apply`, the sentinel reports both new surfaces as **drift**. That is the posture file's rule (2) working as designed — it declares the documented posture, never a wish — and it is a forcing function, not a false alarm.

The honest limit of the guarantee: `main` is provably green *against the fast lane*, not against the full suite. A red `Unit Tests` job still reaches `main` and still reds it. That is the deliberate trade — ADR-117 already decided the exhaustive suite must not gate the chain, and requiring an ~8-minute suite on a solo repo buys a slower loop for a signal that arrives 90 seconds later anyway.

The failure mode to recognize, because it will look like a GitHub outage: a PR stuck on "Expected — Waiting for status to be reported" means a required context stopped being emitted — someone added a `paths:` filter to `pr-checks.yml` or `secret-scan.yml`, renamed a job, or gated it with `if:`. The cure is to restore the workflow or edit the spec and re-run the applier; the escape hatch is deleting the `main-required-fast-lane` ruleset, which the sentinel then reports as absent. `tests/test_branch_protection_spec.py` exists to make that a red test on the PR that causes it rather than a mystery on the PR that follows.

**Revisit when** any of these change: a second contributor (required reviews stop being absurd and start being the point); the fast lane's runtime crosses ~3 minutes (it is only free while it is fast); a required context needs to become path-filtered (it must leave the required set in the same PR); or `pr-checks.yml` grows the `ruff` gate it currently lacks — `black --check` is the only formatter the required lane enforces today, while CI's `Lint + Syntax Check` also runs ruff and mypy post-merge.

### ADR-148 Amendment (2026-08-07, #2198 — the `Integration` bypass actor 422s off an org; the bypass is a `User`, and the reconcile push needs a PAT)

**Context.** Point 6 of the decision above bypassed the ruleset with the built-in `github-actions` app as an `Integration` actor, resolved live via `GET /apps/github-actions` and never hardcoded. Running `scripts/apply_branch_protection.py --apply` for the first time (2026-08-07) failed the ruleset write, identically under **two separate auths** — the session's own `gh` credential and the owner's — ruling out an auth/scope problem:

```
FAIL: ruleset write: {"message":"Validation Failed","errors":["Actor GitHub Actions integration must be part of the ruleset source or owner organization"],"status":"422"}
```

Read literally: GitHub refuses an `Integration` bypass actor for an app unless the ruleset's *source* is itself an organization the app is installed into. `averagejoematt/life-platform` is owned by a personal (User) account — confirmed live, `gh api repos/averagejoematt/life-platform` → `owner.type: "User"` — so there is no organization for the app to "be part of." This is a GitHub product limitation on personal-account-owned repos, not a configuration mistake in the original design; the #1662 review had no way to know it without attempting the write.

**Two alternative mechanisms, measured and rejected — not merely asserted:**

1. **Classic branch protection** (`enforce_admins: false`) — already ruled out by the original ADR's own reasoning (point 6 above, and `ci-cd.yml`'s pre-existing comments): classic protection has no per-actor bypass list at all, only an admin/non-admin distinction, and `github-actions[bot]` is not and cannot be made a repo admin without a much larger privilege grant to the CI token than this fix warrants. Nothing new to measure here; the original analysis holds.
2. **A ruleset with no bypass actor, reconcile switched to open a PR instead of pushing directly** (the issue's candidate (b)). Rejected on GitHub's own documented behavior, not a guess: *"When you use the repository's `GITHUB_TOKEN` to perform tasks, events triggered by the `GITHUB_TOKEN` will not create a new workflow run"* — with a stated exception for `pull_request` `opened`/`synchronize`/`reopened` events, which *do* create a run, but **in an approval-required state** requiring a human to click "Approve and run" in the Actions UI. A reconcile-via-PR flow would therefore never auto-satisfy the required fast-lane check without a manual click on every occurrence — reintroducing exactly the human-wait ADR-148 was built to cost zero, and producing precisely the "Expected — Waiting for status to be reported" wedge `preflight_contexts()` exists to prevent, just relocated from a workflow-config mistake to a structural property of `GITHUB_TOKEN`-opened PRs. Ruled out without a write: the restriction is GitHub's stated behavior, not something that needed reproducing here to trust.

**Decision.** The bypass actor is a **`User`** — the repo owner's account — instead of an `Integration`. GitHub's ruleset `bypass_actors` schema documents `User` as a distinct, valid `actor_type` (alongside `Integration`, `OrganizationAdmin`, `RepositoryRole`, `Team`, `DeployKey`; `OrganizationAdmin` is explicitly documented as not applicable off an organization, which is why it isn't the answer here either). The repo owner trivially satisfies "part of the ruleset source" — the source *is* the repo they own. The trade-off this buys: a `User` bypass actor only matches a push **authenticated as that account**, not `github-actions[bot]`. `ci-cd.yml`'s `reconcile` job (which pushes derived-artifact commits directly to `main`, not through a PR — see §4c above) therefore authenticates its push with a stored fine-grained PAT belonging to the owner (`RECONCILE_PUSH_TOKEN`, scoped to `Contents: read-and-write` on this one repo — nothing broader), passed to `actions/checkout`'s `token:` input with a fallback to the default `GITHUB_TOKEN` so merging the workflow change alone changes nothing until the secret exists. `scripts/apply_branch_protection.py --apply` GET-checks that the secret is provisioned before writing the ruleset and **refuses to proceed if it is absent** (`reconcile_push_secret_provisioned()`) — applying the ruleset first, with no way for the reconcile push to authenticate as the bypass actor, would silently strand the next merge-day reconcile. `deploy/sentinel_github.py::_judge_required_checks()` and its bypass-actor comparison are generalized the same way the applier is (`_resolve_want_bypass_actor_id()`), so the weekly drift check reads the live `User` bypass correctly instead of comparing it against a resolver that only ever knew how to look up apps.

**What is, and is not, verified.** The `422` on the `Integration` shape is measured live, twice, under different auths — that part is settled. The `User` shape's write has **not** been executed live as of this amendment — the hard constraint on this session's work was no repo-settings mutations of any kind, so `--apply` has not been run. What's verified instead: the `User` `actor_type` is a documented, schema-valid enum value (not a guess), the repo owner satisfies the stated 422 condition ("part of the ruleset source") on its face, and the offline test suite exercises the built payload's exact shape (`tests/test_branch_protection_spec.py`) plus the sentinel's live-vs-want comparison logic against fixtures (`tests/test_drift_sentinel.py`). The one thing genuinely open until the owner runs `--apply`: whether GitHub's ruleset validator accepts a `User` bypass actor on this repo without some other constraint this measurement didn't surface. If it also 422s, the fallback is option (2) above with its human-click cost accepted, or a scoped custom GitHub App owned by the same account (registered + installed, an `Integration` actor that *would* satisfy "part of the ruleset source" since the app and the repo would share an owner) — heavier to provision than a PAT for a single job's push, and not built here because the `User` shape is the smaller, more measured bet.

**Consequences.** No live GitHub state changes from this amendment alone — `main` still carries only the pre-existing `main-block-force-push-and-deletion` ruleset (id `19162901`) until the owner runs the sequence below; `deploy/github_posture.json`'s `main_required_checks_ruleset` surface is still, honestly, reported as drift by the weekly sentinel (posture-file rule 2: it declares the documented posture, never a wish). The owner's sanctioned sequence, in order (the PAT step is UI-only — GitHub does not offer an API to mint a fine-grained PAT for security reasons):

1. Create a fine-grained PAT (GitHub UI → Settings → Developer settings → Fine-grained tokens) scoped to `averagejoematt/life-platform` only, repository permission `Contents: Read and write`.
2. `gh secret set RECONCILE_PUSH_TOKEN --repo averagejoematt/life-platform` (paste the PAT).
3. `python3 scripts/apply_branch_protection.py --apply` — refuses (exit 2) if step 2 wasn't done; re-verify with `--check`.
...
The public CSP is **not** a meta tag and **not** a header written by the sync script. It is a **CloudFront `ResponseHeadersPolicy`, CDK-owned**, and there are two of them in `cdk/stacks/web_stack.py`:

| Policy | Serves | Attached |
|---|---|---|
| `life-platform-amj-security-headers` | `averagejoematt.com` (the default S3 behavior — every v4 page incl. `/story/broadcast/`, `/data/*`) | `AmjSecurityHeadersPolicy` → default cache behavior |
| `life-platform-subdomain-security-headers` | `dash.` / `blog.` / `buddy.` | three subdomain distributions |

Measured live on 2026-08-06, `curl -sI https://averagejoematt.com/` returns exactly the main-domain literal from source — no `frame-src`, no `media-src`, so both fall back to `default-src 'self'` and a third-party `<iframe>` is blocked. That much of #1678's problem statement is correct.

Three things in the issue's framing were **wrong on measurement**, and they change the decision:
...
**Allow — narrowly, and inert on merge.** Four parts:

1. **Exactly one third-party origin, on exactly one directive.** `frame-src https://www.youtube-nocookie.com`. `www.` only, because the privacy-enhanced embed URL is `https://www.youtube-nocookie.com/embed/<id>` and the apex is not used. No `media-src` amendment (see Context 2) — `media-src` stays on the `default-src 'self'` fallback. No blanket `https:`, no wildcard host, ever. The set lives in `cdk/stacks/csp.py::NATIVE_EMBED_FRAME_SRC` and is pinned by name in `tests/test_csp_native_embeds_1678.py`, so widening it reds the suite instead of passing review by looking small.

2. **The CSP is built once, for both policies.** `stacks/csp.py::build_site_csp(connect_src=…, native_social_embeds=…)` replaces the two hand-copied string literals; `connect_src` is the only directive that legitimately differs between them. The sign-off's stated likeliest failure mode — "a one-sided edit ships an inconsistent policy" — is now *structurally* impossible rather than a thing to remember. The flag is read **once** in `WebStack.__init__` and passed to both call sites. The module is stdlib-only on purpose: CI's test job installs pytest + boto3 and **not** `aws-cdk-lib`, so a guard that reached the CSP through `web_stack.py` would ImportError at collection and red the whole suite.

3. **Inert until the owner acts, in one sitting.** `cdk.json` declares `"native_social_embeds": false`; with it off, the builder's output is **byte-identical** to the header serving readers today, so merging produces a **zero `cdk diff`** and Plan stays green. Activation is a one-line commit flipping that flag **plus** `cdk deploy LifePlatformWeb`, done together — because the window between them is exactly the window in which Plan reds. A committed JSON flag rather than a `-c` CLI override, deliberately: a `-c` value is not persistent, so the next deploy without it would silently revert the policy and blank every player. Coercion fails closed — anything not recognisably true is off.

4. **The facade stays the fallback and the current truth.** No player ships in this ADR. `site/` still builds zero iframes, and a test keeps it that way: the native-player swap (#1674's follow-up) must land *with* the owner's deploy, not before it, or the reader gets a blank box.

**Rejected, and why.**

- **The four-platform native set from the 2026-07-25 comment (YouTube + Bluesky + X + Instagram, incl. the script-based X/IG widgets).** The 2026-08-02 sign-off supersedes it and narrows to "exactly `youtube-nocookie.com`". That narrowing is also the right call on its merits: an iframe is a *sandboxed document* whose scripts cannot touch ours, while the X/IG widget pattern requires `script-src` for a third-party origin — arbitrary vendor JS executing **in our origin**, able to read the DOM of a page that discusses lab results and mood. Those are different risk classes, not different sizes of the same one. If X/IG embeds are ever wanted, they come back through a new ADR with `script-src` argued on its own.
- **A blanket `frame-src https:`.** Explicitly forbidden by the sign-off; it would also make the guard test meaningless.
- **Adding `media-src https://www.youtube-nocookie.com` "while we're in there."** Inside the approval envelope, but with no consumer it is width bought for nothing. It can be added later without a new sign-off, when something actually needs it.
- **Widening only the main-domain policy and leaving the subdomains narrower.** Marginally tighter, and rejected: the sign-off conditions both blocks changing identically, and the real delta is one named origin on three low-traffic internal subdomains versus a permanent invitation for the two policies to diverge again.
- **Doing nothing (facades forever).** A defensible position — the facade covers the reader need today and the source is dormant. Rejected as the *decision*, accepted as the *default state*: this ADR buys the option and deliberately does not exercise it. Nothing widens until there is content worth widening for.

**Consequences.**

The CSP that reaches readers is unchanged by this PR — verifiable by `curl -sI https://averagejoematt.com/`, which will still show no `frame-src` after merge. The trade-off accepted on activation is the one the owner named: an embedded YouTube player means reader requests to a Google-operated origin from a page about personal health data. `youtube-nocookie.com` defers cookie-setting until playback; it does not eliminate the request. That is the whole of the privacy cost, stated plainly rather than implied.

**Rollback.** Two levels, both cheap. *Config:* set `"native_social_embeds": false` in `cdk/cdk.json` and `cdk deploy LifePlatformWeb` — the policy returns byte-for-byte to today's, and any native player degrades to a blocked frame. *Feature:* revert the front-end to the facade card, which needs no CSP at all and is what `/story/broadcast/`, `/data/training/` and `/data/mind/` render today. There is no data migration and no state to unwind in either direction.

---

## ADR-150: DynamoDB native vector search — evaluated, declined; brute-force cosine stays until the corpus and the latency path both change (#1384)

**Status:** Accepted (evaluated-declined)
**Date:** 2026-08-08

**Context.** AWS shipped native vector search in DynamoDB (GA, all commercial regions): a new index type created through `CreateTable.VectorIndexes` / `UpdateTable.VectorIndexUpdates`, read with a `SearchVectors` API, up to 4,096 dimensions, `COSINE`/`DOT_PRODUCT`/`EUCLIDEAN`, `TopK` ≤ 100, on-demand capacity only, embeddings supplied by the caller. Priced per byte in us-west-2 at $0.52/GB written, $0.002/GB searched, table rates for storage, with a 1 KB minimum on every write and every search. The platform already runs semantic recall (#1384) on Titan-v2 embeddings with brute-force cosine in-Lambda, and `semantic_recall.py` names ADR-103 as the reason it has no vector store. So the question was live and worth answering with numbers rather than taste.

**Decision. Do not adopt. Keep brute-force cosine over a single `Query`.** Recorded with a concrete revisit trigger rather than a "no", because the trigger is reachable.

**Measured, 2026-08-08, against the live table.**

| Fact | Value |
|---|---|
| `life-platform` | 37,628 items · 53.6 MB · `PAY_PER_REQUEST` · GSI1 + GSI2 |
| Recall corpus | **17 rows** under `USER#matthew#SOURCE#recall_embeddings` · ~24 KB total |
| Kinds present | `chronicle` × 17. `KIND_COACH` and `KIND_JOURNAL` are declared in `KINDS` and have **zero rows** |
| DynamoDB spend | $0.28/mo — under 1.5% of the bill |
| Declared-but-unbuilt corpus | 8 coach partitions, **10,409 `COACH#*` items** |

**Reasoning.**

1. **Scale is four orders of magnitude off.** The index would hold 17 vectors in 24 KB, against a feature whose headline is "trillions of vectors" and whose every operation bills at a 1 KB floor. This is the arithmetic ADR-131 already ruled on for batch inference — machinery that would earn ~$0/mo today, carrying real rent. ADR-103/144's landing rule asks new enterprise-pattern infrastructure to name its frame; there is no frame to name.

2. **The adoption cost lands on the platform's most fragile surface.** An index requires an ADR (ADR-005 as amended by ADR-097). The table is not CDK-managed (`core_stack.py` holds a `from_table_name` lookup), so creation is an operator-run `update-table` — one more item on the out-of-IaC config surface ADR-102 already flags. The base64-float32 String codec in `semantic_recall.encode_vector` exists specifically to dodge the boto3 float→Decimal rule, and a native vector attribute reopens it. DDB grants are per-role and mostly `[TABLE_ARN]`-only, so index access fans out across ~15 roles. And the SDK is not there yet: botocore 1.42.59 and the repo's 1.43.62 dev pin both lack `SearchVectors` (`'SearchVectors' in service_model.operation_names` → `False`), the platform does not vendor boto3, and Lambda's managed runtime lags releases by weeks-to-months.

3. **Every use case worth building is worth building without it.** Reader-facing archive search (~200–500 chunks), a repetition detector over trailing coach output (dozens), and day-vector analog retrieval (~160 days × ~20 numeric features, needing no embedding model at all) are all single-`Query` brute force. Only chunk-level RAG over the full declared corpus (~10.4k docs ≈ 10 MB) would flip, and that corpus does not exist.

**The honest caveat.** The corpus is 17 documents by omission, not by nature — #1384's own acceptance criteria named coach outputs, and those are 10,409 items. Fully realised, retrieval means ~10 paginated `Query` round-trips and ~2.6M interpreted-Python multiply-adds: roughly 2–4 seconds. Fine in the nightly batch where it runs today; not fine on a synchronous reader path.

**Revisit trigger (both conditions, not either).** Revisit when (a) the recall corpus exceeds **~5,000 embedding rows**, AND (b) retrieval sits on a **synchronous reader-facing path** (`/api/ask`, the board, site search) measuring **>500 ms p95 in the retrieval step alone**. Today: 17 rows, batch-only. Both false.

**Rejected alternatives.** *OpenSearch Serverless* — its floor alone exceeds the entire $85 monthly ceiling (ADR-063/133). *Aurora pgvector* — a second datastore, against ADR-102. *S3 Vectors* — cheap, but a new service for a 24 KB index. *Adopting now to be ready later* — the dimensions and distance function are fixed at index creation and the corpus that would justify the choice does not exist, so "ready" would mean guessing the parameters of a workload nobody has measured.

**Consequences.** Nothing changes in the serving path. What the evaluation *did* surface is repaired under the same issue: semantic recall had **no incremental writer at all** — the corpus was written once by an operator script on 2026-07-25, and both chronicle records dated after that freeze are absent from it (one of them, 2026-08-02, is reader-visible and is what the new nightly check now reports; the other is a wiped prior-cycle record with no reader page, correctly not required) — the reader-facing `recall_card()` had zero production callers, and `journal_resonance` is read by the reading recommender with no writer anywhere. The first two are fixed (`ai/recall_indexer.py`, the publish-time hook, and a `qa_smoke` freshness check that names missing dates); the third is filed. That is the real return on reading the announcement: not a new index, but the discovery that the feature it would have accelerated was running at 0.16% of its declared corpus with nothing watching.

## ADR-151: Telegram coach chat — the conversational surface, its trust boundary, and the private-tier egress decision

**Date:** 2026-08-09 · **Status:** Accepted · **Issue:** epic #2363, spine #2364

**Context.** Every coach surface before this was a broadcast (cards, narratives, digest) or a queue (`coach_checkin` via MCP). The owner asked for the coaches as Telegram contacts — initiate in his own words, from his phone, replies in each coach's voice. Telegram cloud chats are not end-to-end encrypted, a bot username is publicly discoverable, and a FunctionURL is an open URL — so this is simultaneously a privacy-egress decision, a public-attack-surface decision, and an AI-honesty decision on the platform's first freeform chat surface.

**Decision.**
1. **Private-tier data may flow to Telegram.** The publication rules (`privacy_guard`) govern the public website and stay fully in force there; a reply to the owner's own device is not a publication. A private coach that cannot discuss the private tier is not a coach. (Flagged to the owner before build; accepted.)
2. **One bot per coach; the routing key is the webhook path** (a declared domain map), never message content — content routing would let phrasing reach a persona whose fact block was never built for it (the #2343 shape). Two coaches (glucose, labs) are deliberately not given bots: an unused bot is standing attack surface.
3. **The trust boundary is between two Lambdas.** The public webhook is near-powerless by role (one secret read + one invoke — no DDB/S3/Bedrock) and answers `200 {}` identically on every path (Telegram retries non-2xx; a distinguishable rejection is an oracle). The worker holds the real grants, write-scoped to `COACH#*` via LeadingKeys. All three inbound gates (echoed secret token, declared routing, chat-id allow-list) fail closed.
4. **The chat is the strictest grounding surface on the platform:** the only no-exemption entry in the wiring registry (all five classes armed — in a chat the OWNER picks the subject, so no topic-based exemption is honest), replies are regenerate-once-then-HOLD (never keep-if-better, per the #2391 evidence), and a held turn still answers with an honest deferral.
5. **Budget rank: with the daily brief, not with reader narratives** — the chat survives tier 1, pauses honestly at tier ≥2, and carries a 40-turn/day cap. An unknown tier proceeds (the hard backstop stays `budget_guard`/`bedrock_client`).
6. **The conversation writes to the coach's real memory** (`CHAT#` on the `COACH#` partition family) — texting a coach must feed the same memory the dossier and narratives read, never a side channel.

**Consequences.** Two new Lambdas in `LifePlatformServe` (+ Throttles alarms per the #1328 set guard); one new secret (`life-platform/telegram`: per-bot tokens + chat-id allow-list + webhook secret, owner-provisioned via `setup/setup_telegram_bots.py` — tokens never transit a chat log or the repo). The #2381 August tier-2 pause would pause the chat too — resolved by the owner's amend-to-$115 decision (next session implements). Voice/texting-register improvements are product work under ADR-106 (sketches propose, only the owner approves), tracked at #2402.

---

## ADR-152: One TDEE definition — measured exercise energy, and the deficit lives in the target

**Date:** 2026-08-09 · **Status:** Accepted · **Issue:** #2310 (epic #1890)

**Context.** The same instrument published "today's calorie target" twice, roughly 2x apart, from two formulas that never mentioned each other. `get_nutrition view=macros` multiplied a Mifflin-St Jeor BMR by a flat 1.55 activity factor and applied **no deficit** (3055 kcal at 220 lb), then graded his adherence against it; `get_daily_metrics view=energy` added **measured** trailing-7-day exercise energy and subtracted 500 kcal (1557 kcal), and told him to eat that. Both were internally correct for their own method — which is exactly why this was a decision and not a defect fix. Under ADR-104/105 a number stated twice, differently, without method or uncertainty is a rigor failure regardless of which one is right. A third copy of the flat-multiplier form backed the public nutrition door's `estimate_mifflin` fallback (`lambdas/web/site_api_nutrition.py`).

**Decision.**
1. **TDEE = Mifflin-St Jeor BMR + measured trailing-7-day exercise energy.** The flat x1.55 multiplier is **retired** — a flat multiplier is an assumption wearing a number, and ADR-105 prefers the platform's own measured data over a population constant. **The rejected method's tradeoff, stated rather than dropped:** the flat multiplier is stable and reproducible and never lies about a data outage, whereas the measured form inherits every gap in exercise-energy capture — a Strava outage reads as "no training" and pulls the target down. That is mitigated, not hidden: the payload carries its inputs (rule 3), so a gap is **visible, never silent**. When the window carries no exercise data the exercise term is 0 **and** `exercise_energy_days: 0` says so — honest absence per ADR-104, not a fabricated multiplier.
2. **TDEE means MAINTENANCE.** The −500 deficit lives **only** in the published target: `target = tdee − deficit`, with both numbers and the deficit explicit. Surfaces whose signal *is* `tdee − intake` (`deficit_sustainability`, `_get_metabolic_adaptation`) take maintenance deliberately — folding the deficit into TDEE would double-count it.
3. **Every surface publishing a target carries `{tdee, deficit, target, method, inputs}`** (ADR-105) — `method: "mifflin_bmr_plus_measured_7d_exercise"`, and inputs down to `bmr_kcal`, `age_basis`, `exercise_kcal_7d` and `exercise_energy_days`. The number is checkable without reading the source.
4. **One implementation:** `lambdas/health/tdee.py` (pure — no I/O, no clock reads except an explicit `now`). `deploy/build_bundle.py` copies the whole `lambdas/` tree to the zip root, so `from health import tdee` resolves identically from the MCP bundle, the site-api bundle and the compute path. Both MCP surfaces and the site fallback import it; `tools_nutrition._mifflin_tdee` is deleted. **No source-guard test, because there is no second copy to guard.**
5. **Where weight or profile height is absent the estimate is withheld, not guessed.** Mifflin is 6.25 kcal per cm of height — assuming a height publishes a BMR, a TDEE and a number he eats to, all derived from a guess, with nothing saying so. The macros view then falls back to a flat 2400 labelled `calorie_target_basis: "flat_default_no_weight_or_height"`.
6. **MacroFactor's measured adaptive TDEE stays the site's primary** whenever it is fresh. This decision replaces only the `estimate_mifflin` **fallback** behind it; the label is unchanged so a reader can still tell measured from estimated (#484).
7. **Stated exception:** `health/process_milestones.mifflin_tdee_estimate` keeps the flat-multiplier form. It is not a published "what should I eat" target — it is a per-day expenditure floor for the `strength_in_deficit` milestone, running in a deliberately dependency-free compute path with no exercise-energy input available. Recorded here as a deliberate exception so it is not a silent second answer to the same question.

**Changeover: 2026-08-09.** Cycle 13's genesis is today, so the adherence re-base lands exactly on a cycle boundary — the cleanest possible denominator break. **Every adherence percentage computed against the old 3055 denominator is non-comparable across this line** and must not be trended through it. The boundary is stated here rather than merely crossed.

**Amendment 2026-09-20 (#3931) — the duration proxy charged rest time, and the method label changed with the number.**

Rule 1's "measured trailing-7-day exercise energy" was, for every activity that reports no mechanical work, a ~6 kcal/kg/hour duration proxy applied across the **full logged duration**. For a lifting session that duration is mostly REST between sets, and rest is already inside the 24-hour BMR term — so it was charged a second time at ~6x resting. Live consequence: ~3,000 kcal for one 3.5-hour session, `exercise_kcal_7d: 20,276` (2,897/day), a 5,059 kcal TDEE, and a published **3,529 kcal/day (69.8%) deficit that is arithmetically impossible** against the same page's own 11.7-lb-over-13-days weight trend.

1. **The lifting term is worked-set time.** `health.tdee.worked_set_seconds` reads the Hevy set log (`exercises[].sets[]`) and charges the same ~6 kcal/kg/hour rate over WORK only: a logged `duration_seconds` where one exists, otherwise a **stated 40-second-per-set assumption** that rides in every published `basis` string as `assumed_40s_per_unlogged_set`. Warmup sets count — the exclusion is rest, not warmups. **Cardio is unchanged**: a Run/Ride/Walk/Elliptical duration is honest moving time and is still charged by duration. With no Hevy set log covering the window the lifting block falls back to a labelled `lifting_duration_x0.25_no_set_log`, never to full duration.
2. **The method label changed with the number.** `METHOD` is now `mifflin_bmr_plus_worked_set_exercise` (rule 3's string above is history). A surface still emitting `mifflin_bmr_plus_measured_7d_exercise` would be emitting the OLD number under a label the platform no longer means, so the retired string is swept out of the tree by `tests/test_tdee_worked_set_3931_behavior.py`.
3. **An impossibility check gates publication.** `implied_deficit_vs_trend(tdee, intake, trend_lb_per_wk, days)` compares the model-implied deficit against the deficit the measured weight trend implies at 3,500 kcal/lb and **refuses to publish a calorie target** when they disagree by more than `max(400 kcal/day, 40% of the larger)` — or when the deficit alone exceeds 50% of TDEE. A refusal is never silent: `target` is `None`, `target_basis` begins `refused: ` and carries both figures. An absent or sub-7-day trend publishes with `published_unverified_…` — "no data" may not read as "agreed".
4. **A second, independent method is offered, not folded in.** `tdee_from_trend(intake, trend_lb_per_wk)` (`weight_trend_back_solve_3500_kcal_per_lb`) back-solves TDEE from the observed trend and ships on `get_daily_metrics view=energy` as `tdee_second_method`. Its own weakness is stated on the payload: over a short window the 3,500 kcal/lb constant prices water and glycogen as fat, so a 13-day window over-reads.
5. **Every calorie/deficit surface carries the method name and a `basis`** — `get_nutrition view=macros`, `get_daily_metrics view=energy`, `get_deficit_sustainability`, `/api/nutrition_overview`'s `loss_rate`, `/api/deficit_sustainability`, and the coach domain-facts sheet. Method names are DERIVED from `health.tdee.METHOD`, never re-typed.

**Replay of the specimen:** the same 7-day window that produced the published 20,276 kcal / 5,059 TDEE replays to **3,854 kcal** under the fixed method — inside the red-team's ~3,300–4,000 band, ~1,200 kcal/day below what the reader was shown. The 180 g protein floor is unaffected and stays the primary nutrition gate.

**Consequences.** The macros view's calorie hit-rate changes meaning (it now grades against the target he is asked to hit, not against maintenance). On days MacroFactor's measured expenditure is absent, the public nutrition door's TDEE drops materially (~2914 → ~1880 at 200 lb) — that is the flat multiplier leaving, and it is the intended correction. No infra change: MCP and site-api redeploys only. The xfail marker `test_the_macro_target_and_the_energy_view_agree_on_todays_calorie_target` (deliberately left standing by #2302 as a product decision, not a test burn) is retired, and now asserts the two surfaces ship the *same payload*, not merely the same integer.

## ADR-153: Coaching Team v2 — MOS character adoption, texting tiers, and the roster restructure

**Date:** 2026-08-10 · **Status:** Accepted · **Issue:** epic #2363, #2402; owner decisions 2026-08-09

**Context.** The Telegram go-live (#2363) exposed that the coaches had no runtime personality — the persona layer never loaded (#2469/#2470 fixed the transport), and the personas themselves were platform-grown voice specs without a shared behavioural floor, texting register, or durable character depth. In parallel, Matthew's "Matt Operating System" workshop produced 8 production-grade character bibles plus a shared character standard. And the roster carried two overlapping training seats (Dr. Sarah Chen / training + Dr. Victor Reyes / physical) splitting one domain's memory.

**Decision.**
1. **Bible souls transplant into the existing cast; all published names survive** (no history break). One exception, owner-called 2026-08-09: the merged Performance coach is **renamed Dr. Victor → Max Reyes** (surname kept for continuity).
2. **The roster grows TIERS** (registry flags in `config/personas.json`, mirrored by constants in `persona_registry`):
   - **operational (7)** — daily engine outputs, STANCE#, predictions: sleep, nutrition, mind, physical, glucose, labs, explorer. **training_coach retires** at the cycle-13 genesis (`retired: true`; published history keeps her byline everywhere it already exists — retirement is a *stop writing*, never a rewrite).
   - **chat (3)** — voice spec + Telegram bot, **no** daily compute: `pattern_coach` (Dr. Nora Vale, Pattern Detective — persona-fronts the hypothesis engine), `career_coach` (Steve Brooks — chat+check-in until a data source exists), and the lead `eli_marsh` (Dr. Eli Marsh becomes operational as Matthew's single point of contact, with his own bot).
   - **consulting (2)** — glucose (Patel) + labs (Okafor): pipelines and site pages stay, **no bots**, citable by name by the texting coaches.
3. **The merged Performance seat absorbs the whole movement mandate**: site `training` domain routes to `physical_coach`; the movement-integrity prompt guard arms on the physical expert; the maturity ladder's separate `training` entry retires; influence-graph training edges fold into physical (max of each pair).
4. **De-hardcode before restructure**: every surface that hand-copied the cast (12 sites: ledger/narrative/ai/lambda rosters, state_of_matthew, diary reaction, MCP coach-intel, observatory renderer, expert personas, coaching.js, platform_memory, orchestrator domains) now derives names from `persona_registry` (`short_id_names()` / `display_map()`; `title`+`lens` moved into `personas.json`). History-rendering surfaces pass `include_retired=True` so retired bylines stay real.
5. **Telegram routing is registry data**: `telegram_route` on the persona (`persona_for_telegram_route()`), never `f"{route}_coach"` string surgery (eli_marsh broke it). The `training` route is a **succession alias**, not a retirement (amended 2026-08-10, same session): a bot chat is a thread Matthew already has open, and cycle-13 messages to `@ajm_training_bot` were dead-ending at a silent `Rejected`. `telegram_route_aliases: ["training"]` on `physical_coach` carries the route to the seat that absorbed the lane, so the existing thread continues in Dr. Max Reyes' own partition — one coach, one memory, no first-message special case. The primary `telegram_route` stays single-valued and remains the canonical outbound route; an unclaimed key still fails closed.
6. **The texting relationship is CROSS-PHASE** (owner request): `COACH#* / CHAT#*` turns, `CHAT#summary#*` long memory, and `RELATIONSHIP#state` survive experiment resets — a relationship with a coach is not an artifact of the cycle. `DEDUPE#*` rows are SYSTEM_STATE (24h self-TTL). Registered in `phase_taxonomy._PK_RULES` ahead of the blanket `COACH#*` experiment-scoped rule.
7. **Adopted vs rejected from MOS**: adopted — the shared character standard (as the persona substrate + gate blacklists, ADR-104/105-compatible), 8 core bibles (5 transplants + 3 new seats), the emoji/burst texting register under a deterministic ceiling. Rejected (bloat kill list) — 19 Tier-B bibles, Vale's §§8–20 engineering spec (the platform already has the hypothesis engine/calibration/spiral-breaker), YAML output contracts, MOS data-model/governance/release-process.

**Consequences.** The operational count assertions moved 8 → 7 (`test_persona_registry`, `coaches_api`, traits, field-note broadcast). The roster-copy scanner's vocabulary now includes retired ids so stale 8-coach copies stay catchable. Chat-tier seats need owner BotFather registrations + secret entries before their bots go live; until then their personas exist but no transport reaches them. Cycle-13 day-1 timing makes the merge/retire the cheapest it will ever be (one day of scoped records). Public-site regen (team page, tone, portraits, game) follows in the same session's Wave 4.


**Amendment — 2026-08-12 · the longevity door, and the training alias retires.** Owner question: *"should we not just have a longevity coach?"* The answer was that one already existed with no way to reach him. `labs_coach`'s own bio reads "Longevity & preventive medicine" and his lens is "bloodwork, biomarkers, long-run risk factors" — so a new longevity seat would have landed squarely on Dr. Okafor's evidence base, recreating two days later exactly the overlapping-seats problem decision 1 above was written to solve. **Rather than mint the seat, the existing coach got a bot.**

Three changes, all registry data — **no code**:

1. **`labs_coach` gains `telegram_route: "labs"`.** This amends decision 2's "consulting (2) … **no bots**". Note what did *not* change: `consulting: true` still holds, and it never blocked texting. **A bot is granted by `telegram_route`, not by a tier flag** — `sleep_coach` is `chat: false` and has always had one. The tier flags drive citability and site surfaces; the route drives transport. Conflating them is the trap this amendment exists to document.
2. **`@ajm_longevity_bot` moves from `physical` to `labs`.** Telegram will not rename a bot username once taken, and "longevity" described the retired Victor framing rather than Max's performance/movement mandate. The handle now describes its owner for the first time.
3. **The `training` succession alias retires** (reversing this ADR's own 2026-08-10 amendment). `@ajm_training_bot` becomes the Performance seat's **primary** route, so Max keeps the thread he absorbed without needing an alias. This is load-bearing, not tidiness: the primary `telegram_route` is the canonical **outbound** route, so a seat reachable only by alias could be texted but could never text first — Max's morning check-ins and event-triggered outbound would have stayed dark. `training` is now deliberately unmapped and fails **closed** in `gateway.resolve_coach`, which is correct: there is no separate training seat.

**Consequence.** Matthew's chat list stops containing two differently-named doors to the same coach, and the one coach whose stated domain is longevity becomes reachable. Whether a *distinct* longevity seat is warranted is now an evidence question — text Okafor for a few weeks first (the ADR-108 promotion pattern: advisory until measured).

## ADR-154: The new-signal playbook — a new metric/source lands through one ordered checklist, absence semantics and privacy tier first

**Date:** 2026-08-16 · **Status:** Accepted · **Driver:** the Withings BodyScan 2 spike (#2782)

**Context.** The first new device since the platform matured arrived and exposed that "a new signal starts flowing" had no repeatable pattern. The spike measured the blast radius: 12 unmapped measurement types AND 19 already-mapped-but-never-fired ones lit up with zero code change — including an age-class metric (`vascular_age`) that reached DynamoDB before any privacy classification, an hour after the first weigh-in. Nothing leaked (all consumers were field-selective, verified), but only because prior sessions happened to build them that way.

**Decision.** `docs/NEW_SIGNAL_PLAYBOOK.md` is the standard for ANY new metric, device, or source. Its load-bearing orderings, sanctioned here so they outlive the doc's prose:

1. **Capture raw and unfiltered before touching code** — and enumerate the dormant mappings that will fire, because ingestion can start WITHOUT a deploy.
2. **Privacy tier BEFORE the first scheduled ingestion run**, not before the first surface — the BodyScan proved the data lands on the cron's schedule, not the developer's.
3. **A field without absence semantics is not done** (ADR-104 applied at birth): every ingested metric defines day-1 what its absence and its sentinel values mean (the same device transmitted SpO2 0 = failed measurement AND afib 0 = honest negative — one skip rule, one keep rule).
4. **Ingest only what a named consumer will read; park the rest visibly** (ADR-103/144) — a parked ID is a one-line comment in the source map, so the next session finds a decision instead of re-deriving one. (The owner may still choose ingest-all, as #2782's owner did — the point is the decision is explicit, per-metric, and recorded.)
5. **One SoT ruling per overlap, written down** — never two writers to one truth surface.
6. **Multi-valued shapes never enter through a flat map entry** — the parser's shape contract is checked before the ID is mapped (#2782's segmental types would have silently collapsed to one arbitrary limb).
...
**Context.** `docs/DATA_GOVERNANCE.md` classed HRV, heart rate, sleep stages, lab results, weight and body composition **Tier-2 owner-only**, yet the public site had been serving them for months: `/api/vitals` (HRV raw ms + 30d averages, RHR, recovery %, sleep hours, weight + deltas + trends and their honesty disclosures), `/api/labs` (the full named-biomarker panel with value/unit/range/flag), `/api/sleep_detail` (deep/REM/light stage hours), the nutrition surface (lean mass, driving the public protein floor), and the physical surface (the full DEXA scan summary — body fat %, fat/lean mass, visceral fat, bone density; served deliberately since an unrecorded owner decision of 2026-06-06). No ADR recorded any of it, and the #2803 field-tier registry held **3 fields**, so every other Tier-2 field was `TIER_PUBLIC`-by-omission — the registry and the governance prose were unreconciled twin sources of truth. The publication itself is the platform's thesis (radical transparency about one man's health data, ADR-071's whole premise); the *drift* — publication nobody decided — is the defect.

**Decision (the owner call, 2026-08-23).** **The full currently-served public surface is consented.** Every field `/api/vitals` serves today and every biomarker `/api/labs` serves today — plus the sleep-stage trio, lean mass, and the DEXA summary the site also verifiably serves — is deliberately published. **Nothing is stripped from public payloads by this ADR.** What changes is the mechanism:

1. **`TIER_OWNER_PUBLISHED` exists** in `lambdas/privacy/field_tiers.py`: a distinct tier meaning *was Tier-2 by nature, deliberately published by recorded owner consent*. It is numerically above `TIER_OWNER_ONLY` on purpose, so a naive `tier >= TIER_OWNER_ONLY` restriction check fails closed (over-strips) rather than leaking; the one sanctioned publication predicate is `is_publishable()`, and `strip_map()` never includes an owner-published field at any threshold — the owner's own MCP row dumps are not stricter than the public site.
2. **The standing rule:** a Tier-2-class field reaches a public surface **only** via an explicit `TIER_OWNER_PUBLISHED` stamp in the registry, citing this ADR — never by omission, never by default. Widening the published set is a one-line registry change **plus** the DATA_GOVERNANCE row edit the guard forces, which is exactly the recorded decision this ADR exists to require.
3. **The registry is the enforcement point and the full Tier-2 catalogue lives in it** (DIL-011): every remaining DATA_GOVERNANCE Tier-2 row is ported — field-level where the row is a set of DDB fields (whoop raw biometrics, the withings BodyScan family, reading retention fields), source-level (`SOURCE_TIERS`) where the row is a whole partition (journal `notion`, `state_of_mind`, `macrofactor` nutrition logs, `strava` GPS, `hevy` workout detail, `sick_days`, `supplements`, `genome`, `private_intake`, `flourishing`, `felt_probe`, the ADR-097 `reading` keyspace, and the S3 `cgm_readings` raw stream). Source-level semantics: the raw row is owner-only; public surfaces may serve only deliberate, gated projections (the Tier-0 aggregate path). Enforcement reach is stated honestly in the module: field-level = the #2803 wiring scan + `strip_map()`; source-level = declaration reconciled by the guard, with runtime enforcement in the named per-source gates (`phase_taxonomy`'s never-public class, `reading_visibility.project_public`, the diary consent gates, `_strip_genetic_biomarkers`).
4. **The twin-sources drift class is closed:** `tests/test_data_governance_tier_guard_3045.py` derives both directions — a Tier-2 prose row absent from the registry fails the build, and an owner-grade registry entry with no governing prose row fails the build.

**Consented-set enumeration (2026-08-23):** whoop `hrv`, `resting_heart_rate`, `recovery_score`, `sleep_duration_hours`, `rem_sleep_hours`, `slow_wave_sleep_hours`, `light_sleep_hours`; withings `weight_kg/_lbs`, `fat_free_mass_kg/_lbs`; source `labs` (full served biomarker panel — genetic entries structurally stripped, `tests/test_public_genetic_privacy_absolute.py` unchanged and absolute); source `dexa` (the served scan summary). Everything else Tier-2-class is `TIER_OWNER_ONLY`. The PhenoAge Option A rule (chronological age never published), the genetic absolute, and the editorial guardrails are **untouched carve-outs** — this ADR publishes nothing new; it records what was already served and arms the gate that makes the next publication a decision.

**Consequence.** The diligence framing ("Tier-2 data on public APIs with no recorded decision") is answered by construction: the decision now exists, is dated, is owner-signed, and is machine-enforced. The residual honestly carried: source-level tiers are declarations with named per-source gates, not yet a generic row-level scrubber on the serving path — if a future endpoint starts serializing whole owner-only rows, the wiring scan catches field-level names but a novel field would need its registry row first; the new-signal playbook (ADR-154 step 2) is the paved road that assigns it one.

## ADR-156: The reader's three questions come before the loop on every door's first screen

**Date:** 2026-09-26 · **Status:** Accepted · **Driver:** the owner's 2026-09-25 ruling ("I have not used it in the 3 weeks … friends overwhelmed with the layout, the content, what to do, and even some of the words"), epic #4182, the red-team record in `docs/SITE_TRANSFORMATION_V6.md`

**Context.** `DESIGN_SYSTEM_V5.md` §1 set "the one rule that kills scattered": every first screen answers *which part of the loop am I, and what do I give you*. Applied literally it produced a site organised around the builder's model — the loop dial owned the home fold (#1469, 2026-07-19), the cockpit opened on "6 · Foundation", the coaching door on a navigation paragraph — and the measured result three weeks into cycle 17 was zero owner visits, ~1,100 readers a week who did not return, and every door scoring 1–3 of 5 on a friend's ten-second test (Session AV's B1 audit, 60 screenshots). 71 of 88 reader pages carried builder vocabulary with no gloss.

**Decision.** On every door, the first screen answers the reader's three questions — **who is he · how is it going · what do I look at today** — in ≤120 words, third person, dates in words, every number with its date/n/CI, *before* it teaches the loop. The loop rule stands for the second screen. Served coach text is never rewritten (glossed, marked disputed where the engine disagrees). The reader surface is a projection: nothing in the engine changes to make a page simpler (ADR-104/105). The four audiences are unchanged; their **order** for this cycle is the subject and his friends first, enthusiasts one click down, newcomers on screen two.

**Mechanism (charter-shaped).** `site/data/glossary.json` is the vocabulary registry; `tests/test_site_vocabulary_registry.py` + `tests/site_vocabulary_residue.py` the derivation guard and shrink-only ratchet (a keep-with-gloss term counts only on unglossed pages; `<noscript>` bakes of served content are excluded); `tests/test_site_nav_reach_ratchet.py` holds the statically reachable page count, lowered only by the owner's cap. Registered in CONVENTIONS §9.

**Consequences.** The 2026-07-19 fold pick is reversed (`tests/test_home_okay.py` re-pinned and says so). The character level's tier name and XP leave the reader surface (a one-line revert is named in PR #4200). Nav labels, the weight-led home headline, the page cap number, glucose's link and the subscriber counter are the owner's calls (`SITE_TRANSFORMATION_V6.md` §7) — rendered, not decided, by this ADR. The dissent register (§9 there) is part of the record: Raj, Sofia and Lena each lost a ruling and their reasons are kept.
