...
| ADR-156 | The body-comp delta stays deleted and the lean-mass floor is owner-monitored — the "weight-only scale" premise expired 2026-08-16 | Accepted | 2026-09-01 |
<!-- ADR-INDEX:END -->
...
## ADR-156: The body-comp delta stays deleted and the lean-mass floor is owner-monitored — the "weight-only scale" premise expired 2026-08-16

**Date:** 2026-09-01 · **Status:** Accepted · **Driver:** Day-1 verification finding #3417 (owner-confirmed device behavior)
...
2. **The 14-day body-comp delta is NOT restored.** Three grounds, each sufficient today:
   ...
   **Revisit trigger:** once ≥6 full scans spanning ≥6 weeks exist, a *scan-to-scan* delta (dates and n carried in the output, never a calendar-window one) may be proposed — proven against the real full-scan records per #3417's acceptance, as its own story, amending this ADR.
