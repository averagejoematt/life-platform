...
## ADR-133: Surge-mode ceiling — the $75 budget floats to $100 on real reader traffic, never on spend creep (E5.4, #739)

**Date:** 2026-07-08 · **Status:** Accepted · **Story:** #739 (epic #719, R21 definitive review) · **Amends:** ADR-063 (the $75 ceiling), ADR-125 (audience-based degradation ladder)
