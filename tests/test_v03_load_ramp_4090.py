...
What these tests hold:
  ...
  2. WEEK 1 — the generator's heavy squat / bench / row top sets for 2026-09-24 land at
     60–65 % of the band anchor after the discount; back-offs at −10 % of that top set.
...
# at a bodyweight inside the same 10-lb band as the target-date weigh-in.
ANCHOR_LB = {"leg_press": 400.0, "db_bench_press_flat": 80.0, "machine_row": 200.0, "lat_pulldown": 180.0}
ANCHOR_REPS = {"leg_press": 8, "db_bench_press_flat": 6, "machine_row": 10, "lat_pulldown": 10}
HISTORY = {
...
HEAVY_ANCHORS = ("leg_press", "db_bench_press_flat", "machine_row")
...
def test_week_1_heavy_top_sets_land_at_60_to_65_percent_of_the_discounted_anchor():
    ...
    assert audit["load_rule"]["week"] == 1 and audit["movements"]["leg_press"]["ramp"]["ramp_pct"] == 60
