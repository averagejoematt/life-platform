...
def test_the_verdict_counts_add_up_and_are_reported(real_census):
    ...
    assert (
        ...
        # Upper bound 122 -> 123 (2026-09-20 PT, #3599 box 2): structural::test_scoped_writer_provenance_guard_3599.py arrives
        ...
        # this lane (rebased onto 341860e0a) -> 674 rows {proven 123, unproven 540, not-applicable 6, attempted-unproven 5}; a
        # disposable `git archive origin/main` export -> 673 {122, 540, 6, 5}. Exactly
        # {structural::test_scoped_writer_provenance_guard_3599.py} enters, {} leaves — unproven does NOT move.
        <= 123
