...
_PREMERGE_EXTRA_FILES = frozenset(
    {
        ...
        # and the value it guards was wrong in PUBLIC for weeks precisely because nothing
        # cheap ever re-read it.
        ...
        # #3294: the channels_quiet reader enumeration — a NEW consumer of the raw
        ...
        # because a dead reference in a skill is silent: it misleads the next session
        # rather than raising, and the next session may be an unattended one.
