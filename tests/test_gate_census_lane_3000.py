...
BASELINE_TOTAL_GATES = 607  # +8 2026-09-06 (#3544/#3545: the 8 entries of tests/test_token_contrast.py::RECEDE_TEXT_RULES, one per rule in the site's recede state grammar — all 8 land PROVEN per entry, so BASELINE_UNPROVEN_GATES is untouched and live unproven stays 537; RE-MEASURED by scripts/gate_census.py on this merged tree, not arithmetic), atop 599 (#3529/#3531/#3534's two derived mirror registries, PROVEN, net of #3568's +1), atop 598 +1 2026-09-06 (#3568's sending-vocabulary census, PROVEN — 4 real-tree mutations each red their own assertion), atop 597 (#3503's repo-wide AlarmTypes sweep, atop 596, atop 595, atop 594)
