...
BASELINE_TOTAL_GATES = 599  # +2 2026-09-06 (#3515/#3567: scripts/check_proof_freshness.py + the premerge-registered tests/test_v4_build_sitemap_3567.py, BOTH PROVEN by hand-records in scripts/gate_census_proofs.py — unproven does not move, 538 -> 538), atop 597 (#3503's repo-wide AlarmTypes sweep, PROVEN by the family-5 harness), atop 596 (#3564's subscriber-promise cadence check, atop 595, atop 594)
