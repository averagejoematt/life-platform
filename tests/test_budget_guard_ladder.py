...
_INTERNAL = ("ensemble", "coherence_semantic", "chronicle_editor", "reader_truth_qa", "visual_ai_qa", "eyeball_estimate")
_READER_NARRATIVE = ("coach_narrative", "state_of_matthew", "daily_debrief", "chronicle", "semantic_recall", "horizons_retrospective")
